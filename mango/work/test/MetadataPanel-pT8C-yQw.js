import { $ as e, A as t, B as n, C as r, Ct as i, Dt as a, I as o, J as s, N as c, O as l, Q as u, R as d, _t as f, g as p, gt as m, it as h, j as g, k as _, mt as v, n as y, nt as b, rt as x, u as S, wt as C, z as w } from "./client-CruOUf1V.js";
import { r as T } from "./i18n-CG_FGWUx.js";
import { n as E, r as D, t as O } from "./PanelCloseButton-BNGDiR-j.js";
//#region node_modules/ol/CollectionEventType.js
var k = {
	ADD: "add",
	REMOVE: "remove"
}, A = { PROPERTYCHANGE: "propertychange" };
//#endregion
...
function N(e) {
	e && e.target && (e.target.removeEventListener(e.type, e.listener), ee(e));
}
//#endregion
...
function me(e) {
	...
	return function() {
		...
		return (!n || this !== r || !le(i, n)) && (r = this, n = i, t = e.apply(this, arguments)), t;
	};
}
function he(e) {
	function t() {
...
var ge = class {
	...
	dispatchEvent(e) {
		...
		if (--a[n] === 0) {
			let e = o[n];
			for (delete o[n]; e--;) this.removeEventListener(n, pe);
			delete a[n];
		}
		return s;
	}
	disposeInternal() {
		this.listeners_ && ee(this.listeners_);
	}
	getListeners(e) {
	...
	removeEventListener(e, t) {
		...
		if (!n) return;
		let r = n.indexOf(t);
		r !== -1 && (this.pendingRemovals_ && e in this.pendingRemovals_ ? (n[r] = pe, ++this.pendingRemovals_[e]) : (n.splice(r, 1), n.length === 0 && delete this.listeners_[e]));
	}
}, ve = class extends _e {
	constructor() {
	...
	onInternal(e, t) {
		if (Array.isArray(e)) {
			...
			for (let i = 0; i < n; ++i) r[i] = M(this, e[i], t);
			return r;
		}
		return M(this, e, t);
	}
	onceInternal(e, t) {
		...
		if (Array.isArray(e)) {
			let r = e.length;
			n = Array(r);
			for (let i = 0; i < r; ++i) n[i] = te(this, e[i], t);
		} else n = te(this, e, t);
		return t.ol_key = n, n;
	}
	unInternal(e, t) {
...
ve.prototype.on, ve.prototype.once, ve.prototype.un;
function ye(e) {
	if (Array.isArray(e)) for (let t = 0, n = e.length; t < n; ++t) N(e[t]);
	else N(e);
}
//#endregion
...
var xe = class extends ge {
	...
	constructor(e) {
		super(), this.on, this.once, this.un, I(this), this.values_ = null, e !== void 0 && this.setProperties(e);
	}
	get(e) {
		let t;
	...
	notify(e, t) {
		let n;
		n = `change:${e}`, this.hasListener(n) && this.dispatchEvent(new xe(n, e, t)), n = A.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new xe(n, e, t));
	}
	...
	unset(e, t) {
		if (this.values_ && e in this.values_) {
			...
			delete this.values_[e], j(this.values_) && (this.values_ = null), t || this.notify(e, n);
		}
	}
}, Ce = { LENGTH: "length" }, we = class extends ge {
	constructor(e, t, n) {
	...
	getLength() {
		return this.get(Ce.LENGTH);
	}
	insertAt(e, t) {
		if (e < 0 || e > this.getLength()) throw Error("Index out of bounds: " + e);
		this.unique_ && this.assertUnique_(t), this.array_.splice(e, 0, t), this.updateLength_(), this.dispatchEvent(new we(k.ADD, t, e));
	}
	pop() {
	...
	removeAt(e) {
		...
		let t = this.array_[e];
		return this.array_.splice(e, 1), this.updateLength_(), this.dispatchEvent(new we(k.REMOVE, t, e)), t;
	}
	setAt(e, t) {
		if (e >= this.getLength()) {
			this.insertAt(e, t);
		...
		let n = this.array_[e];
		this.array_[e] = t, this.dispatchEvent(new we(k.REMOVE, n, e)), this.dispatchEvent(new we(k.ADD, t, e));
	}
	updateLength_() {
		this.set(Ce.LENGTH, this.array_.length);
	}
	assertUnique_(e, t) {
		let n = this.array_;
...
}, Oe = typeof navigator < "u" && navigator.userAgent !== void 0 ? navigator.userAgent.toLowerCase() : "";
Oe.includes("safari") && !Oe.includes("chrom") && (Oe.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Oe));
var ke = Oe.includes("webkit") && !Oe.includes("edge"), Ae = Oe.includes("macintosh"), je = typeof devicePixelRatio < "u" ? devicePixelRatio : 1, Me = typeof WorkerGlobalScope < "u" && typeof OffscreenCanvas < "u" && self instanceof WorkerGlobalScope, Ne = typeof Image < "u" && Image.prototype.decode, Pe = (function() {
	let e = !1;
	try {
	...
	constructor(e, t) {
		...
		this.activePointers_ = [], this.trackedTouches_ = {}, this.element_ = n, this.pointerdownListenerKey_ = M(n, Fe.POINTERDOWN, this.handlePointerDown_, this), this.originalPointerMoveEvent_, this.relayedListenerKey_ = M(n, Fe.POINTERMOVE, this.relayMoveEvent_, this), this.boundHandleTouchMove_ = this.handleTouchMove_.bind(this), this.element_.addEventListener(P.TOUCHMOVE, this.boundHandleTouchMove_, Pe ? { passive: !1 } : !1);
	}
	emulateClick_(e) {
		let t = new De(L.CLICK, this.map_, e);
		this.dispatchEvent(t), this.clickTimeoutId_ === void 0 ? this.clickTimeoutId_ = setTimeout(() => {
			this.clickTimeoutId_ = void 0;
			let t = new De(L.SINGLECLICK, this.map_, e);
			this.dispatchEvent(t);
		}, 250) : (clearTimeout(this.clickTimeoutId_), this.clickTimeoutId_ = void 0, t = new De(L.DBLCLICK, this.map_, e), this.dispatchEvent(t));
	}
	updateActivePointers_(e) {
		let t = e, n = t.pointerId;
		if (t.type == L.POINTERUP || t.type == L.POINTERCANCEL) {
		...
		} else (t.type == L.POINTERDOWN || t.type == L.POINTERMOVE) && (this.trackedTouches_[n] = t);
		this.activePointers_ = Object.values(this.trackedTouches_);
	}
	handlePointerUp_(e) {
		this.updateActivePointers_(e);
		let t = new De(L.POINTERUP, this.map_, e, void 0, void 0, this.activePointers_);
		this.dispatchEvent(t), this.emulateClicks_ && !t.defaultPrevented && !this.dragging_ && this.isMouseActionButton_(e) && this.emulateClick_(this.down_), this.activePointers_.length === 0 && (this.dragListenerKeys_.forEach(N), this.dragListenerKeys_.length = 0, this.dragging_ = !1, this.down_ = null);
	}
	...
	handlePointerDown_(e) {
		...
		let t = new De(L.POINTERDOWN, this.map_, e, void 0, void 0, this.activePointers_);
		if (this.dispatchEvent(t), this.down_ = new PointerEvent(e.type, e), Object.defineProperty(this.down_, "target", {
			...
			this.dragListenerKeys_.push(M(e, L.POINTERMOVE, this.handlePointerMove_, this), M(e, L.POINTERUP, this.handlePointerUp_, this), M(this.element_, L.POINTERCANCEL, this.handlePointerUp_, this)), this.element_.getRootNode && this.element_.getRootNode() !== e && this.dragListenerKeys_.push(M(this.element_.getRootNode(), L.POINTERUP, this.handlePointerUp_, this));
		}
	}
	handlePointerMove_(e) {
		if (this.isMoving_(e)) {
			this.updateActivePointers_(e), this.dragging_ = !0;
			let t = new De(L.POINTERDRAG, this.map_, e, this.dragging_, void 0, this.activePointers_);
			this.dispatchEvent(t);
		}
	}
	relayMoveEvent_(e) {
		...
		this.dispatchEvent(new De(L.POINTERMOVE, this.map_, e, t));
	}
	handleTouchMove_(e) {
	...
	disposeInternal() {
		this.relayedListenerKey_ &&= (N(this.relayedListenerKey_), null), this.element_.removeEventListener(P.TOUCHMOVE, this.boundHandleTouchMove_), this.pointerdownListenerKey_ &&= (N(this.pointerdownListenerKey_), null), this.dragListenerKeys_.forEach(N), this.dragListenerKeys_.length = 0, this.element_ = null, super.disposeInternal();
	}
}, Le = {
...
var Re = Infinity, ze = class {
	constructor(e, t) {
		this.priorityFunction_ = e, this.keyFunction_ = t, this.elements_ = [], this.priorities_ = [], this.queuedElements_ = {};
	}
	clear() {
		this.elements_.length = 0, this.priorities_.length = 0, ee(this.queuedElements_);
	}
	dequeue() {
	...
	enqueue(e) {
		...
		return t && e[0].addEventListener(P.CHANGE, this.boundHandleTileChange_), t;
	}
	getTilesLoading() {
	...
	handleTileChange(e) {
		...
		if (n === z.LOADED || n === z.ERROR || n === z.EMPTY) {
			n !== z.ERROR && t.removeEventListener(P.CHANGE, this.boundHandleTileChange_);
			let e = t.getKey();
	...
	loadMoreTiles(e, t) {
		...
		for (; this.tilesLoading_ < e && n < t && this.getCount() > 0;) {
			...
			e.getState() === z.IDLE && !(t in this.tilesLoadingKeys_) && (this.tilesLoadingKeys_[t] = !0, ++this.tilesLoading_, ++n, e.load());
		}
	}
};
function Ve(e, t, n, r, i) {
	if (!e || !(n in e.wantedTiles) || !e.wantedTiles[n][t.getKey()]) return Re;
...
function Qe(e, t) {
	return Math.floor(Ze(e, t));
}
function $e(e, t) {
	return Math.ceil(Ze(e, t));
}
function et(e, t, n) {
	if (e >= t && e < n) return e;
	let r = n - t;
...
function it(e) {
	let t = ft();
	for (let n = 0, r = e.length; n < r; ++n) yt(t, e[n]);
	return t;
}
function at(e, t, n) {
...
function dt(e, t) {
	let n = e[0], r = e[1], i = e[2], a = e[3], o = t[0], s = t[1], c = rt.UNKNOWN;
	return o < n ? c |= rt.LEFT : o > i && (c |= rt.RIGHT), s < r ? c |= rt.BELOW : s > a && (c |= rt.ABOVE), c === rt.UNKNOWN && (c = rt.INTERSECTING), c;
}
function ft() {
	return [
		Infinity,
...
function mt(e) {
	return pt(Infinity, Infinity, -Infinity, -Infinity, e);
}
function ht(e, t) {
	let n = e[0], r = e[1];
	return pt(n, r, n, r, t);
...
function St(e, t) {
	let n;
	return n = t(wt(e)), n || (n = t(Tt(e)), n) || (n = t(Pt(e)), n) || (n = t(Nt(e)), n) ? n : !1;
}
function Ct(e) {
	let t = 0;
	return It(e) || (t = H(e) * At(e)), t;
}
function wt(e) {
	return [e[0], e[1]];
}
...
function Dt(e, t) {
	let n;
	if (t === "bottom-left") n = wt(e);
	else if (t === "bottom-right") n = Tt(e);
	else if (t === "top-left") n = Nt(e);
	else if (t === "top-right") n = Pt(e);
	else throw Error("Invalid corner");
	return n;
}
function Ot(e, t, n, r, i) {
	let [a, o, s, c, l, u, d, f] = kt(e, t, n, r);
	return pt(Math.min(a, s, l, d), Math.min(o, c, u, f), Math.max(a, s, l, d), Math.max(o, c, u, f), i);
}
function kt(e, t, n, r) {
...
function jt(e, t, n) {
	let r = n || ft();
	return Ft(e, t) ? (r[0] = e[0] > t[0] ? e[0] : t[0], r[1] = e[1] > t[1] ? e[1] : t[1], r[2] = e[2] < t[2] ? e[2] : t[2], r[3] = e[3] < t[3] ? e[3] : t[3]) : mt(r), r;
}
function Mt(e, t) {
	if (!Ft(e, t)) return [e.slice()];
	if (lt(t, e)) return [];
...
function Rt(e, t, n) {
	let r = !1, i = dt(e, t), a = dt(e, n);
	if (i === rt.INTERSECTING || a === rt.INTERSECTING) r = !0;
	else {
		let o = e[0], s = e[1], c = e[2], l = e[3], u = t[0], d = t[1], f = n[0], p = n[1], m = (p - d) / (f - u), h, g;
		a & rt.ABOVE && !(i & rt.ABOVE) && (h = f - (p - l) / m, r = h >= o && h <= c), !r && a & rt.RIGHT && !(i & rt.RIGHT) && (g = p - (f - c) * m, r = g >= s && g <= l), !r && a & rt.BELOW && !(i & rt.BELOW) && (h = f - (p - s) / m, r = h >= o && h <= c), !r && a & rt.LEFT && !(i & rt.LEFT) && (g = p - (f - o) * m, r = g >= s && g <= l);
	}
	return r;
}
function zt(e, t) {
	let n = t.getExtent(), r = Et(e);
...
function Vt(e, t) {
	...
	for (let e = 0, r = t.length; e < r && n.length > 0; ++e) {
		let r = [];
		for (let i = 0, a = n.length; i < a; ++i) r.push(...Mt(n[i], t[e]));
		n = r;
	}
	return n;
}
...
function Kt(e, t) {
	if (t.canWrapX()) {
		let n = H(t.getExtent()), r = qt(e, t, n);
		r && (e[0] -= r * n);
	}
	return e;
}
...
function Jt(e, t, n) {
	let r = Math.sqrt((t[0] - e[0]) * (t[0] - e[0]) + (t[1] - e[1]) * (t[1] - e[1])), i = [(t[0] - e[0]) / r, (t[1] - e[1]) / r], a = [-i[1], i[0]], o = Math.sqrt((n[0] - e[0]) * (n[0] - e[0]) + (n[1] - e[1]) * (n[1] - e[1])), s = [(n[0] - e[0]) / o, (n[1] - e[1]) / o], c = r === 0 || o === 0 ? 0 : Math.acos(V(s[0] * i[0] + s[1] * i[1], -1, 1));
...
function $t(e, t, n) {
	n ||= 6371008.8;
	let r = Je(e[1]), i = Je(t[1]), a = (i - r) / 2, o = Je(t[0] - e[0]) / 2, s = Math.sin(a) * Math.sin(a) + Math.sin(o) * Math.sin(o) * Math.cos(r) * Math.cos(i);
...
var rn = {
	...
	180,
	85
], un = on * Math.log(Math.tan(Math.PI / 2)), dn = class extends an {
	constructor(e) {
		super({
			code: e,
			units: "m",
...
function pn(e, t, n, r) {
	...
	for (let n = 0; n < i; n += r) {
		t[n] = sn * e[n] / 180;
		let r = on * Math.log(Math.tan(Math.PI * (+e[n + 1] + 90) / 360));
		r > un ? r = un : r < -un && (r = -un), t[n + 1] = r;
	}
	return t;
}
function mn(e, t, n, r) {
	let i = e.length;
	n = n > 1 ? n : 2, r ??= n, t === void 0 && (t = n > 2 ? e.slice() : Array(i));
	for (let n = 0; n < i; n += r) t[n] = 180 * e[n] / sn, t[n + 1] = 360 * Math.atan(Math.exp(e[n + 1] / on)) / Math.PI - 90;
	return t;
}
//#endregion
...
var hn = 6378137, gn = [
	...
	180,
	90
], _n = Math.PI * hn / 180, vn = class extends an {
	constructor(e, t) {
		super({
			code: e,
			units: "degrees",
...
function xn(e) {
	return bn[e] || bn[e.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] || null;
}
function Sn(e, t) {
	bn[e] = t;
}
...
function wn(e, t, n) {
	...
	r in Cn || (Cn[r] = {}), Cn[r][i] = n;
}
function Tn(e, t) {
	return e in Cn && t in Cn[e] ? Cn[e][t] : null;
}
//#endregion
//#region node_modules/ol/proj/utm.js
var En = .9996, Dn = .00669438, On = Dn * Dn, kn = On * Dn, An = Dn / .99330562, jn = Math.sqrt(.99330562), Mn = (1 - jn) / (1 + jn), Nn = Mn * Mn, Pn = Nn * Mn, Fn = Pn * Mn, In = Fn * Mn, Ln = 1 - Dn / 4 - 3 * On / 64 - 5 * kn / 256, Rn = .002514607064228144, zn = 26390466021299826e-22, Bn = 35 * kn / 3072, Vn = 3 / 2 * Mn - 27 / 32 * Pn + 269 / 512 * In, Hn = 21 / 16 * Nn - 55 / 32 * Fn, Un = 151 / 96 * Pn - 417 / 128 * In, Wn = 1097 / 512 * Fn, Gn = 6378137;
function Kn(e, t, n) {
	let r = e - 5e5, i = (n.north ? t : t - 1e7) / En / (Gn * Ln), a = i + Vn * Math.sin(2 * i) + Hn * Math.sin(4 * i) + Un * Math.sin(6 * i) + Wn * Math.sin(8 * i), o = Math.sin(a), s = o * o, c = Math.cos(a), l = o / c, u = l * l, d = u * u, f = 1 - Dn * s, p = Gn / Math.sqrt(1 - Dn * s), m = .99330562 / f, h = An * c ** 2, g = h * h, _ = r / (p * En), v = _ * _, y = v * _, b = y * _, x = b * _, S = x * _, C = a - l / m * (v / 2 - b / 24 * (5 + 3 * u + 10 * h - 4 * g - 9 * An)) + S / 720 * (61 + 90 * u + 298 * h + 45 * d - 252 * An - 3 * g), w = (_ - y / 6 * (1 + 2 * u + h) + x / 120 * (5 - 2 * h + 28 * u - 3 * g + 8 * An + 24 * d)) / c;
	return w = et(w + Je(Qn(n.number)), -Math.PI, Math.PI), [qe(w), qe(C)];
}
var qn = -80, Jn = 84, Yn = -180, Xn = 180;
function Zn(e, t, n) {
	e = et(e, Yn, Xn), t < qn ? t = qn : t > Jn && (t = Jn);
	let r = Je(t), i = Math.sin(r), a = Math.cos(r), o = i / a, s = o * o, c = s * s, l = Je(e), u = Je(Qn(n.number)), d = Gn / Math.sqrt(1 - Dn * i ** 2), f = An * a ** 2, p = a * et(l - u, -Math.PI, Math.PI), m = p * p, h = m * p, g = h * p, _ = g * p, v = _ * p, y = Gn * (Ln * r - Rn * Math.sin(2 * r) + zn * Math.sin(4 * r) - Bn * Math.sin(6 * r)), b = En * d * (p + h / 6 * (1 - s + f) + _ / 120 * (5 - 18 * s + c + 72 * f - 58 * An)) + 5e5, x = En * (y + d * o * (m / 2 + g / 24 * (5 - s + 9 * f + 4 * f ** 2) + v / 720 * (61 - 58 * s + c + 600 * f - 330 * An)));
	...
	if (a) {
		...
		if (a == "degrees" && !r || r == "degrees") i = t;
			...
			if (!o && a !== "degrees") i = t * e.getMetersPerUnit();
				...
				e = o(e, e, 2), i = ($t(e.slice(0, 2), e.slice(2, 4)) + $t(e.slice(4, 6), e.slice(6, 8))) / 2;
			}
			let s = r ? rn[r] : e.getMetersPerUnit();
			s !== void 0 && (i /= s);
		}
	}
	return i;
...
function hr(e, t) {
	return e ? typeof e == "string" ? dr(e) : e : dr(t);
}
function gr(e) {
...
function _r(e, t) {
	return sr(), Sr(e, "EPSG:4326", t === void 0 ? "EPSG:3857" : t);
}
function vr(e, t) {
	if (e === t) return !0;
	let n = e.getUnits() === t.getUnits();
	return (e.getCode() === t.getCode() || yr(e, t) === cr) && n;
}
function yr(e, t) {
	let n = e.getCode(), r = t.getCode(), i = Tn(n, r);
	if (i) return i;
	let a = null, o = null;
	for (let n of ir) a ||= n(e), o ||= n(t);
	if (!a && !o) return null;
	let s = "EPSG:4326";
	if (!o) {
		let e = Tn(s, r);
		e && (i = br(a.inverse, e));
	} else if (a) i = br(a.inverse, o.forward);
	else {
		let e = Tn(n, s);
		e && (i = br(e, o.forward));
	}
	return i && (lr(e), lr(t), wn(e, t, i)), i;
}
function br(e, t) {
	return function(n, r, i, a) {
...
function Sr(e, t, n) {
	let r = xr(t, n);
	if (!r) {
		let e = dr(t).getCode(), r = dr(n).getCode();
...
function Er(e, t) {
	return or && !Ut(e, [0, 0]) && e[0] >= -180 && e[0] <= 180 && e[1] >= -90 && e[1] <= 90 && (or = !1, nn("Call useGeographic() from ol/proj once to work with [longitude, latitude] coordinates.")), e;
}
function Dr(e, t) {
	return e;
}
...
function Vr(e, t) {
	let n = Br(e), r = Br(t);
	for (let e = 0; e < 6; ++e) if (Math.round((n[e] - r[e]) * Rr[e]) !== 0) return !1;
	return !0;
}
//#endregion
...
var Kr = Mr(), qr = [NaN, NaN], Jr = class extends Se {
	constructor() {
		super(), this.extent_ = ft(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = me((e, t, n) => {
	...
	containsXY(e, t) {
		return this.closestPointXY(e, t, qr, Number.MIN_VALUE) === 0;
	}
	getClosestPoint(e, t) {
	...
	getExtent(e) {
		if (this.extentRevision_ != this.getRevision()) {
			...
			(isNaN(e[0]) || isNaN(e[1])) && mt(e), this.extentRevision_ = this.getRevision();
		}
	...
	transform(e, t) {
		let n = dr(e), r = n.getUnits() == "tile-pixels" ? function(e, r, i) {
			let a = n.getExtent(), o = n.getWorldExtent(), s = At(o) / At(a);
			Fr(Kr, o[0], o[3], s, -s, 0, 0, 0);
			let c = Hr(e, 0, e.length, i, Kr, r), l = xr(n, t);
			return l ? l(c, c, i) : c;
		} : xr(n, t);
	...
	computeExtent(e) {
		return gt(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, e);
	}
	getCoordinates() {
		return F();
	}
	...
	setFlatCoordinates(e, t) {
		this.stride = Zr(e), this.layout = e, this.flatCoordinates = t;
	}
	setCoordinates(e, t) {
		F();
	}
	...
	rotate(e, t) {
		...
		if (n) {
			...
			Ur(n, 0, n.length, r, e, t, n), this.changed();
		}
	}
	scale(e, t, n) {
		t === void 0 && (t = e), n ||= Et(this.getExtent());
		let r = this.getFlatCoordinates();
		if (r) {
			let i = this.getStride();
			Wr(r, 0, r.length, i, e, t, n, r), this.changed();
		}
	}
	translate(e, t) {
		let n = this.getFlatCoordinates();
		if (n) {
			let r = this.getStride();
			Gr(n, 0, n.length, r, e, t, n), this.changed();
		}
	}
};
function Xr(e) {
...
function ti(e, t, n, r, i, a, o) {
	...
	if (l === 0 && u === 0) d = t;
		...
		if (f > 1) d = n;
			...
			for (let i = 0; i < r; ++i) o[i] = Xe(e[t + i], e[n + i], f);
			o.length = r;
			return;
		} else d = t;
	}
...
function ni(e, t, n, r, i) {
	let a = e[t], o = e[t + 1];
	for (t += r; t < n; t += r) {
		let n = e[t], r = e[t + 1], s = Ge(a, o, n, r);
		s > i && (i = s), a = n, o = r;
	}
	return i;
}
...
function ii(e, t, n, r, i, a, o, s, c, l, u) {
	...
	u ||= [NaN, NaN];
	let p = t + r;
	for (; p < n;) if (ti(e, p - r, p, r, o, s, u), f = Ge(o, s, u[0], u[1]), f < l) {
		for (l = f, d = 0; d < r; ++d) c[d] = u[d];
		c.length = r, p += r;
	} else p += r * Math.max((Math.sqrt(f) - Math.sqrt(l)) / i | 0, 1);
	if (a && (ti(e, n - r, t, r, o, s, u), f = Ge(o, s, u[0], u[1]), f < l)) {
		for (l = f, d = 0; d < r; ++d) c[d] = u[d];
		c.length = r;
	}
	return l;
...
function ai(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (let d = 0, f = n.length; d < f; ++d) {
		let f = n[d];
		l = ii(e, t, f, r, i, a, o, s, c, l, u), t = f;
	}
	return l;
}
//#endregion
...
function fi(e, t, n, r, i) {
	return !St(i, function(i) {
		return !pi(e, t, n, r, i[0], i[1]);
	});
}
...
function mi(e, t, n, r, i, a) {
	if (n.length === 0 || !pi(e, t, n[0], r, i, a)) return !1;
	for (let t = 1, o = n.length; t < o; ++t) if (pi(e, n[t - 1], n[t], r, i, a)) return !1;
	return !0;
}
//#endregion
...
function gi(e, t, n, r, i, a) {
	return a ??= bt(ft(), e, t, n, r), Ft(i, a) ? a[0] >= i[0] && a[2] <= i[2] || a[1] >= i[1] && a[3] <= i[3] || hi(e, t, n, r, function(e, t) {
		return Rt(i, e, t);
	}) : !1;
}
function _i(e, t, n, r, i) {
	return !!(gi(e, t, n, r, i) || pi(e, t, n, r, i[0], i[1]) || pi(e, t, n, r, i[0], i[3]) || pi(e, t, n, r, i[2], i[1]) || pi(e, t, n, r, i[2], i[3]));
}
function vi(e, t, n, r, i) {
	if (!_i(e, t, n[0], r, i)) return !1;
	if (n.length === 1) return !0;
	for (let t = 1, a = n.length; t < a; ++t) if (fi(e, n[t - 1], n[t], r, i) && !gi(e, n[t - 1], n[t], r, i)) return !1;
	return !0;
}
//#endregion
...
function yi(e, t, n, r, i, a, o) {
	...
	for (; l.length > 0;) {
		...
		for (let t = a + r; t < n; t += r) {
			let n = e[t], r = e[t + 1], i = We(n, r, s, d, f, p);
			i > o && (u = t, o = i);
		}
...
function bi(e, t, n, r, i, a, o, s) {
	for (let c = 0, l = n.length; c < l; ++c) {
		let l = n[c];
		o = yi(e, t, l, r, i, a, o), s.push(o), t = l;
	}
	return o;
}
function xi(e, t) {
...
function Si(e, t, n, r, i, a, o) {
	if (t == n) return o;
	let s = xi(e[t], i), c = xi(e[t + 1], i);
	t += r, a[o++] = s, a[o++] = c;
	let l, u;
	do
		if (l = xi(e[t], i), u = xi(e[t + 1], i), t += r, t == n) return a[o++] = l, a[o++] = u, o;
	while (l == s && u == c);
	for (; t < n;) {
		let n = xi(e[t], i), d = xi(e[t + 1], i);
...
function Ci(e, t, n, r, i, a, o, s) {
	for (let c = 0, l = n.length; c < l; ++c) {
		let l = n[c];
		o = Si(e, t, l, r, i, a, o), s.push(o), t = l;
	}
	return o;
}
//#endregion
//#region node_modules/ol/geom/LinearRing.js
var wi = class e extends Yr {
	constructor(e, t) {
	...
	closestPointXY(e, t, n, r) {
		return r < st(this.getExtent(), e, t) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(ni(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), ii(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !0, e, t, n, r));
	}
	getArea() {
		return $r(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride);
	}
	getCoordinates() {
	...
	getSimplifiedGeometryInternal(t) {
		let n = [];
		return n.length = yi(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, n, 0), new e(n, "XY");
	}
	getType() {
		return "LinearRing";
	}
	intersectsExtent(e) {
		return gi(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, e);
	}
	setCoordinates(e, t) {
		this.setLayout(t, e, 1), this.flatCoordinates ||= [], this.flatCoordinates.length = si(this.flatCoordinates, 0, e, this.stride), this.changed();
	}
}, Ti = class e extends Yr {
	constructor(e, t) {
	...
	closestPointXY(e, t, n, r) {
		let i = this.flatCoordinates, a = Ge(e, t, i[0], i[1]);
		if (a < r) {
			let e = this.stride;
	...
	computeExtent(e) {
		return ht(this.flatCoordinates, e);
	}
	getType() {
		return "Point";
	}
	intersectsExtent(e) {
		return ut(e, this.flatCoordinates[0], this.flatCoordinates[1]);
	}
	setCoordinates(e, t) {
		this.setLayout(t, e, 0), this.flatCoordinates ||= [], this.flatCoordinates.length = oi(this.flatCoordinates, 0, e, this.stride), this.changed();
	}
};
//#endregion
...
function Ei(e, t, n, r, i, a, o) {
	...
	for (h.sort(ie), u = h[0], s = 1, c = h.length; s < c; ++s) {
		d = h[s];
		let i = Math.abs(d - u);
...
function Di(e, t, n, r, i) {
	...
	for (let o = 0, s = n.length; o < s; ++o) {
		let s = n[o];
		a = Ei(e, t, s, r, i, 2 * o, a), t = s[s.length - 1];
	}
	return a;
}
//#endregion
...
function ji(e, t, n, r, i) {
	...
	for (let a = 0, o = n.length; a < o; ++a) {
		let o = n[a], s = ki(e, t, o, r);
		(a === 0 ? i && s || !i && !s : i && !s || !i && s) && Oi(e, t, o, r), t = o;
	}
	return t;
}
function Mi(e, t) {
...
var Ni = class e extends Yr {
	...
	appendLinearRing(e) {
		this.flatCoordinates ? ce(this.flatCoordinates, e.getFlatCoordinates()) : this.flatCoordinates = e.getFlatCoordinates().slice(), this.ends_.push(this.flatCoordinates.length), this.changed();
	}
	clone() {
	...
	closestPointXY(e, t, n, r) {
		return r < st(this.getExtent(), e, t) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(ri(this.flatCoordinates, 0, this.ends_, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), ai(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !0, e, t, n, r));
	}
	containsXY(e, t) {
		return mi(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, e, t);
	}
	getArea() {
		return ei(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride);
	}
	getCoordinates(e) {
		let t;
		return e === void 0 ? t = this.flatCoordinates : (t = this.getOrientedFlatCoordinates().slice(), ji(t, 0, this.ends_, this.stride, e)), ui(t, 0, this.ends_, this.stride);
	}
	getEnds() {
		return this.ends_;
	}
	getFlatInteriorPoint() {
		if (this.flatInteriorPointRevision_ != this.getRevision()) {
			let e = Et(this.getExtent());
			this.flatInteriorPoint_ = Ei(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, e, 0), this.flatInteriorPointRevision_ = this.getRevision();
		}
		return this.flatInteriorPoint_;
	}
	getInteriorPoint() {
		return new Ti(this.getFlatInteriorPoint(), "XYM");
	}
	getLinearRingCount() {
		return this.ends_.length;
	}
	getLinearRing(e) {
		return e < 0 || this.ends_.length <= e ? null : new wi(this.flatCoordinates.slice(e === 0 ? 0 : this.ends_[e - 1], this.ends_[e]), this.layout);
	}
	getLinearRings() {
		let e = this.layout, t = this.flatCoordinates, n = this.ends_, r = [], i = 0;
		for (let a = 0, o = n.length; a < o; ++a) {
			let o = n[a], s = new wi(t.slice(i, o), e);
			r.push(s), i = o;
		}
		return r;
	}
	getOrientedFlatCoordinates() {
		if (this.orientedRevision_ != this.getRevision()) {
			...
			Ai(e, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = e : (this.orientedFlatCoordinates_ = e.slice(), this.orientedFlatCoordinates_.length = ji(this.orientedFlatCoordinates_, 0, this.ends_, this.stride)), this.orientedRevision_ = this.getRevision();
		}
		return this.orientedFlatCoordinates_;
	}
	getSimplifiedGeometryInternal(t) {
		let n = [], r = [];
		return n.length = Ci(this.flatCoordinates, 0, this.ends_, this.stride, Math.sqrt(t), n, 0, r), new e(n, "XY", r);
	}
	getType() {
		return "Polygon";
	}
	...
	setCoordinates(e, t) {
		...
		let n = ci(this.flatCoordinates, 0, e, this.stride, this.ends_);
		this.flatCoordinates.length = n.length === 0 ? 0 : n[n.length - 1], this.changed();
	}
};
function Pi(e) {
	if (It(e)) throw Error("Cannot create polygon from empty extent");
	...
	return new Ni(a, "XY", [a.length]);
}
//#endregion
//#region node_modules/ol/resolutionconstraint.js
function Fi(e, t, n, r) {
	let i = H(t) / n[0], a = At(t) / n[1];
	return r ? Math.min(e, Math.max(i, a)) : Math.min(e, Math.min(i, a));
}
function Ii(e, t, n) {
	let r = Math.min(e, t);
	return r *= Math.log(1 + 50 * Math.max(0, e / t - 1)) / 50 + 1, n && (r = Math.max(r, n), r /= Math.log(1 + 50 * Math.max(0, n / e - 1)) / 50 + 1), V(r, n / 2, t * 2);
}
function Li(e, t, n, r) {
	return t = t === void 0 || t, (function(i, a, o, s) {
		if (i !== void 0) {
			let c = e[0], l = e[e.length - 1], u = n ? Fi(c, n, o, r) : c;
			if (s) return t ? Ii(i, u, l) : V(i, l, u);
			let d = Math.floor(oe(e, Math.min(u, i), a));
...
function zi(e, t, n, r, i) {
	return n = n === void 0 || n, (function(a, o, s, c) {
		if (a !== void 0) {
			let o = r ? Fi(e, r, s, i) : e;
			return !n || !c ? V(a, t, o) : Ii(a, o, t);
		}
	});
}
//#endregion
...
var Wi = 0, Gi = class extends Se {
	constructor(e) {
		super(), this.on, this.once, this.un, e = Object.assign({}, e), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = hr(e.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, e.projection && sr(), e.center && (e.center = Er(e.center, this.projection_)), e.extent && (e.extent = Or(e.extent, this.projection_)), this.applyOptions_(e);
	}
	applyOptions_(e) {
		let t = Object.assign({}, e);
		for (let e in Ue) delete t[e];
		...
		let r = qi(e), i = n.constraint, a = Yi(e);
		this.constraints_ = {
			center: r,
			resolution: i,
			rotation: a
	...
	animate(e) {
		...
		for (let e = 0; e < t.length; ++e) {
			let n = arguments[e];
			n.center && (n = Object.assign({}, n), n.center = Er(n.center, this.getProjection())), n.anchor && (n = Object.assign({}, n), n.anchor = Er(n.anchor, this.getProjection())), t[e] = n;
		}
	...
	animateInternal(e) {
		...
		for (; r < t; ++r) {
			...
			if (e.center && (t.sourceCenter = a, t.targetCenter = e.center.slice(), a = t.targetCenter), e.zoom === void 0 ? e.resolution && (t.sourceResolution = o, t.targetResolution = e.resolution, o = t.targetResolution) : (t.sourceResolution = o, t.targetResolution = this.getResolutionForZoom(e.zoom), o = t.targetResolution), e.rotation !== void 0) {
				t.sourceRotation = s;
				let n = Ye(e.rotation - s + Math.PI, 2 * Math.PI) - Math.PI;
				t.targetRotation = s + n, s = t.targetRotation;
			}
			Xi(t) ? t.complete = !0 : i += t.duration, c.push(t);
		}
		this.animations_.push(c), this.setHint(He.ANIMATING, 1), this.updateAnimations_();
	}
	getAnimating() {
	...
	cancelAnimations() {
		...
		for (let t = 0, n = this.animations_.length; t < n; ++t) {
			...
			if (n[0].callback && Ki(n[0].callback, !1), !e) for (let t = 0, r = n.length; t < r; ++t) {
				let r = n[t];
				if (!r.complete) {
					e = r.anchor;
					break;
		...
		for (let n = this.animations_.length - 1; n >= 0; --n) {
			...
			for (let n = 0, a = r.length; n < a; ++n) {
				...
				if (a.sourceRotation !== void 0 && a.targetRotation !== void 0) {
					let e = c === 1 ? Ye(a.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : a.sourceRotation + c * (a.targetRotation - a.sourceRotation);
					if (a.anchor) {
	...
	calculateCenterRotate(e, t) {
		...
		return r !== void 0 && (n = [r[0] - t[0], r[1] - t[1]], Wt(n, e - this.getRotation()), Ht(n, t)), n;
	}
	...
	getCenter() {
		...
		return e && Tr(e, this.getProjection());
	}
	getCenterInternal() {
		return this.get(Ue.CENTER);
	}
	getConstraints() {
	...
	calculateExtent(e) {
		return Dr(this.calculateExtentInternal(e), this.getProjection());
	}
	calculateExtentInternal(e) {
		...
		return B(r !== void 0, "The view rotation is not defined"), Ot(t, n, r, e);
	}
	getMaxResolution() {
	...
	getResolution() {
		return this.get(Ue.RESOLUTION);
	}
	getResolutions() {
		return this.resolutions_;
	}
	getResolutionForExtent(e, t) {
		return this.getResolutionForExtentInternal(Or(e, this.getProjection()), t);
	}
	getResolutionForExtentInternal(e, t) {
		t ||= this.getViewportSizeMinusPadding_();
		let n = H(e) / t[0], r = At(e) / t[1];
		return Math.max(n, r);
	}
	...
	getState() {
		...
		if (i) {
			...
			r = Zi(r, this.getViewportSize_(), [e[0] / 2 + i[3], e[1] / 2 + i[0]], t, n);
		}
		return {
			center: r.slice(0),
	...
	getZoomForResolution(e) {
		...
		if (this.resolutions_) {
			let i = oe(this.resolutions_, e, 1);
	...
	getResolutionForZoom(e) {
		if (this.resolutions_?.length) {
			...
			let t = V(Math.floor(e), 0, this.resolutions_.length - 2), n = this.resolutions_[t] / this.resolutions_[t + 1];
	...
	fit(e, t) {
		let n;
		if (B(Array.isArray(e) || typeof e.getSimplifiedGeometry == "function", "Invalid extent or geometry provided as `geometry`"), Array.isArray(e)) B(!It(e), "Cannot fit empty extent provided as `geometry`"), n = Pi(Or(e, this.getProjection()));
		else if (e.getType() === "Circle") {
			let t = Or(e.getExtent(), this.getProjection());
			n = Pi(t), n.rotate(this.getRotation(), Et(t));
		} else {
			let t = wr();
	...
	fitInternal(e, t) {
		...
		let c = this.getRotation(), l = Math.sin(c), u = Math.cos(c), d = Et(o);
		d[0] += (r[1] - r[3]) / 2 * s, d[1] += (r[0] - r[2]) / 2 * s;
		let f = d[0] * u - d[1] * l, p = d[1] * u + d[0] * l, m = this.getConstrainedCenter([f, p], s), h = t.callback ? t.callback : pe;
		t.duration === void 0 ? (this.targetResolution_ = s, this.targetCenter_ = m, this.applyTargetState_(!1, !0), Ki(h, !0)) : this.animateInternal({
			resolution: s,
			center: m,
			duration: t.duration,
			easing: t.easing
	...
	centerOn(e, t, n) {
		this.centerOnInternal(Er(e, this.getProjection()), t, n);
	}
	centerOnInternal(e, t, n) {
		this.setCenterInternal(Zi(e, t, n, this.getResolution(), this.getRotation()));
	}
	calculateCenterShift(e, t, n, r) {
		let i, a = this.padding_;
		if (a && e) {
			let o = this.getViewportSizeMinusPadding_(-n), s = Zi(e, r, [o[0] / 2 + a[3], o[1] / 2 + a[0]], t, n);
			i = [e[0] - s[0], e[1] - s[1]];
		}
		return i;
	}
	...
	adjustCenter(e) {
		let t = Tr(this.targetCenter_, this.getProjection());
	...
	adjustResolution(e, t) {
		t &&= Er(t, this.getProjection()), this.adjustResolutionInternal(e, t);
	}
	...
	adjustRotation(e, t) {
		t &&= Er(t, this.getProjection()), this.adjustRotationInternal(e, t);
	}
	...
	applyTargetState_(e, t) {
		...
		this.get(Ue.ROTATION) !== r && this.set(Ue.ROTATION, r), this.get(Ue.RESOLUTION) !== a && (this.set(Ue.RESOLUTION, a), this.set("zoom", this.getZoom(), !0)), (!o || !this.get(Ue.CENTER) || !Ut(this.get(Ue.CENTER), o)) && this.set(Ue.CENTER, o), this.getAnimating() && !e && this.cancelAnimations(), this.cancelAnchor_ = void 0;
	}
	resolveConstraints(e, t, n) {
		...
		n ||= e === 0 ? this.cancelAnchor_ : void 0, this.cancelAnchor_ = void 0, (this.getResolution() !== o || this.getRotation() !== i || !this.getCenterInternal() || !Ut(this.getCenterInternal(), s)) && (this.getAnimating() && this.cancelAnimations(), this.animateInternal({
			rotation: i,
			center: s,
			resolution: o,
			duration: e,
	...
	endInteraction(e, t, n) {
		n &&= Er(n, this.getProjection()), this.endInteractionInternal(e, t, n);
	}
	endInteractionInternal(e, t, n) {
		this.getInteracting() && (this.setHint(He.INTERACTING, -1), this.resolveConstraints(e, t, n));
	}
...
function qi(e) {
	if (e.extent !== void 0) {
		...
		return tt(e.extent, e.constrainOnlyCenter, t);
	}
	let t = hr(e.projection, "EPSG:3857");
	if (e.multiWorld !== !0 && t.isGlobal()) {
		let e = t.getExtent().slice();
		return e[0] = -Infinity, e[2] = Infinity, tt(e, !1, !1);
	}
	return nt;
}
function Ji(e) {
	let t, n, r, i = e.minZoom === void 0 ? Wi : e.minZoom, a = e.maxZoom === void 0 ? 28 : e.maxZoom, o = e.zoomFactor === void 0 ? 2 : e.zoomFactor, s = e.multiWorld !== void 0 && e.multiWorld, c = e.smoothResolutionConstraint === void 0 || e.smoothResolutionConstraint, l = e.showFullExtent !== void 0 && e.showFullExtent, u = hr(e.projection, "EPSG:3857"), d = u.getExtent(), f = e.constrainOnlyCenter, p = e.extent;
	if (!s && !p && u.isGlobal() && (f = !1, p = d), e.resolutions !== void 0) {
		let o = e.resolutions;
		n = o[i], r = o[a] === void 0 ? o[o.length - 1] : o[a], t = e.constrainResolution ? Li(o, c, !f && p, l) : zi(n, r, c, !f && p, l);
	} else {
		let s = (d ? Math.max(H(d), At(d)) : 360 * rn.degrees / u.getMetersPerUnit()) / 256 / 2 ** Wi, m = s / 2 ** 28;
		n = e.maxResolution, n === void 0 ? n = s / o ** +i : i = 0, r = e.minResolution, r === void 0 && (r = e.maxZoom === void 0 ? m : e.maxResolution === void 0 ? s / o ** +a : n / o ** +a), a = i + Math.floor(Math.log(n / r) / Math.log(o)), r = n / o ** +(a - i), t = e.constrainResolution ? Ri(o, n, r, c, !f && p, l) : zi(n, r, c, !f && p, l);
	}
	return {
		constraint: t,
		maxResolution: n,
...
function Yi(e) {
	if (e.enableRotation === void 0 || e.enableRotation) {
		...
		return t === void 0 || t === !0 ? Ui() : t === !1 ? Vi : typeof t == "number" ? Hi(t) : Vi;
	}
	return Bi;
}
function Xi(e) {
	return !(e.sourceCenter && e.targetCenter && !Ut(e.sourceCenter, e.targetCenter) || e.sourceResolution !== e.targetResolution || e.sourceRotation !== e.targetRotation);
}
function Zi(e, t, n, r, i) {
...
var Qi = "ol-hidden", $i = "ol-unselectable", ea = "ol-control", ta = "ol-collapsed", na = new RegExp([
	...
	for (let e = 0, r = ra.length; e < r; ++e) {
		let r = t[e + 1];
		r !== void 0 && (n[ra[e]] = typeof r == "string" ? r.trim() : r);
	}
	return isNaN(Number(n.weight)) && n.weight in ia && (n.weight = ia[n.weight]), n.families = n.family.split(/,\s?/).map((e) => e.trim().replace(/^['"]|['"]$/g, "")), n;
};
//#endregion
...
var ma = class extends Se {
	...
	setMap(e) {
		...
		for (let e = 0, t = this.listenerKeys.length; e < t; ++e) N(this.listenerKeys[e]);
		if (this.listenerKeys.length = 0, this.map_ = e, e) {
			let t = this.target_ ?? e.getOverlayContainerStopEvent();
			this.element && t.appendChild(this.element), this.render !== pe && this.listenerKeys.push(M(e, Le.POSTRENDER, this.render, this)), e.render();
		}
	}
	render(e) {}
	setTarget(e) {
	...
	constructor(e) {
		...
		this.toggleButton_ = document.createElement("button"), this.toggleButton_.setAttribute("type", "button"), this.toggleButton_.setAttribute("aria-expanded", String(!this.collapsed_)), this.toggleButton_.title = n, this.toggleButton_.appendChild(s), this.toggleButton_.addEventListener(P.CLICK, this.handleClick_.bind(this), !1);
		let c = t + " " + $i + " " + ea + (this.collapsed_ && this.collapsible_ ? " " + ta : "") + (this.collapsible_ ? "" : " ol-uncollapsible"), l = this.element;
	...
	async updateElement_(e) {
		...
		let t = await Promise.all(this.collectSourceAttributions_(e).map((e) => he(() => e))), n = t.length > 0;
		if (this.renderedVisible_ != n && (this.element.style.display = n ? "" : "none", this.renderedVisible_ = n), !le(t, this.renderedAttributions_)) {
			ua(this.ulElement_);
	...
	handleToggle_() {
		this.element.classList.toggle(ta), this.collapsed_ ? la(this.collapseLabel_, this.label_) : la(this.label_, this.collapseLabel_), this.collapsed_ = !this.collapsed_, this.toggleButton_.setAttribute("aria-expanded", String(!this.collapsed_));
	}
	getCollapsible() {
	...
	constructor(e) {
		...
		a.className = t + "-reset", a.setAttribute("type", "button"), a.title = i, a.appendChild(this.label_), a.addEventListener(P.CLICK, this.handleClick_.bind(this), !1);
		let o = t + " " + $i + " " + ea, s = this.element;
		s.className = o, s.appendChild(a), this.callResetNorth_ = e.resetNorth ? e.resetNorth : void 0, this.duration_ = e.duration === void 0 ? 250 : e.duration, this.autoHide_ = e.autoHide === void 0 || e.autoHide, this.rotation_ = void 0, this.autoHide_ && this.element.classList.add(Qi);
	}
	handleClick_(e) {
	...
	render(e) {
		...
		if (n != this.rotation_) {
			let e = "rotate(" + n + "rad)";
			if (this.autoHide_) {
				let e = this.element.classList.contains(Qi);
				!e && n === 0 ? this.element.classList.add(Qi) : e && n !== 0 && this.element.classList.remove(Qi);
			}
	...
	constructor(e) {
		...
		l.className = r, l.setAttribute("type", "button"), l.title = s, l.appendChild(typeof a == "string" ? document.createTextNode(a) : a), l.addEventListener(P.CLICK, this.handleClick_.bind(this, n), !1);
		let u = document.createElement("button");
		u.className = i, u.setAttribute("type", "button"), u.title = c, u.appendChild(typeof o == "string" ? document.createTextNode(o) : o), u.addEventListener(P.CLICK, this.handleClick_.bind(this, -n), !1);
		let d = t + " " + $i + " " + ea, f = this.element;
...
function va(e) {
	e ||= {};
	let t = new Te();
	return (e.zoom === void 0 || e.zoom) && t.push(new _a(e.zoomOptions)), (e.rotate === void 0 || e.rotate) && t.push(new ga(e.rotateOptions)), (e.attribution === void 0 || e.attribution) && t.push(new ha(e.attributionOptions)), t;
}
//#endregion
...
var Ea = function(e) {
	...
	return !(n instanceof ShadowRoot ? n.host : t).hasAttribute("tabindex") || Da(e);
}, ka = de, Aa = function(e) {
	let t = e.originalEvent;
	return "pointerId" in t && t.button == 0 && !(ke && Ae && t.ctrlKey);
}, ja = function(e) {
	let t = e.originalEvent;
	return !t.altKey && !(t.metaKey || t.ctrlKey) && !t.shiftKey;
}, Ma = function(e) {
	...
	handleEvent(e) {
		...
		if (this.updateTrackedPointers_(e), this.handlingDownUpSequence) {
			if (e.type == L.POINTERDRAG) this.handleDragEvent(e), e.originalEvent.preventDefault();
			else if (e.type == L.POINTERUP) {
				let t = this.handleUpEvent(e);
				this.handlingDownUpSequence = t && this.targetPointers.length > 0;
			}
		} else if (e.type == L.POINTERDOWN) {
			let n = this.handleDownEvent(e);
			this.handlingDownUpSequence = n, t = this.stopDown(n);
		} else e.type == L.POINTERMOVE && this.handleMoveEvent(e);
		return !t;
	}
	handleMoveEvent(e) {}
	handleUpEvent(e) {
...
var za = class extends La {
	constructor(e) {
		super({ stopDown: fe }), e ||= {}, this.kinetic_ = e.kinetic, this.lastCentroid = null, this.lastPointersCount_, this.panning_ = !1;
		let t = e.condition ? e.condition : Ta(ja, Ia);
		this.condition_ = e.onFocusOnly ? Ta(Oa, t) : t, this.noKinetic_ = !1;
	}
	handleDragEvent(e) {
		let t = e.map;
		this.panning_ || (this.panning_ = !0, t.getView().beginInteraction());
		let n = this.targetPointers, r = t.getEventPixel(Ra(n));
		if (n.length == this.lastPointersCount_) {
			if (this.kinetic_ && this.kinetic_.update(r[0], r[1]), this.lastCentroid) {
				...
				Gt(t, n.getResolution()), Wt(t, n.getRotation()), n.adjustCenterInternal(t);
			}
	...
	constructor(e) {
		e ||= {}, super({ stopDown: fe }), this.condition_ = e.condition ? e.condition : Ea, this.lastAngle_ = void 0, this.duration_ = e.duration === void 0 ? 250 : e.duration;
	}
	handleDragEvent(e) {
		if (!Fa(e)) return;
		let t = e.map, n = t.getView();
		if (n.getConstraints().rotation === Bi) return;
	...
	handleUpEvent(e) {
		return !Fa(e) || (e.map.getView().endInteraction(this.duration_), !1);
	}
	handleDownEvent(e) {
		return Fa(e) && Aa(e) && this.condition_(e) ? (e.map.getView().beginInteraction(), this.lastAngle_ = void 0, !0) : !1;
	}
}, Va = class extends ne {
	constructor(e) {
	...
	createOrUpdateGeometry() {
		...
		n[4] = n[0].slice(), this.geometry_ ? this.geometry_.setCoordinates([n]) : this.geometry_ = new Ni([n]);
	}
	getGeometry() {
	...
	constructor(e) {
		super(), this.on, this.once, this.un, e ??= {}, this.box_ = new Va(e.className || "ol-dragbox"), this.minArea_ = e.minArea ?? 64, e.onBoxEnd && (this.onBoxEnd = e.onBoxEnd), this.startPixel_ = null, this.condition_ = e.condition ?? Aa, this.boxEndCondition_ = e.boxEndCondition ?? this.defaultBoxEndCondition;
	}
	...
	handleDragEvent(e) {
		this.startPixel_ && (this.box_.setPixels(this.startPixel_, e.pixel), this.dispatchEvent(new Ua(Ha.BOXDRAG, e.coordinate, e)));
	}
	handleUpEvent(e) {
		if (!this.startPixel_) return !1;
		let t = this.boxEndCondition_(e, this.startPixel_, e.pixel);
		return t && this.onBoxEnd(e), this.dispatchEvent(new Ua(t ? Ha.BOXEND : Ha.BOXCANCEL, e.coordinate, e)), this.box_.setMap(null), this.startPixel_ = null, !1;
	}
	handleDownEvent(e) {
		return this.condition_(e) ? (this.startPixel_ = e.pixel, this.box_.setMap(e.map), this.box_.setPixels(this.startPixel_, this.startPixel_), this.dispatchEvent(new Ua(Ha.BOXSTART, e.coordinate, e)), !0) : !1;
	}
	onBoxEnd(e) {}
	setActive(e) {
		e || (this.box_.setMap(null), this.startPixel_ &&= (this.dispatchEvent(new Ua(Ha.BOXCANCEL, this.startPixel_, null)), null)), super.setActive(e);
	}
	setMap(e) {
		this.getMap() && (this.box_.setMap(null), this.startPixel_ &&= (this.dispatchEvent(new Ua(Ha.BOXCANCEL, this.startPixel_, null)), null)), super.setMap(e);
	}
}, Ga = class extends Wa {
	constructor(e) {
		e ||= {};
		let t = e.condition ? e.condition : Na;
		super({
			condition: t,
	...
	handleEvent(e) {
		...
		if (e.type == P.KEYDOWN) {
			...
			if (this.condition_(e) && (r == Ka.DOWN || r == Ka.LEFT || r == Ka.RIGHT || r == Ka.UP)) {
				let i = e.map.getView(), a = i.getResolution() * this.pixelDelta_, o = 0, s = 0;
				r == Ka.DOWN ? s = -a : r == Ka.LEFT ? o = -a : r == Ka.RIGHT ? o = a : s = a;
				let c = [o, s];
				Wt(c, i.getRotation()), Sa(i, c, this.duration_), n.preventDefault(), t = !0;
			}
		}
		return !t;
	}
	...
	handleEvent(e) {
		let t = !1;
		if (e.type == P.KEYDOWN || e.type == P.KEYPRESS) {
			let n = e.originalEvent, r = n.key;
			if (this.condition_(e) && (r === "+" || r === "-")) {
				let i = e.map, a = r === "+" ? this.delta_ : -this.delta_;
				Ca(i.getView(), a, void 0, this.duration_), n.preventDefault(), t = !0;
			}
		}
		return !t;
	}
}, Ya = 40, Xa = 300, Za = 3, Qa = class extends xa {
	constructor(e) {
		...
		let t = e.condition ? e.condition : ka;
		this.condition_ = e.onFocusOnly ? Ta(Oa, t) : t, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300, this.ctrlKeyPressed_ = !1, this.ctrlKeyListenerKeys_ = [];
	}
	setMap(e) {
		if (this.ctrlKeyListenerKeys_.forEach(N), this.ctrlKeyListenerKeys_.length = 0, this.ctrlKeyPressed_ = !1, super.setMap(e), e) {
			let t = e.getOwnerDocument();
			this.ctrlKeyListenerKeys_.push(M(t, "keydown", (e) => {
	...
	handleEvent(e) {
		if (!this.condition_(e) || e.type !== P.WHEEL) return !0;
		...
		switch (n.deltaMode) {
			case WheelEvent.DOM_DELTA_LINE:
				i *= Ya;
				break;
			case WheelEvent.DOM_DELTA_PAGE: i *= Xa;
		}
		if (i === 0) return !1;
		this.lastDelta_ = i;
		let a = Date.now();
		...
		let o = t.getView();
		if (this.mode_ === "trackpad") return this.trackpadTimeoutId_ ? clearTimeout(this.trackpadTimeoutId_) : (o.getAnimating() && o.cancelAnimations(), o.beginInteraction()), this.trackpadTimeoutId_ = setTimeout(this.endInteraction_.bind(this), this.timeout_), r && (i *= Za), o.adjustZoom(-i / this.deltaPerZoom_, this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null), this.startTime_ = a, !1;
		this.totalDelta_ += i;
	...
	handleWheelZoom_(e) {
		...
		let n = -V(this.totalDelta_, -this.maxDelta_ * this.deltaPerZoom_, this.maxDelta_ * this.deltaPerZoom_) / this.deltaPerZoom_;
		(t.getConstrainResolution() || this.constrainResolution_) && (n = n ? n > 0 ? 1 : -1 : 0), Ca(t, n, this.lastAnchor_ ? e.getCoordinateFromPixel(this.lastAnchor_) : null, this.duration_), this.mode_ = void 0, this.totalDelta_ = 0, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_ = void 0;
	}
	setMouseAnchor(e) {
	...
	constructor(e) {
		e ||= {};
		let t = e;
		t.stopDown ||= fe, super(t), this.anchor_ = null, this.lastAngle_ = void 0, this.rotating_ = !1, this.rotationDelta_ = 0, this.threshold_ = e.threshold === void 0 ? .3 : e.threshold, this.duration_ = e.duration === void 0 ? 250 : e.duration;
	}
	handleDragEvent(e) {
		...
		o.getConstraints().rotation !== Bi && (this.anchor_ = a.getCoordinateFromPixelInternal(a.getEventPixel(Ra(this.targetPointers))), this.rotating_ && (a.render(), o.adjustRotationInternal(t, this.anchor_)));
	}
	handleUpEvent(e) {
	...
	constructor(e) {
		e ||= {};
		let t = e;
		t.stopDown ||= fe, super(t), this.anchor_ = null, this.duration_ = e.duration === void 0 ? 400 : e.duration, this.lastDistance_ = void 0, this.lastScaleDelta_ = 1;
	}
	handleDragEvent(e) {
		...
		t != 1 && (this.lastScaleDelta_ = t), this.anchor_ = s.getCoordinateFromPixelInternal(s.getEventPixel(Ra(this.targetPointers))), s.render(), c.adjustResolutionInternal(t, this.anchor_);
	}
	handleUpEvent(e) {
		if (this.targetPointers.length < 2) {
...
function to(e) {
	e ||= {};
	let t = new Te(), n = new ya(-.005, .05, 100);
	return (e.altShiftDragRotate === void 0 || e.altShiftDragRotate) && t.push(new Ba()), (e.doubleClickZoom === void 0 || e.doubleClickZoom) && t.push(new wa({
		delta: e.zoomDelta,
		duration: e.zoomDuration
	})), (e.dragPan === void 0 || e.dragPan) && t.push(new za({
		onFocusOnly: e.onFocusOnly,
		kinetic: n
	})), (e.pinchRotate === void 0 || e.pinchRotate) && t.push(new $a()), (e.pinchZoom === void 0 || e.pinchZoom) && t.push(new eo({ duration: e.zoomDuration })), (e.keyboard === void 0 || e.keyboard) && (t.push(new qa()), t.push(new Ja({
		delta: e.zoomDelta,
		duration: e.zoomDuration
	}))), (e.mouseWheelZoom === void 0 || e.mouseWheelZoom) && t.push(new Qa({
		onFocusOnly: e.onFocusOnly,
		duration: e.zoomDuration
	})), (e.shiftDragZoom === void 0 || e.shiftDragZoom) && t.push(new Ga({ duration: e.zoomDuration })), t;
}
//#endregion
...
var W = {
	...
	constructor(e) {
		...
		let t = Object.assign({}, e);
		typeof e.properties == "object" && (delete t.properties, Object.assign(t, e.properties)), t[W.OPACITY] = e.opacity === void 0 ? 1 : e.opacity, B(typeof t[W.OPACITY] == "number", "Layer opacity must be a number"), t[W.VISIBLE] = e.visible === void 0 || e.visible, t[W.Z_INDEX] = e.zIndex, t[W.MAX_RESOLUTION] = e.maxResolution === void 0 ? Infinity : e.maxResolution, t[W.MIN_RESOLUTION] = e.minResolution === void 0 ? 0 : e.minResolution, t[W.MIN_ZOOM] = e.minZoom === void 0 ? -Infinity : e.minZoom, t[W.MAX_ZOOM] = e.maxZoom === void 0 ? Infinity : e.maxZoom, this.className_ = t.className === void 0 ? "ol-layer" : t.className, delete t.className, this.setProperties(t), this.state_ = null;
	}
	getBackground() {
	...
	setOpacity(e) {
		B(typeof e == "number", "Layer opacity must be a number"), this.set(W.OPACITY, e);
	}
	setVisible(e) {
...
}, ao = { LAYERS: "layers" }, oo = class e extends no {
	constructor(e) {
		e ||= {};
		let t = Object.assign({}, e);
		delete t.layers;
		let n = e.layers;
		super(t), this.on, this.once, this.un, this.layersListenerKeys_ = [], this.listenerKeys_ = {}, this.addChangeListener(ao.LAYERS, this.handleLayersChanged_), n ? Array.isArray(n) ? n = new Te(n.slice(), { unique: !0 }) : B(typeof n.getArray == "function", "Expected `layers` to be an array or a `Collection`") : n = new Te(void 0, { unique: !0 }), this.setLayers(n);
	}
	handleLayerChange_() {
		this.changed();
	}
	handleLayersChanged_() {
		...
		this.layersListenerKeys_.push(M(e, k.ADD, this.handleLayersAdd_, this), M(e, k.REMOVE, this.handleLayersRemove_, this));
		for (let e in this.listenerKeys_) this.listenerKeys_[e].forEach(N);
		ee(this.listenerKeys_);
		let t = e.getArray();
		for (let e = 0, n = t.length; e < n; e++) {
			let n = t[e];
			this.registerLayerListeners_(n), this.dispatchEvent(new io(ro.ADDLAYER, n));
		}
		this.changed();
	}
	registerLayerListeners_(t) {
		let n = [M(t, A.PROPERTYCHANGE, this.handleLayerChange_, this), M(t, P.CHANGE, this.handleLayerChange_, this)];
		t instanceof e && n.push(M(t, ro.ADDLAYER, this.handleLayerGroupAdd_, this), M(t, ro.REMOVELAYER, this.handleLayerGroupRemove_, this)), this.listenerKeys_[I(t)] = n;
	}
	handleLayerGroupAdd_(e) {
		this.dispatchEvent(new io(ro.ADDLAYER, e.layer));
	}
	handleLayerGroupRemove_(e) {
		this.dispatchEvent(new io(ro.REMOVELAYER, e.layer));
	}
	handleLayersAdd_(e) {
		let t = e.element;
		this.registerLayerListeners_(t), this.dispatchEvent(new io(ro.ADDLAYER, t)), this.changed();
	}
	handleLayersRemove_(e) {
		let t = e.element, n = I(t);
		this.listenerKeys_[n].forEach(N), delete this.listenerKeys_[n], this.dispatchEvent(new io(ro.REMOVELAYER, t)), this.changed();
	}
	getLayers() {
		return this.get(ao.LAYERS);
	}
	setLayers(e) {
		let t = this.getLayers();
		if (t) {
			let e = t.getArray();
			for (let t = 0, n = e.length; t < n; ++t) this.dispatchEvent(new io(ro.REMOVELAYER, e[t]));
		}
		this.set(ao.LAYERS, e);
	}
	getLayersArray(e) {
	...
	getLayerStatesArray(e) {
		...
		for (let e = n, a = t.length; e < a; e++) {
			let n = t[e];
			n.opacity *= r.opacity, n.visible = n.visible && r.visible, n.maxResolution = Math.min(n.maxResolution, r.maxResolution), n.minResolution = Math.max(n.minResolution, r.minResolution), n.minZoom = Math.max(n.minZoom, r.minZoom), n.maxZoom = Math.min(n.maxZoom, r.maxZoom), r.extent !== void 0 && (n.extent = n.extent === void 0 ? r.extent : jt(n.extent, r.extent)), n.zIndex === void 0 && (n.zIndex = i);
		}
		return t;
	}
	getSourceState() {
	...
	constructor(e) {
		let t = Object.assign({}, e);
		delete t.source, super(t), this.on, this.once, this.un, this.mapPrecomposeKey_ = null, this.mapRenderKey_ = null, this.sourceChangeKey_ = null, this.renderer_ = null, this.sourceReady_ = !1, this.rendered = !1, e.render && (this.render = e.render), e.map && this.setMap(e.map), this.addChangeListener(W.SOURCE, this.handleSourcePropertyChange_);
	...
	handleSourcePropertyChange_() {
		this.sourceChangeKey_ &&= (N(this.sourceChangeKey_), null), this.sourceReady_ = !1;
		let e = this.getSource();
		e && (this.sourceChangeKey_ = M(e, P.CHANGE, this.handleSourceChange_, this), e.getState() === "ready" && (this.sourceReady_ = !0, setTimeout(() => {
	...
	isVisible(e) {
		...
		!e && n && (e = n.getView()), t = e instanceof Gi ? {
		...
		return lo(r, t.viewState) && (!i || Ft(i, t.extent));
	}
	getAttributions(e) {
		if (!this.isVisible(e)) return [];
		let t = this.getSource()?.getAttributions();
		if (!t) return [];
		let n = t(e instanceof Gi ? e.getViewStateAndExtent() : e);
	...
	setMapInternal(e) {
		e || this.unrender(), this.set(W.MAP, e);
	}
	getMapInternal() {
		return this.get(W.MAP);
	}
	setMap(e) {
		this.mapPrecomposeKey_ &&= (N(this.mapPrecomposeKey_), null), e || this.changed(), this.mapRenderKey_ &&= (N(this.mapRenderKey_), null), e && (this.mapPrecomposeKey_ = M(e, so.PRECOMPOSE, this.handlePrecompose_, this), this.mapRenderKey_ = M(this, P.CHANGE, e.render, e), this.changed());
	}
	handlePrecompose_(e) {
...
function uo(e, t, n = 0, r = e.length - 1, i = po) {
	for (; r > n;) {
		if (r - n > 600) {
			let a = r - n + 1, o = t - n + 1, s = Math.log(a), c = .5 * Math.exp(2 * s / 3), l = .5 * Math.sqrt(s * c * (a - c) / a) * (o - a / 2 < 0 ? -1 : 1);
			uo(e, t, Math.max(n, Math.floor(t - o * c / a + l)), Math.min(r, Math.floor(t + (a - o) * c / a + l)), i);
		}
		let a = e[t], o = n, s = r;
		for (fo(e, n, t), i(e[r], a) > 0 && fo(e, n, r); o < s;) {
			for (fo(e, o, s), o++, s--; i(e[o], a) < 0;) o++;
			for (; i(e[s], a) > 0;) s--;
		}
		i(e[n], a) === 0 ? fo(e, n, s) : (s++, fo(e, s, r)), s <= t && (n = s + 1), t <= s && (r = s - 1);
	}
}
function fo(e, t, n) {
	let r = e[t];
...
var mo = class {
	...
	search(e) {
		...
		for (; t;) {
			for (let a = 0; a < t.children.length; a++) {
				...
				Eo(e, s) && (t.leaf ? n.push(o) : To(e, s) ? this._all(o, n) : i.push(o));
			}
			t = i.pop();
		}
		return n;
	...
	remove(e, t) {
		...
		for (; n || i.length;) {
			if (n || (n = i.pop(), s = i[i.length - 1], o = a.pop(), c = !0), n.leaf) {
				let r = ho(e, n.children, t);
				if (r !== -1) return n.children.splice(r, 1), i.push(n), this._condense(i), this;
			}
			!c && !n.leaf && To(n, r) ? (i.push(n), a.push(o), o = 0, s = n, n = n.children[0]) : s ? (o++, n = s.children[o], c = !1) : n = null;
		}
		return this;
	}
	toBBox(e) {
	...
	_build(e, t, n, r) {
		...
		if (i <= a) return o = Do(e.slice(t, n + 1)), go(o, this.toBBox), o;
		r || (r = Math.ceil(Math.log(i) / Math.log(a)), a = Math.ceil(i / a ** (r - 1))), o = Do([]), o.leaf = !1, o.height = r;
		let s = Math.ceil(i / a), c = s * Math.ceil(Math.sqrt(a));
		Oo(e, t, n, c, this.compareMinX);
		for (let i = t; i <= n; i += c) {
			let t = Math.min(i + c - 1, n);
			Oo(e, i, t, s, this.compareMinY);
			for (let n = i; n <= t; n += s) {
				let i = Math.min(n + s - 1, t);
				o.children.push(this._build(e, n, i, r - 1));
			}
		}
		return go(o, this.toBBox), o;
	}
	_chooseSubtree(e, t, n, r) {
		for (; r.push(t), !(t.leaf || r.length - 1 === n);) {
			let n = Infinity, r = Infinity, i;
			for (let a = 0; a < t.children.length; a++) {
				let o = t.children[a], s = xo(o), c = Co(e, o) - s;
	...
	_insert(e, t, n) {
		...
		for (a.children.push(e), vo(a, r); t >= 0 && i[t].children.length > this._maxEntries;) this._split(i, t), t--;
		this._adjustParentBBoxes(r, i, t);
	}
	_split(e, t) {
		let n = e[t], r = n.children.length, i = this._minEntries;
		this._chooseSplitAxis(n, i, r);
		let a = this._chooseSplitIndex(n, i, r), o = Do(n.children.splice(a, n.children.length - a));
		o.height = n.height, o.leaf = n.leaf, go(n, this.toBBox), go(o, this.toBBox), t ? e[t - 1].children.push(o) : this._splitRoot(n, o);
	}
	_splitRoot(e, t) {
		this.data = Do([e, t]), this.data.height = e.height + 1, this.data.leaf = !1, go(this.data, this.toBBox);
	}
	_chooseSplitIndex(e, t, n) {
		let r, i = Infinity, a = Infinity;
		for (let o = t; o <= n - t; o++) {
			let t = _o(e, 0, o, this.toBBox), s = _o(e, o, n, this.toBBox), c = wo(t, s), l = xo(t) + xo(s);
			c < i ? (i = c, r = o, a = l < a ? l : a) : c === i && l < a && (a = l, r = o);
		}
		return r || n - t;
	}
	_chooseSplitAxis(e, t, n) {
		let r = e.leaf ? this.compareMinX : yo, i = e.leaf ? this.compareMinY : bo;
		this._allDistMargin(e, t, n, r) < this._allDistMargin(e, t, n, i) && e.children.sort(r);
	}
	_allDistMargin(e, t, n, r) {
		e.children.sort(r);
		let i = this.toBBox, a = _o(e, 0, t, i), o = _o(e, n - t, n, i), s = So(a) + So(o);
		for (let r = t; r < n - t; r++) {
			let t = e.children[r];
			vo(a, e.leaf ? i(t) : t), s += So(a);
		}
		for (let r = n - t - 1; r >= t; r--) {
			let t = e.children[r];
			vo(o, e.leaf ? i(t) : t), s += So(o);
		}
		return s;
	}
	_adjustParentBBoxes(e, t, n) {
		for (let r = n; r >= 0; r--) vo(t[r], e);
	}
	_condense(e) {
		for (let t = e.length - 1, n; t >= 0; t--) e[t].children.length === 0 ? t > 0 ? (n = e[t - 1].children, n.splice(n.indexOf(e[t]), 1)) : this.clear() : go(e[t], this.toBBox);
	}
};
function ho(e, t, n) {
...
function go(e, t) {
	_o(e, 0, e.children.length, t, e);
}
function _o(e, t, n, r, i) {
	i ||= Do(null), i.minX = Infinity, i.minY = Infinity, i.maxX = -Infinity, i.maxY = -Infinity;
	for (let a = t; a < n; a++) {
		let t = e.children[a];
		vo(i, e.leaf ? r(t) : t);
	}
...
function jo() {
	return Ao ||= U(1, 1, void 0, {
		willReadFrequently: !0,
		desynchronized: !0
	}), Ao;
}
var Mo = /^rgba?\(\s*(\d+%?)\s+(\d+%?)\s+(\d+%?)(?:\s*\/\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i, No = /^rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)(?:\s*,\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i, Po = /^rgba?\(\s*(\d+%)\s*,\s*(\d+%)\s*,\s*(\d+%)(?:\s*,\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i, Fo = /^#([\da-f]{3,4}|[\da-f]{6}|[\da-f]{8})$/i;
function Io(e, t) {
...
function Ro(e) {
	if (e.toLowerCase().startsWith("rgb")) {
		let t = e.match(No) || e.match(Mo) || e.match(Po);
		if (t) {
			let e = t[4], n = 100 / 255;
			return [
				V(Io(t[1], n) + .5 | 0, 0, 255),
				V(Io(t[2], n) + .5 | 0, 0, 255),
				V(Io(t[3], n) + .5 | 0, 0, 255),
				e === void 0 ? 1 : V(Io(e, 100), 0, 1)
			];
		}
		Lo(e);
	}
	...
	t.fillStyle = "#abcdef";
	let n = t.fillStyle;
	t.fillStyle = e, t.fillStyle === n && (t.fillStyle = "#fedcba", n = t.fillStyle, t.fillStyle = e, t.fillStyle === n && Lo(e));
	let r = t.fillStyle;
	if (r.startsWith("#") || r.startsWith("rgba")) return Ro(r);
	t.clearRect(0, 0, 1, 1), t.fillRect(0, 0, 1, 1);
	let i = Array.from(t.getImageData(0, 0, 1, 1).data);
	return i[3] = Ze(i[3] / 255, 3), i;
}
function zo(e) {
...
function Jo(e) {
	let t = Ko(e[0]), n = Ko(e[1]), r = Ko(e[2]), i = qo(t * .222488403 + n * .716873169 + r * .06060791), a = 500 * (qo(t * .452247074 + n * .399439023 + r * .148375274) - i), o = 200 * (i - qo(t * .016863605 + n * .117638439 + r * .865350722)), s = 180 / Math.PI * Math.atan2(o, a);
	return [
		116 * i - 16,
		Math.sqrt(a * a + o * o),
		s < 0 ? s + 360 : s,
...
function Yo(e) {
	let t = (e[0] + 16) / 116, n = e[1], r = e[2] * Math.PI / 180, i = Go(t), a = Go(t + n / 500 * Math.cos(r)), o = Go(t - n / 200 * Math.sin(r)), s = Wo(a * 3.021973625 - i * 1.617392459 - o * .404875592), c = Wo(a * -.943766287 + i * 1.916279586 + o * .027607165), l = Wo(a * .069407491 - i * .22898585 + o * 1.159737864);
	return [
		V(s + .5 | 0, 0, 255),
		V(c + .5 | 0, 0, 255),
		V(l + .5 | 0, 0, 255),
...
function Xo(e) {
	if (e === "none") return ko;
	if (Vo.hasOwnProperty(e)) return Vo[e];
	if (Ho >= Bo) {
		let e = 0;
		for (let t in Vo) e++ & 3 || (delete Vo[t], --Ho);
	}
	let t = Ro(e);
	t.length !== 4 && Lo(e);
	for (let n of t) isNaN(n) && Lo(e);
	return Vo[e] = t, ++Ho, t;
}
function Zo(e) {
	return Array.isArray(e) ? e : Xo(e);
}
function Qo(e) {
	let t = e[0];
	t != (t | 0) && (t = t + .5 | 0);
...
var ns = 0, rs = 1 << ns++, G = 1 << ns++, is = 1 << ns++, as = 1 << ns++, os = 1 << ns++, ss = 1 << ns++, cs = 2 ** ns - 1, ls = {
	[rs]: "boolean",
	[G]: "number",
	[is]: "string",
	[as]: "color",
	[os]: "number[]",
	[ss]: "size"
}, us = Object.keys(ls).map(Number).sort(ie);
function ds(e) {
	return e in ls;
}
function fs(e) {
...
function q(e, t, n) {
	switch (typeof e) {
		case "boolean":
			if (hs(t, is)) return new K(is, e ? "true" : "false");
			if (!ps(t, rs)) throw Error(`got a boolean, but expected ${fs(t)}`);
			return new K(rs, e);
		case "number":
			if (hs(t, ss)) return new K(ss, ts(e));
			if (hs(t, rs)) return new K(rs, !!e);
			if (hs(t, is)) return new K(is, e.toString());
			if (!ps(t, G)) throw Error(`got a number, but expected ${fs(t)}`);
			return new K(G, e);
		case "string":
			if (hs(t, as)) return new K(as, Xo(e));
			if (hs(t, rs)) return new K(rs, !!e);
			if (!ps(t, is)) throw Error(`got a string, but expected ${fs(t)}`);
			return new K(is, e);
	}
	...
	if (typeof e[0] == "string") return Fs(e, t, n);
	...
	if (hs(t, as)) {
		if (e.length === 3) return new K(as, [...e, 1]);
		if (e.length === 4) return new K(as, e);
...
var J = {
	...
	[J.Get]: Z(Y(1, Infinity), ys),
	[J.Var]: bs(),
	[J.Has]: Z(Y(1, Infinity), ys),
	[J.Id]: Z(xs, Ts),
	[J.Concat]: Z(Y(2, Infinity), X(is)),
	[J.GeometryType]: Z(Ss, Ts),
	[J.LineMetric]: Z(Cs, Ts),
	[J.Resolution]: Z(ws, Ts),
	[J.Zoom]: Z(ws, Ts),
	[J.Time]: Z(ws, Ts),
	[J.Any]: Z(Y(2, Infinity), X(rs)),
	[J.All]: Z(Y(2, Infinity), X(rs)),
	[J.Not]: Z(Y(1, 1), X(rs)),
	[J.Equal]: Z(Y(2, 2), Ds()),
	[J.NotEqual]: Z(Y(2, 2), Ds()),
	[J.GreaterThan]: Z(Y(2, 2), X(G)),
	[J.GreaterThanOrEqualTo]: Z(Y(2, 2), X(G)),
	[J.LessThan]: Z(Y(2, 2), X(G)),
	[J.LessThanOrEqualTo]: Z(Y(2, 2), X(G)),
	[J.Multiply]: Z(Y(2, Infinity), Es),
	[J.Coalesce]: Z(Y(2, Infinity), Es),
	[J.Divide]: Z(Y(2, 2), X(G)),
	[J.Add]: Z(Y(2, Infinity), X(G)),
	[J.Subtract]: Z(Y(2, 2), X(G)),
	[J.Clamp]: Z(Y(3, 3), X(G)),
	[J.Mod]: Z(Y(2, 2), X(G)),
	[J.Pow]: Z(Y(2, 2), X(G)),
	[J.Abs]: Z(Y(1, 1), X(G)),
	...
	[J.Atan]: Z(Y(1, 2), X(G)),
	[J.Sqrt]: Z(Y(1, 1), X(G)),
	[J.Match]: Z(Y(4, Infinity), ks, As),
	[J.Between]: Z(Y(3, 3), X(G)),
	[J.Interpolate]: Z(Y(6, Infinity), ks, js),
	[J.Case]: Z(Y(3, Infinity), Os, Ms),
	[J.In]: Z(Y(2, 2), Ns),
	[J.Number]: Z(Y(1, Infinity), X(cs)),
	[J.String]: Z(Y(1, Infinity), X(cs)),
	[J.Array]: Z(Y(1, Infinity), X(G)),
	[J.Color]: Z(Y(1, 4), X(G)),
	[J.Band]: Z(Y(1, 3), X(G)),
	[J.Palette]: Z(Y(2, 2), Ps),
	[J.ToString]: Z(Y(1, 1), X(rs | G | is | as))
};
function ys(e, t, n) {
...
function bs() {
	return function(e, t, n) {
		...
		if (a !== void 0) {
			let e = q(a, cs, n);
			if (!(e instanceof K)) throw Error(`style variables should only be literal values (no expressions!), variable name: ${r}`);
			let o = e.type;
			if (typeof a == "string" && ms(i, as) && !ms(i, is) ? o = as : Array.isArray(a) && a.length === 2 && ms(i, ss) && !ms(i, os) && (o = ss), i &= o, i === 0) throw Error(`the type expected from the var operator (${fs(t)}) did not have any overlap with the type of the corresponding style variables (${fs(o)}), variable name: ${r}`);
		}
		...
		return n.variables.set(r, i), new gs(i, "var", new K(is, r));
	};
}
function xs(e, t, n) {
	n.featureId = !0;
...
function As(e, t, n) {
	let r = e.length - 1, i = q(e[e.length - 1], t, n), a = is | G | rs, o = Array(r - 2);
...
function Ms(e, t, n) {
	let r = q(e[e.length - 1], t, n), i = Array(e.length - 1);
...
function Ps(e, t, n) {
	...
	for (let e = 0; e < a.length; e++) {
		...
		if (!(t instanceof K)) throw Error(`the palette color at index ${e} must be a literal value`);
		a[e] = t;
	}
	return [r, ...a];
}
...
function Is(e) {
	...
	switch (t) {
		...
		case "GeometryCollection": return Is(e.getGeometries()[0]);
		default: return "";
	}
}
//#endregion
...
function zs(e, t) {
	if (e instanceof K) {
		if (e.type === as && typeof e.value == "string") {
			let t = Xo(e.value);
			return function() {
				return t;
			};
	...
	switch (n) {
		case J.Number:
		case J.String:
		case J.Coalesce: return Bs(e, t);
		case J.Get:
		case J.Var:
		case J.Has: return Vs(e, t);
		case J.Id: return (e) => e.featureId;
		case J.GeometryType: return (e) => e.geometryType;
		case J.Concat: {
			let n = e.args.map((e) => zs(e, t));
			return (e) => "".concat(...n.map((t) => t(e).toString()));
		}
		case J.Resolution: return (e) => e.resolution;
		case J.Any:
		case J.All:
		case J.Between:
		case J.In:
		case J.Not: return Us(e, t);
		case J.Equal:
		case J.NotEqual:
		case J.LessThan:
		case J.LessThanOrEqualTo:
		case J.GreaterThan:
		case J.GreaterThanOrEqualTo: return Hs(e, t);
		case J.Multiply:
		case J.Divide:
		case J.Add:
		case J.Subtract:
		...
		case J.Cos:
		case J.Atan:
		case J.Sqrt: return Ws(e, t);
		case J.Case: return Gs(e, t);
		case J.Match: return Ks(e, t);
		case J.Interpolate: return qs(e, t);
		case J.ToString: return Js(e, t);
		default: throw Error(`Unsupported operator ${n}`);
	}
}
function Bs(e, t) {
	let n = e.operator, r = e.args.length, i = Array(r);
	for (let n = 0; n < r; ++n) i[n] = zs(e.args[n], t);
	switch (n) {
		case J.Coalesce: return (e) => {
			for (let t = 0; t < r; ++t) {
				let n = i[t](e);
				if (n != null) return n;
			}
...
function Vs(e, t) {
	...
	switch (e.operator) {
		...
		case J.Var: return (e) => e.variables[n];
		case J.Has: return (t) => {
			let r = e.args;
...
function Hs(e, t) {
	let n = e.operator, r = zs(e.args[0], t), i = zs(e.args[1], t);
	switch (n) {
		case J.Equal: return (e) => r(e) === i(e);
		case J.NotEqual: return (e) => r(e) !== i(e);
		case J.LessThan: return (e) => r(e) < i(e);
		case J.LessThanOrEqualTo: return (e) => r(e) <= i(e);
		case J.GreaterThan: return (e) => r(e) > i(e);
		case J.GreaterThanOrEqualTo: return (e) => r(e) >= i(e);
...
function Ws(e, t) {
	...
	for (let n = 0; n < r; ++n) i[n] = zs(e.args[n], t);
	switch (n) {
		case J.Multiply: return (e) => {
			let t = 1;
			for (let n = 0; n < r; ++n) t *= i[n](e);
			return t;
		};
		case J.Divide: return (e) => i[0](e) / i[1](e);
		case J.Add: return (e) => {
			let t = 0;
			for (let n = 0; n < r; ++n) t += i[n](e);
			return t;
		};
		case J.Subtract: return (e) => i[0](e) - i[1](e);
		case J.Clamp: return (e) => {
			let t = i[0](e), n = i[1](e);
			if (t < n) return n;
			let r = i[2](e);
			return t > r ? r : t;
		};
		case J.Mod: return (e) => i[0](e) % i[1](e);
		case J.Pow: return (e) => i[0](e) ** +i[1](e);
		case J.Abs: return (e) => Math.abs(i[0](e));
		case J.Floor: return (e) => Math.floor(i[0](e));
		case J.Ceil: return (e) => Math.ceil(i[0](e));
		case J.Round: return (e) => Math.round(i[0](e));
		case J.Sin: return (e) => Math.sin(i[0](e));
		case J.Cos: return (e) => Math.cos(i[0](e));
		case J.Atan: return r === 2 ? (e) => Math.atan2(i[0](e), i[1](e)) : (e) => Math.atan(i[0](e));
		case J.Sqrt: return (e) => Math.sqrt(i[0](e));
		default: throw Error(`Unsupported numeric operator ${n}`);
	}
}
function Gs(e, t) {
	let n = e.args.length, r = Array(n);
	for (let i = 0; i < n; ++i) r[i] = zs(e.args[i], t);
	return (e) => {
...
function qs(e, t) {
	...
	return (e) => {
		...
		for (let s = 2; s < n; s += 2) {
			...
			if (l && (c = Uo(c)), n >= i) return s === 2 ? c : l ? Xs(t, i, a, o, n, c) : Ys(t, i, a, o, n, c);
			a = n, o = c;
		}
		return o;
	};
...
function Js(e, t) {
	...
	for (let n = 0; n < r; ++n) i[n] = zs(e.args[n], t);
	switch (n) {
		case J.ToString: return (t) => {
			let n = i[0](t);
			return e.args[0].type === as ? Qo(n) : n.toString();
		};
...
function Xs(e, t, n, r, i, a) {
	if (i - n === 0) return r;
	let o = Jo(r), s = Jo(a), c = s[2] - o[2];
	return c > 180 ? c -= 360 : c < -180 && (c += 360), Yo([
		Ys(e, t, n, o[0], i, s[0]),
		Ys(e, t, n, o[1], i, s[1]),
		o[2] + Ys(e, t, n, 0, i, c),
		Ys(e, t, n, r[3], i, a[3])
...
function Zs(e, t, n) {
	let r = e, i = !0, a = !1, o = !1, s = [te(r, P.LOAD, function() {
		o = !0, a || t();
	})];
	return r.src && Ne ? (a = !0, r.decode().then(function() {
		i && t();
	}).catch(function(e) {
		i && (o ? t() : n());
	})) : s.push(te(r, P.ERROR, n)), function() {
		i = !1, s.forEach(N);
	};
}
function Qs(e, t) {
...
function $s(e, t) {
	return t && (e.src = t), e.src && Ne ? new Promise((t, n) => e.decode().then(() => t(e)).catch((r) => e.complete && e.width ? t(e) : n(r))) : Qs(e);
}
//#endregion
...
var ec = class {
	...
	set(e, t, n, r) {
		let i = tc(e, t), a = i in this.cache_;
		this.cache_[i] = n, r && (n.getImageState() === Q.IDLE && n.load(), n.getImageState() === Q.LOADING ? n.ready().then(() => {
			this.patternCache_[i] = sa().createPattern(n.getImage(1), "repeat");
		}) : this.patternCache_[i] = sa().createPattern(n.getImage(1), "repeat")), a || ++this.cacheSize_;
	}
	setSize(e) {
...
var nc = new ec(), rc = null, ic = class extends _e {
	...
	isTainted_() {
		if (this.tainted_ === void 0 && this.imageState_ === Q.LOADED) {
			rc ||= U(1, 1, void 0, { willReadFrequently: !0 }), rc.drawImage(this.image_, 0, 0);
			try {
	...
	getHitDetectionImage() {
		if (this.image_ || this.initializeImage_(), !this.hitDetectionImage_) if (this.isTainted_()) {
			let e = this.size_[0], t = this.size_[1], n = U(e, t);
	...
	load() {
		if (this.imageState_ === Q.IDLE) {
			...
			this.image_ instanceof HTMLImageElement && $s(this.image_, this.src_).then((e) => {
	...
	replaceColor_(e) {
		...
		let t = this.image_, n = U(Math.ceil(t.width * e), Math.ceil(t.height * e)), r = n.canvas;
		n.scale(e, e), n.drawImage(t, 0, 0), n.globalCompositeOperation = "multiply", n.fillStyle = zo(this.color_), n.fillRect(0, 0, r.width / e, r.height / e), n.globalCompositeOperation = "destination-in", n.drawImage(t, 0, 0), this.canvas_[e] = r;
	}
	ready() {
		return this.ready_ ||= new Promise((e) => {
			if (this.imageState_ === Q.LOADED || this.imageState_ === Q.ERROR) e();
				...
				let t = () => {
					(this.imageState_ === Q.LOADED || this.imageState_ === Q.ERROR) && (this.removeEventListener(P.CHANGE, t), e());
				};
				this.addEventListener(P.CHANGE, t);
			}
		}), this.ready_;
	}
};
function ac(e, t, n, r, i, a) {
	let o = t === void 0 ? void 0 : nc.get(t, i);
	return o || (o = new ic(e, e && "src" in e ? e.src || void 0 : t, n, r, i), nc.set(t, i, o, a)), a && o && !nc.getPattern(t, i) && nc.set(t, i, o, a), o;
}
//#endregion
//#region node_modules/ol/colorlike.js
function oc(e) {
	return e ? Array.isArray(e) ? Qo(e) : typeof e == "object" && "src" in e ? sc(e) : e : null;
}
function sc(e) {
	if (!e.offset || !e.size) return nc.getPattern(e.src, e.color);
	let t = e.src + ":" + e.offset, n = nc.getPattern(t, e.color);
	if (n) return n;
	let r = nc.get(e.src, null);
	if (r.getImageState() !== Q.LOADED) return null;
	let i = U(e.size[0], e.size[1]);
	return i.drawImage(r.getImage(1), e.offset[0], e.offset[1], e.size[0], e.size[1], 0, 0, e.size[0], e.size[1]), ac(i.canvas, t, void 0, Q.LOADED, e.color, !0), nc.getPattern(t, e.color);
}
//#endregion
//#region node_modules/ol/render/canvas.js
var cc = "10px sans-serif", lc = "#000", uc = "round", dc = [], fc = "round", pc = "#000", mc = "center", hc = "middle", gc = [
	0,
	0,
	0,
	0
], _c = new Se(), vc = null, yc, bc = {}, xc = /* @__PURE__ */ new Set([
	"serif",
	"sans-serif",
	"monospace",
	"cursive",
...
var Cc = (function() {
	...
	async function n(e) {
		await t.ready;
		let n = aa(e), r = n.families[0].toLowerCase(), i = n.weight, a = [];
		return t.forEach((e) => {
			let t = e.family.replace(/^['"]|['"]$/g, "").toLowerCase(), o = ia[e.weight] || e.weight;
			t === r && e.style === n.style && o == i && a.push(e);
		}), a.length !== 0 && (await Promise.all(a.map((e) => e.load().then(() => !0, () => !1)))).some((e) => e);
	}
	async function r() {
		await t.ready;
		let i = !0, a = _c.getProperties(), o = Object.keys(a).filter((e) => a[e] < 100);
		for (let e = o.length - 1; e >= 0; --e) {
			let t = o[e], r = a[t];
			r < 100 && (await n(t) ? (ee(bc), _c.set(t, 100)) : (r += 10, _c.set(t, r, !0), r < 100 && (i = !1)));
		}
	...
	return async function(n) {
		...
		for (let e of a) {
			if (xc.has(e)) continue;
			let t = Sc(i.style, i.weight, e);
			_c.get(t) === void 0 && (_c.set(t, 0, !0), o = !0);
		}
...
function Tc(e, t) {
	return vc ||= U(1, 1), e != yc && (vc.font = e, yc = vc.font), vc.measureText(t);
}
function Ec(e, t) {
	return Tc(e, t).width;
}
function Dc(e, t, n) {
	...
	let r = t.split("\n").reduce((t, n) => Math.max(t, Ec(e, n)), 0);
	return n[t] = r, r;
}
function Oc(e, t) {
...
function kc(e, t, n, r, i, a, o, s, c, l, u) {
	e.save(), n !== 1 && (e.globalAlpha === void 0 ? e.globalAlpha = (e) => e.globalAlpha *= n : e.globalAlpha *= n), t && e.transform.apply(e, t), r.contextInstructions ? (e.translate(c, l), e.scale(u[0], u[1]), Ac(r, e)) : u[0] < 0 || u[1] < 0 ? (e.translate(c, l), e.scale(u[0], u[1]), e.drawImage(r, i, a, o, s, 0, 0, o, s)) : e.drawImage(r, i, a, o, s, c, l, o * u[0], s * u[1]), e.restore();
}
function Ac(e, t) {
...
var jc = class e {
	constructor(e) {
		this.opacity_ = e.opacity, this.rotateWithView_ = e.rotateWithView, this.rotation_ = e.rotation, this.scale_ = e.scale, this.scaleArray_ = ts(e.scale), this.displacement_ = e.displacement, this.declutterMode_ = e.declutterMode;
	}
	clone() {
		let t = this.getScale();
		return new e({
	...
	setScale(e) {
		this.scale_ = e, this.scaleArray_ = ts(e);
	}
	listenImageChange(e) {
		F();
	}
	...
	getImage(e) {
		let t = this.fill_?.getKey(), n = `${e},${this.angle_},${this.radius},${this.radius2_},${this.points_},${t}` + Object.values(this.renderOptions_).join(","), r = nc.get(n, null)?.getImage(1);
		if (!r) {
			let t = this.renderOptions_, i = Math.ceil(t.size * e), a = U(i, i);
			this.draw_(t, a, e), r = a.canvas;
			let o = new ic(r, void 0, null, Q.LOADED, null);
			nc.set(n, null, o), createImageBitmap(r).then((e) => {
				o.setImage(e);
			});
		}
		return r;
	...
	createRenderOptions() {
		let e = uc, t = fc, n = 0, r = null, i = 0, a, o = 0;
		this.stroke_ && (a = oc(this.stroke_.getColor() ?? "#000"), o = this.stroke_.getWidth() ?? 1, r = this.stroke_.getLineDash(), i = this.stroke_.getLineDashOffset() ?? 0, t = this.stroke_.getLineJoin() ?? "round", e = this.stroke_.getLineCap() ?? "round", n = this.stroke_.getMiterLimit() ?? 10);
	...
	draw_(e, t, n) {
		if (t.scale(n, n), t.translate(e.size / 2, e.size / 2), this.createPath_(t), this.fill_) {
			...
			e === null && (e = lc), t.fillStyle = oc(e), t.fill();
		}
	...
	createHitDetectionCanvas_(e) {
		...
		if (this.fill_) {
			...
			typeof n == "string" && (n = Zo(n)), n === null ? r = 1 : Array.isArray(n) && (r = n.length === 4 ? n[3] : 1), r === 0 && (t = U(e.size, e.size), this.drawHitDetectionCanvas_(e, t));
		}
	...
	drawHitDetectionCanvas_(e, t) {
		t.translate(e.size / 2, e.size / 2), this.createPath_(t), t.fillStyle = lc, t.fill(), e.strokeStyle && (t.strokeStyle = e.strokeStyle, t.lineWidth = e.strokeWidth, e.lineDash && (t.setLineDash(e.lineDash), t.lineDashOffset = e.lineDashOffset), t.lineJoin = e.lineJoin, t.miterLimit = e.miterLimit, t.stroke());
	}
	ready() {
	...
	setColor(e) {
		if (typeof e == "object" && e && "src" in e) {
			let t = ac(null, e.src, { crossOrigin: "anonymous" }, void 0, e.offset ? null : e.color ? e.color : null, !(e.offset && e.size));
			t.ready().then(() => {
	...
	getKey() {
		let e = this.getColor();
		return e ? e instanceof CanvasPattern || e instanceof CanvasGradient ? I(e) : typeof e == "object" && "src" in e ? e.src + ":" + e.offset : Zo(e).toString() : "";
	}
	loading() {
...
var Ic = class e extends jc {
	constructor(e) {
		...
		B(!(o !== void 0 && a), "`image` and `src` cannot be provided at the same time"), (o === void 0 || o.length === 0) && a && (o = a.src || I(a)), B(o !== void 0 && o.length > 0, "A defined and non-empty `src` or `image` must be provided"), B(e.width === void 0 && e.height === void 0 || e.scale === void 0, "`width` or `height` cannot be provided together with `scale`");
		let s;
		if (e.src === void 0 ? a !== void 0 && (s = "complete" in a ? a.complete ? a.src ? Q.LOADED : Q.IDLE : Q.LOADING : Q.LOADED) : s = Q.IDLE, this.color_ = e.color === void 0 ? null : Zo(e.color), this.iconImage_ = ac(a, o, {
			...
			if (e.size) [t, n] = e.size;
				...
				if (r.width && r.height) t = r.width, n = r.height;
					...
					let t = () => {
						...
						this.setScale(Fc(n[0], n[1], e.width, e.height));
					};
					this.listenImageChange(t);
					return;
				}
			}
			t !== void 0 && this.setScale(Fc(t, n, e.width, e.height));
		}
	}
	clone() {
		let t, n, r;
	...
	listenImageChange(e) {
		this.iconImage_.addEventListener(P.CHANGE, e);
	}
	load() {
		this.iconImage_.load();
	}
	unlistenImageChange(e) {
		this.iconImage_.removeEventListener(P.CHANGE, e);
	}
	ready() {
	...
	setGeometry(e) {
		typeof e == "function" ? this.geometryFunction_ = e : typeof e == "string" ? this.geometryFunction_ = function(t) {
			...
			return e;
		}) : this.geometryFunction_ = Hc, this.geometry_ = e;
	}
	setZIndex(e) {
		this.zIndex_ = e;
	}
...
function Vc(e, t) {
	if (!Bc) {
		let e = new Pc({ color: "rgba(255,255,255,0.4)" }), t = new Lc({
			color: "#3399CC",
			width: 1.25
		});
		Bc = [new Rc({
...
var Uc = "#333", Wc = class e {
	constructor(e) {
		e ||= {}, this.font_ = e.font, this.rotation_ = e.rotation, this.rotateWithView_ = e.rotateWithView, this.keepUpright_ = e.keepUpright, this.scale_ = e.scale, this.scaleArray_ = ts(e.scale === void 0 ? 1 : e.scale), this.text_ = e.text, this.textAlign_ = e.textAlign, this.justify_ = e.justify, this.repeat_ = e.repeat, this.textBaseline_ = e.textBaseline, this.fill_ = e.fill === void 0 ? new Pc({ color: Uc }) : e.fill, this.maxAngle_ = e.maxAngle === void 0 ? Math.PI / 4 : e.maxAngle, this.placement_ = e.placement === void 0 ? "point" : e.placement, this.overflow_ = !!e.overflow, this.stroke_ = e.stroke === void 0 ? null : e.stroke, this.offsetX_ = e.offsetX === void 0 ? 0 : e.offsetX, this.offsetY_ = e.offsetY === void 0 ? 0 : e.offsetY, this.backgroundFill_ = e.backgroundFill ? e.backgroundFill : null, this.backgroundStroke_ = e.backgroundStroke ? e.backgroundStroke : null, this.padding_ = e.padding === void 0 ? null : e.padding, this.declutterMode_ = e.declutterMode;
	}
	clone() {
		let t = this.getScale();
		return new e({
			...
			fill: this.getFill() instanceof Pc ? this.getFill().clone() : this.getFill(),
			stroke: this.getStroke() ? this.getStroke().clone() : void 0,
	...
	setScale(e) {
		this.scale_ = e, this.scaleArray_ = ts(e === void 0 ? 1 : e);
	}
	setStroke(e) {
		this.stroke_ = e;
	}
...
function Kc(e, t) {
	...
	return function(e, i) {
		...
		return t.geometryType && (r.geometryType = Is(e.getGeometry())), n(r);
	};
}
function qc(e, t) {
	t ??= _s();
	let n = e.length, r = Array(n);
	for (let i = 0; i < n; ++i) r[i] = Xc(e[i], t);
	let i = Ls(), a = Array(n);
	return function(e, o) {
		...
		t.geometryType && (i.geometryType = Is(e.getGeometry()));
		let s = 0;
		for (let e = 0; e < n; ++e) {
			let t = r[e](i);
			t && (a[s] = t, s += 1);
...
function Jc(e, t) {
	if (t ??= _s(), !Array.isArray(e)) return qc([e], t);
	let n = e.length;
	if ("style" in e[0]) {
		let r = Array(n);
		for (let t = 0; t < n; ++t) {
...
function Yc(e, t) {
	let n = e.length, r = Array(n);
	for (let i = 0; i < n; ++i) {
		let n = e[i], a = "filter" in n ? Rs(n.filter, rs, t) : Gc, o;
		if (Array.isArray(n.style)) {
			let e = n.style.length;
			o = Array(e);
			for (let r = 0; r < e; ++r) o[r] = Xc(n.style[r], t);
		} else o = [Xc(n.style, t)];
		r[i] = {
			filter: a,
			styles: o
...
function Xc(e, t) {
	let n = Zc(e, "", t), r = Qc(e, "", t), i = $c(e, t), a = el(e, t), o = al(e, "z-index", t);
	if (!n && !r && !i && !a && !j(e)) throw Error("No fill, stroke, point, or text symbolizer properties in style: " + JSON.stringify(e));
	let s = new Rc();
	return function(e) {
		let t = !0;
		if (n) {
...
function Zc(e, t, n) {
	let r;
	if (t + "fill-pattern-src" in e) r = sl(e, t + "fill-", n);
	else {
		if (e[t + "fill-color"] === "none") return (e) => null;
		r = ll(e, t + "fill-color", n);
	}
	if (!r) return null;
	let i = new Pc();
	return function(e) {
		let t = r(e);
		return t === ko ? null : (i.setColor(t), i);
	};
}
function Qc(e, t, n) {
	let r = al(e, t + "stroke-width", n), i = ll(e, t + "stroke-color", n);
	if (!r && !i) return null;
	let a = ol(e, t + "stroke-line-cap", n), o = ol(e, t + "stroke-line-join", n), s = ul(e, t + "stroke-line-dash", n), c = al(e, t + "stroke-line-dash-offset", n), l = al(e, t + "stroke-miter-limit", n), u = al(e, t + "stroke-offset", n), d = new Lc();
	return function(e) {
		if (i) {
			let t = i(e);
			if (t === ko) return null;
...
function $c(e, t) {
	let n = "text-", r = ol(e, "text-value", t);
	if (!r) return null;
	let i = Zc(e, n, t), a = Zc(e, "text-background-", t), o = Qc(e, n, t), s = Qc(e, "text-background-", t), c = ol(e, "text-font", t), l = al(e, "text-max-angle", t), u = al(e, "text-offset-x", t), d = al(e, "text-offset-y", t), f = cl(e, "text-overflow", t), p = ol(e, "text-placement", t), m = al(e, "text-repeat", t), h = pl(e, "text-scale", t), g = cl(e, "text-rotate-with-view", t), _ = al(e, "text-rotation", t), v = ol(e, "text-align", t), y = ol(e, "text-justify", t), b = ol(e, "text-baseline", t), x = cl(e, "text-keep-upright", t), S = ul(e, "text-padding", t), C = new Wc({ declutterMode: bl(e, "text-declutter-mode") });
	return function(e) {
...
function el(e, t) {
	return "icon-src" in e ? tl(e, t) : "shape-points" in e ? nl(e, t) : "circle-radius" in e ? rl(e, t) : null;
}
function tl(e, t) {
	let n = "icon-src", r = Sl(e[n], n), i = dl(e, "icon-anchor", t), a = pl(e, "icon-scale", t), o = al(e, "icon-opacity", t), s = dl(e, "icon-displacement", t), c = al(e, "icon-rotation", t), l = cl(e, "icon-rotate-with-view", t), u = _l(e, "icon-anchor-origin"), d = vl(e, "icon-anchor-x-units"), f = vl(e, "icon-anchor-y-units"), p = il(e, "icon-color"), m, h = null;
	p !== void 0 && (Array.isArray(p) && p.length > 0 && typeof p[0] == "string" ? h = ll(e, "icon-color", t) : m = wl(p, "icon-color"));
	let g = gl(e, "icon-cross-origin"), _ = yl(e, "icon-offset"), v = _l(e, "icon-offset-origin"), y = ml(e, "icon-width"), b = {
		src: r,
		anchorOrigin: u,
		anchorXUnits: d,
		anchorYUnits: f,
		...
		offset: _,
		offsetOrigin: v,
		height: ml(e, "icon-height"),
		width: y,
		size: hl(e, "icon-size"),
		declutterMode: bl(e, "icon-declutter-mode")
	}, x = null;
	return function(e) {
		if (x) h && x.setColor(h(e));
		else {
			let t = h ? h(e) : m;
			x = new Ic(t === void 0 ? Object.assign({}, b) : Object.assign({}, b, { color: t }));
		}
...
function nl(e, t) {
	let n = "shape-", r = "shape-points", i = "shape-radius", a = Cl(e[r], r);
	if (!(i in e)) throw Error(`Expected a number for ${i}`);
	let o = al(e, i, t), s = typeof e[i] == "number" ? e[i] : 5, c = "shape-radius2", l = al(e, c, t), u = typeof e[c] == "number" ? e[c] : void 0, d = Zc(e, n, t), f = Qc(e, n, t), p = pl(e, "shape-scale", t), m = dl(e, "shape-displacement", t), h = al(e, "shape-rotation", t), g = cl(e, "shape-rotate-with-view", t), _ = new Mc({
		points: a,
		radius: s,
		radius2: u,
		angle: ml(e, "shape-angle"),
		declutterMode: bl(e, "shape-declutter-mode")
	});
	return function(e) {
...
function rl(e, t) {
	let n = "circle-", r = Zc(e, n, t), i = Qc(e, n, t), a = al(e, "circle-radius", t), o = pl(e, "circle-scale", t), s = dl(e, "circle-displacement", t), c = al(e, "circle-rotation", t), l = cl(e, "circle-rotate-with-view", t), u = new Nc({
		radius: 5,
		declutterMode: bl(e, "circle-declutter-mode")
	});
	return function(e) {
...
function sl(e, t, n) {
	let r = ol(e, t + "pattern-src", n), i = fl(e, t + "pattern-offset", n), a = fl(e, t + "pattern-size", n), o = ll(e, t + "color", n);
	return function(e) {
		return {
			src: r(e),
			offset: i && i(e),
...
function hl(e, t) {
	let n = e[t];
	if (n !== void 0) {
		if (typeof n == "number") return ts(n);
...
function El(e, t) {
	return typeof e == "number" ? e : Tl(e, t);
}
//#endregion
//#region node_modules/ol/layer/BaseVector.js
var Dl = { RENDER_ORDER: "renderOrder" }, Ol = class extends co {
	constructor(e) {
		e ||= {};
		let t = Object.assign({}, e);
	...
	getRenderOrder() {
		return this.get(Dl.RENDER_ORDER);
	}
	getStyle() {
		return this.style_;
	}
	...
	renderDeclutter(e, t) {
		...
		n in e.declutter || (e.declutter[n] = new mo(9)), this.getRenderer().renderDeclutter(e, t);
	}
	setRenderOrder(e) {
		this.set(Dl.RENDER_ORDER, e);
	}
	setStyle(e) {
		this.style_ = e === void 0 ? Vc : e;
		let t = kl(e);
		this.styleFunction_ = e === null ? void 0 : zc(t), this.changed();
	}
	setDeclutter(e) {
...
function kl(e) {
	...
	if (!e) return null;
	if (typeof e == "function" || e instanceof Rc) return e;
	if (Array.isArray(e) && e.length === 0) return [];
	if (Array.isArray(e) && e[0] instanceof Rc) {
		let t = e.length, n = Array(t);
		for (let r = 0; r < t; ++r) {
			let t = e[r];
			if (!(t instanceof Rc)) throw Error("Expected a list of style instances");
			n[r] = t;
		}
		return n;
	}
...
var Al = class extends ge {
	...
	calculateMatrices2D(e) {
		...
		Fr(n, e.size[0] / 2, e.size[1] / 2, 1 / t.resolution, -1 / t.resolution, -t.rotation, -t.center[0], -t.center[1]), Ir(r, n);
	}
	forEachFeatureAtCoordinate(e, t, n, r, i, a, o, s) {
		...
		let d = l.projection, f = Kt(e.slice(), d), p = [[0, 0]];
		if (d.canWrapX() && r) {
			let e = H(d.getExtent());
			p.push([-e, 0], [e, 0]);
		}
		...
		for (let r = 0; r < p.length; r++) for (let i = h - 1; i >= 0; --i) {
			let a = m[i], d = a.layer;
			if (d.hasRenderer() && lo(a, l) && o.call(s, d)) {
	...
	hasFeatureAtCoordinate(e, t, n, r, i, a) {
		return this.forEachFeatureAtCoordinate(e, t, n, r, de, this, i, a) !== void 0;
	}
	getMap() {
		return this.map_;
	}
	...
	scheduleExpireIconCache(e) {
		nc.canExpireCache() && e.postRenderFunctions.push(Ml);
	}
};
function Ml(e, t) {
	nc.expire();
...
var Nl = class extends jl {
	constructor(e) {
		super(e), this.fontChangeListenerKey_ = M(_c, A.PROPERTYCHANGE, e.redrawText, e), this.element_ = Me ? fa() : document.createElement("div");
		let t = this.element_.style;
		t.position = "absolute", t.width = "100%", t.height = "100%", t.zIndex = "0", this.element_.className = $i + " ol-layers";
		let n = e.getViewport();
	...
	dispatchRenderEvent(e, t) {
		let n = this.getMap();
		if (n.hasListener(e)) {
			let r = new Al(e, void 0, t);
			n.dispatchEvent(r);
		}
	}
	disposeInternal() {
		N(this.fontChangeListenerKey_), this.element_.remove(), super.disposeInternal();
	}
	renderFrame(e) {
		if (!e) {
		...
		this.calculateMatrices2D(e), this.dispatchRenderEvent(so.PRECOMPOSE, e);
		let t = e.layerStatesArray.sort((e, t) => e.zIndex - t.zIndex);
		t.some((e) => e.layer instanceof Ol && e.layer.getDeclutter()) && (e.declutter = {});
		let n = e.viewState;
		this.children_.length = 0;
		let r = this.getMap().getTargetElement(), i;
		pa(r) && (i = r.getContext("2d"), i.setTransform(1, 0, 0, 1, 0, 0), i.clearRect(0, 0, r.width, r.height));
		let a = [], o = i ? r : null;
		for (let r = 0, i = t.length; r < i; ++r) {
			let i = t[r];
			e.layerIndex = r;
			let s = i.layer, c = s.getSourceState();
			if (!lo(i, n) || c != "ready" && c != "undefined") {
				s.unrender();
				continue;
			}
			let l = s.render(e, o);
		...
		this.declutter(e, a), da(this.element_, this.children_);
		for (let e of i ? this.children_ : []) {
			let t = e.firstElementChild || e, n = e.style.backgroundColor;
			if (n && (!pa(t) || t.width > 0) && (i.fillStyle = n, i.fillRect(0, 0, i.canvas.width, i.canvas.height)), !pa(t) || t.width === 0) continue;
			i.save();
			let r = e.style.opacity || t.style.opacity;
			i.globalAlpha = r === "" ? 1 : Number(r);
			let a = t.style.transform;
			if (a) i.transform(...Br(a));
			else {
		...
		this.dispatchRenderEvent(so.POSTCOMPOSE, e), this.renderedVisible_ ||= (this.element_.style.display = "", !0), this.scheduleExpireIconCache(e);
	}
	declutter(e, t) {
		if (e.declutter) {
...
function Pl(e) {
	...
	e instanceof oo && e.getLayers().forEach(Pl);
}
function Fl(e, t) {
	if (e instanceof co) {
		e.setMapInternal(t);
	...
	if (e instanceof oo) {
		...
		for (let e = 0, r = n.length; e < r; ++e) Fl(n[e], t);
	}
}
var Il = class extends Se {
	constructor(e) {
		super(), e ||= {}, this.on, this.once, this.un;
		let t = Ll(e);
		this.renderComplete_ = !1, this.loaded_ = !0, this.boundHandleBrowserEvent_ = this.handleBrowserEvent.bind(this), this.maxTilesLoading_ = e.maxTilesLoading === void 0 ? 16 : e.maxTilesLoading, this.pixelRatio_ = e.pixelRatio === void 0 ? je : e.pixelRatio, this.postRenderTimeoutHandle_, this.animationDelayKey_, this.animationDelay_ = this.animationDelay_.bind(this), this.coordinateToPixelTransform_ = Mr(), this.pixelToCoordinateTransform_ = Mr(), this.frameIndex_ = 0, this.frameState_ = null, this.previousExtent_ = null, this.viewPropertyListenerKey_ = null, this.viewChangeListenerKey_ = null, this.layerGroupPropertyListenerKeys_ = null, Me || (this.viewport_ = document.createElement("div"), this.viewport_.className = "ol-viewport" + ("ontouchstart" in window ? " ol-touch" : ""), this.viewport_.style.position = "relative", this.viewport_.style.overflow = "hidden", this.viewport_.style.width = "100%", this.viewport_.style.height = "100%", this.overlayContainer_ = document.createElement("div"), this.overlayContainer_.style.position = "absolute", this.overlayContainer_.style.zIndex = "0", this.overlayContainer_.style.width = "100%", this.overlayContainer_.style.height = "100%", this.overlayContainer_.style.pointerEvents = "none", this.overlayContainer_.className = "ol-overlaycontainer", this.viewport_.appendChild(this.overlayContainer_), this.overlayContainerStopEvent_ = document.createElement("div"), this.overlayContainerStopEvent_.style.position = "absolute", this.overlayContainerStopEvent_.style.zIndex = "0", this.overlayContainerStopEvent_.style.width = "100%", this.overlayContainerStopEvent_.style.height = "100%", this.overlayContainerStopEvent_.style.pointerEvents = "none", this.overlayContainerStopEvent_.className = "ol-overlaycontainer-stopevent", this.viewport_.appendChild(this.overlayContainerStopEvent_)), this.mapBrowserEventHandler_ = null, this.moveTolerance_ = e.moveTolerance, this.keyboardEventTarget_ = t.keyboardEventTarget, this.targetChangeHandlerKeys_ = null, this.targetElement_ = null, Me || (this.resizeObserver_ = new ResizeObserver(() => this.updateSize())), this.controls = t.controls || (Me ? new Te() : va()), this.interactions = t.interactions || (Me ? new Te() : to({ onFocusOnly: !0 })), this.overlays_ = t.overlays, this.overlayIdIndex_ = {}, this.renderer_ = null, this.postRenderFunctions_ = [], this.tileQueue_ = new Be(this.getTilePriority.bind(this), this.handleTileChange_.bind(this)), this.addChangeListener(R.LAYERGROUP, this.handleLayerGroupChanged_), this.addChangeListener(R.VIEW, this.handleViewChanged_), this.addChangeListener(R.SIZE, this.handleSizeChanged_), this.addChangeListener(R.TARGET, this.handleTargetChanged_), this.setProperties(t.values);
		let n = this;
		e.view && !(e.view instanceof Gi) && e.view.then(function(e) {
			n.setView(new Gi(e));
		}), this.controls.addEventListener(k.ADD, (e) => {
			e.element.setMap(this);
		}), this.controls.addEventListener(k.REMOVE, (e) => {
			e.element.setMap(null);
		}), this.interactions.addEventListener(k.ADD, (e) => {
			e.element.setMap(this);
		}), this.interactions.addEventListener(k.REMOVE, (e) => {
			e.element.setMap(null);
		}), this.overlays_.addEventListener(k.ADD, (e) => {
			this.addOverlayInternal_(e.element);
		}), this.overlays_.addEventListener(k.REMOVE, (e) => {
	...
	forEachFeatureAtPixel(e, t, n) {
		...
		n = n === void 0 ? {} : n;
		let i = n.hitTolerance === void 0 ? 0 : n.hitTolerance, a = n.layerFilter === void 0 ? de : n.layerFilter, o = n.checkWrapped !== !1;
	...
	getAllLayers() {
		...
		function t(n) {
			n.forEach(function(n) {
				n instanceof oo ? t(n.getLayers()) : e.push(n);
			});
		}
	...
	hasFeatureAtPixel(e, t) {
		...
		t = t === void 0 ? {} : t;
		let r = t.layerFilter === void 0 ? de : t.layerFilter, i = t.hitTolerance === void 0 ? 0 : t.hitTolerance, a = t.checkWrapped !== !1;
	...
	getTarget() {
		return this.get(R.TARGET);
	}
	getTargetElement() {
		return this.targetElement_;
	}
	getCoordinateFromPixel(e) {
		return Tr(this.getCoordinateFromPixelInternal(e), this.getView().getProjection());
	}
	getCoordinateFromPixelInternal(e) {
		let t = this.frameState_;
		return t ? Pr(t.pixelToCoordinateTransform, e.slice()) : null;
	}
	getControls() {
	...
	getPixelFromCoordinate(e) {
		let t = Er(e, this.getView().getProjection());
		return this.getPixelFromCoordinateInternal(t);
	}
	getPixelFromCoordinateInternal(e) {
		let t = this.frameState_;
		return t ? Pr(t.coordinateToPixelTransform, e.slice(0, 2)) : null;
	}
	getPixelRatio() {
	...
	getSize() {
		return this.get(R.SIZE);
	}
	getView() {
		return this.get(R.VIEW);
	}
	getViewport() {
	...
	handlePostRender() {
		...
		if (!t.isEmpty()) {
			let n = this.maxTilesLoading_, r = n, i = e ? e.viewHints : void 0, a = i ? i[He.ANIMATING] || i[He.INTERACTING] : !1;
			if (a) {
		...
		e && this.renderer_ && !e.animate && (this.renderComplete_ ? (this.hasListener(so.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(so.RENDERCOMPLETE, e), this.loaded_ === !1 && (this.loaded_ = !0, this.dispatchEvent(new Ee(Le.LOADEND, this, e)))) : this.loaded_ === !0 && (this.loaded_ = !1, this.dispatchEvent(new Ee(Le.LOADSTART, this, e))));
	...
	handleTargetChanged_() {
		if (this.mapBrowserEventHandler_) {
			for (let e = 0, t = this.targetChangeHandlerKeys_.length; e < t; ++e) N(this.targetChangeHandlerKeys_[e]);
			this.targetChangeHandlerKeys_ = null, this.viewport_.removeEventListener(P.CONTEXTMENU, this.boundHandleBrowserEvent_), this.viewport_.removeEventListener(P.WHEEL, this.boundHandleBrowserEvent_), this.mapBrowserEventHandler_.dispose(), this.mapBrowserEventHandler_ = null, this.viewport_.remove();
		}
		if (this.targetElement_ && !pa(this.targetElement_)) {
		...
		if (this.targetElement_ = t, !t) this.renderer_ &&= (clearTimeout(this.postRenderTimeoutHandle_), this.postRenderTimeoutHandle_ = void 0, this.postRenderFunctions_.length = 0, this.renderer_.dispose(), null), this.animationDelayKey_ &&= (cancelAnimationFrame(this.animationDelayKey_), void 0);
			...
			if (pa(t) || t.appendChild(this.viewport_), this.renderer_ ||= new Nl(this), !pa(t)) {
				this.mapBrowserEventHandler_ = new Ie(this, this.moveTolerance_);
				for (let e in L) this.mapBrowserEventHandler_.addEventListener(L[e], this.handleMapBrowserEvent.bind(this));
				this.viewport_.addEventListener(P.CONTEXTMENU, this.boundHandleBrowserEvent_, !1), this.viewport_.addEventListener(P.WHEEL, this.boundHandleBrowserEvent_, Pe ? { passive: !1 } : !1);
				let e;
				...
				if (this.targetChangeHandlerKeys_ = [M(e, P.KEYDOWN, this.handleBrowserEvent, this), M(e, P.KEYPRESS, this.handleBrowserEvent, this)], !pa(t)) {
					let e = t.getRootNode();
	...
	handleViewChanged_() {
		this.viewPropertyListenerKey_ &&= (N(this.viewPropertyListenerKey_), null), this.viewChangeListenerKey_ &&= (N(this.viewChangeListenerKey_), null);
		let e = this.getView();
		e && (this.updateViewportSize_(this.getSize()), this.viewPropertyListenerKey_ = M(e, A.PROPERTYCHANGE, this.handleViewPropertyChanged_, this), this.viewChangeListenerKey_ = M(e, P.CHANGE, this.handleViewPropertyChanged_, this), e.resolveConstraints(0)), this.render();
	}
	handleLayerGroupChanged_() {
		this.layerGroupPropertyListenerKeys_ &&= (this.layerGroupPropertyListenerKeys_.forEach(N), null);
		let e = this.getLayerGroup();
		e && (this.handleLayerAdd_(new io("addlayer", e)), this.layerGroupPropertyListenerKeys_ = [
			M(e, A.PROPERTYCHANGE, this.render, this),
			M(e, P.CHANGE, this.render, this),
			M(e, "addlayer", this.handleLayerAdd_, this),
			M(e, "removelayer", this.handleLayerRemove_, this)
		]), this.render();
	}
	isRendered() {
	...
	renderFrame_(e) {
		...
		this.frameState_ = i, this.renderer_.renderFrame(i), i && (i.animate && this.render(), Array.prototype.push.apply(this.postRenderFunctions_, i.postRenderFunctions), r && (!this.previousExtent_ || !It(this.previousExtent_) && !_t(i.extent, this.previousExtent_)) && (this.dispatchEvent(new Ee(Le.MOVESTART, this, r)), this.previousExtent_ = mt(this.previousExtent_)), this.previousExtent_ && !i.viewHints[He.ANIMATING] && !i.viewHints[He.INTERACTING] && !_t(i.extent, this.previousExtent_) && (this.dispatchEvent(new Ee(Le.MOVEEND, this, i)), ot(i.extent, this.previousExtent_))), this.dispatchEvent(new Ee(Le.POSTRENDER, this, i)), this.renderComplete_ = (this.hasListener(Le.LOADSTART) || this.hasListener(Le.LOADEND) || this.hasListener(so.RENDERCOMPLETE)) && !this.tileQueue_.getTilesLoading() && !this.tileQueue_.getCount() && !this.getLoadingOrNotReady(), this.postRenderTimeoutHandle_ ||= setTimeout(() => {
			this.postRenderTimeoutHandle_ = void 0, this.handlePostRender();
		}, 0);
	}
	setLayerGroup(e) {
		let t = this.getLayerGroup();
		t && this.handleLayerRemove_(new io("removelayer", t)), this.set(R.LAYERGROUP, e);
	}
	setSize(e) {
		this.set(R.SIZE, e);
	}
	...
	updateSize() {
		...
		if (e) {
			...
			!isNaN(n) && !isNaN(r) && (t = [Math.max(0, n), Math.max(0, r)], !$o(t) && (e.offsetWidth || e.offsetHeight || e.getClientRects().length) && nn("No map visible because the map container's width or height are 0."));
		}
		let n = this.getSize();
		t && (!n || !le(t, n)) && (this.updateViewportSize_(t), this.setSize(t));
	}
...
function Ll(e) {
	...
	let n = {}, r = e.layers && typeof e.layers.getLayers == "function" ? e.layers : new oo({ layers: e.layers });
	n[R.LAYERGROUP] = r, n[R.TARGET] = e.target, n[R.VIEW] = e.view instanceof Gi ? e.view : new Gi();
	let i;
	e.controls !== void 0 && (Array.isArray(e.controls) ? i = new Te(e.controls.slice()) : (B(typeof e.controls.getArray == "function", "Expected `controls` to be an array or an `ol/Collection.js`"), i = e.controls));
	let a;
	e.interactions !== void 0 && (Array.isArray(e.interactions) ? a = new Te(e.interactions.slice()) : (B(typeof e.interactions.getArray == "function", "Expected `interactions` to be an array or an `ol/Collection.js`"), a = e.interactions));
	let o;
	return e.overlays === void 0 ? o = new Te() : Array.isArray(e.overlays) ? o = new Te(e.overlays.slice()) : (B(typeof e.overlays.getArray == "function", "Expected `overlays` to be an array or an `ol/Collection.js`"), o = e.overlays), {
		controls: i,
		interactions: a,
...
var Rl = class extends _e {
	...
	setState(e) {
		if (this.state !== z.EMPTY) {
			if (this.state !== z.ERROR && this.state > e) throw Error("Tile load sequence violation");
	...
	getAlpha(e, t) {
		...
		let r = t - n + 1e3 / 60;
		return r >= this.transition_ ? 1 : Yt(r / this.transition_);
	}
	inTransition(e) {
...
var Bl = /* @__PURE__ */ Error("disposed"), Vl = [256, 256], Hl = class extends Rl {
	constructor(e) {
		let t = z.IDLE;
		super(e.tileCoord, t, {
	...
	disposeInternal() {
		this.controller_ &&= (this.controller_.abort(Bl), null), super.disposeInternal();
	}
}, Ul = class extends Rl {
	constructor(e, t, n, r, i, a) {
	...
	handleImageError_() {
		this.state = z.ERROR, this.unlistenImage_(), this.image_ = Wl(), this.changed();
	}
	handleImageLoad_() {
		if (Me) this.state = z.LOADED;
		else {
			let e = this.image_;
			this.state = e.naturalWidth && e.naturalHeight ? z.LOADED : z.EMPTY;
		}
		this.unlistenImage_(), this.changed();
	}
	load() {
		this.state == z.ERROR && (this.state = z.IDLE, this.image_ = new Image(), this.crossOrigin_ !== null && (this.image_.crossOrigin = this.crossOrigin_), this.referrerPolicy_ !== void 0 && (this.image_.referrerPolicy = this.referrerPolicy_)), this.state == z.IDLE && (this.state = z.LOADING, this.changed(), this.tileLoadFunction_(this, this.src_), this.unlisten_ = Zs(this.image_, this.handleImageLoad_.bind(this), this.handleImageError_.bind(this)));
	}
	unlistenImage_() {
...
function Kl(e, t, n, r, i) {
	return i === void 0 ? new Gl(e, t, n, r) : (i.minX = e, i.maxX = t, i.minY = n, i.maxY = r, i);
}
//#endregion
...
function Zl() {
	if (ql === void 0) {
		let e = U(6, 6, Jl);
		e.globalCompositeOperation = "lighter", e.fillStyle = "rgba(210, 0, 0, 0.75)", Yl(e, 4, 5, 4, 0), Yl(e, 4, 5, 0, 5);
		let t = e.getImageData(0, 0, 3, 3).data;
		ql = Xl(t, 0) || Xl(t, 4) || Xl(t, 8), ca(e), Jl.push(e.canvas);
	}
	return ql;
}
function Ql(e, t, n, r) {
	let i = Sr(n, t, e), a = fr(t, r, n), o = t.getMetersPerUnit();
	o !== void 0 && (a *= o);
...
function $l(e, t, n, r) {
	let i = Ql(e, t, Et(n), r);
	return (!isFinite(i) || i <= 0) && St(n, function(n) {
		return i = Ql(e, t, n, r), isFinite(i) && i > 0;
	}), i;
}
function eu(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
	let m = U(Math.round(n * e), Math.round(n * t), Jl);
	...
	if (!f || c.length !== 1 || l !== 0) {
		if (_ = U(Math.round(H(g) * v), Math.round(At(g) * v), Jl), d || (_.imageSmoothingEnabled = !1), i && p) {
			let e = (i[0] - g[0]) * v, t = -(i[3] - g[3]) * v, n = H(i) * v, r = At(i) * v;
		...
		c.forEach(function(e, t, n) {
			if (e.image.width > 0 && e.image.height > 0) {
				if (e.clipExtent) {
					_.save();
					let t = (e.clipExtent[0] - g[0]) * v, n = -(e.clipExtent[3] - g[3]) * v, r = H(e.clipExtent) * v, i = At(e.clipExtent) * v;
					_.rect(d ? t : Math.round(t), d ? n : Math.round(n), d ? r : Math.round(t + r) - Math.round(t), d ? i : Math.round(n + i) - Math.round(n)), _.clip();
				}
				let t = (e.extent[0] - g[0]) * v, n = -(e.extent[3] - g[3]) * v, r = H(e.extent) * v, i = At(e.extent) * v;
	...
	return s.getTriangles().forEach(function(e, t, n) {
		...
		if (_) k = _.canvas, m.scale(y, -y);
			...
			k = e.image, m.scale(H(t) / k.width, -At(t) / k.height);
		}
		m.drawImage(k, 0, 0), m.restore();
	}), _ && (ca(_), Jl.push(_.canvas)), u && (m.save(), m.globalCompositeOperation = "source-over", m.strokeStyle = "black", m.lineWidth = 1, s.getTriangles().forEach(function(e, t, n) {
...
var tu = 10, nu = .25, ru = class {
	constructor(e, t, n, r, i, a, o) {
		this.sourceProj_ = e, this.targetProj_ = t;
		let s = {}, c = o ? gr((e) => Pr(o, Sr(e, this.targetProj_, this.sourceProj_))) : xr(this.targetProj_, this.sourceProj_);
		...
		let l = Nt(n), u = Pt(n), d = Tt(n), f = wt(n), p = this.transformInv_(l), m = this.transformInv_(u), h = this.transformInv_(d), g = this.transformInv_(f), _ = tu + (a ? Math.max(0, Math.ceil(Math.log2(Ct(n) / (a * a * 256 * 256)))) : 0);
	...
	addQuad_(e, t, n, r, i, a, o, s, c) {
		...
		if (c > 0 && (this.targetProj_.isGlobal() && this.targetWorldWidth_ && (p = H(it([
			e,
			t,
			n,
			r
		])) / this.targetWorldWidth_ > nu || p), !f && this.sourceProj_.isGlobal() && u && (p = u > nu || p)), !p && this.maxSourceExtent_ && isFinite(l[0]) && isFinite(l[1]) && isFinite(l[2]) && isFinite(l[3]) && !Ft(l, this.maxSourceExtent_)) return;
		let m = 0;
		...
		if (c > 0) {
			if (!p) {
				...
				a = f ? (Ye(i[0], d) + Ye(o[0], d)) / 2 - Ye(r[0], d) : (i[0] + o[0]) / 2 - r[0];
				let s = (i[1] + o[1]) / 2 - r[1];
	...
	calculateSourceExtent() {
		...
		return this.triangles_.forEach(function(t, n, r) {
			let i = t.source;
			yt(e, i[0]), yt(e, i[1]), yt(e, i[2]);
		}), e;
	}
	getTriangles() {
		return this.triangles_;
	}
}, iu = .5, au = class extends Rl {
	constructor(e, t, n, r, i, a, o, s, c, l, u, d) {
		super(i, z.IDLE, d), this.renderEdges_ = u !== void 0 && u, this.pixelRatio_ = o, this.gutter_ = s, this.canvas_ = null, this.sourceTileGrid_ = t, this.targetTileGrid_ = r, this.wrappedTileCoord_ = a || i, this.sourceTiles_ = [], this.sourcesListenerKeys_ = null, this.sourceZ_ = 0, this.clipExtent_ = e.canWrapX() ? e.getExtent() : void 0;
		let f = r.getTileCoordExtent(this.wrappedTileCoord_), p = this.targetTileGrid_.getExtent(), m = this.sourceTileGrid_.getExtent(), h = p ? jt(f, p) : f;
		if (Ct(h) === 0) {
			this.state = z.EMPTY;
			return;
		}
		let g = e.getExtent();
		g && (m = m ? jt(m, g) : g);
		let _ = r.getResolution(this.wrappedTileCoord_[0]), v = $l(e, n, h, _);
		if (!isFinite(v) || v <= 0) {
			this.state = z.EMPTY;
			return;
		}
		let y = l === void 0 ? iu : l;
		if (this.triangulation_ = new ru(e, n, h, m, v * y, _), this.triangulation_.getTriangles().length === 0) {
			this.state = z.EMPTY;
			return;
		}
		this.sourceZ_ = t.getZForResolution(v);
		let b = this.triangulation_.calculateSourceExtent();
		if (m && (e.canWrapX() ? (b[1] = V(b[1], m[1], m[3]), b[3] = V(b[3], m[1], m[3])) : b = jt(b, m)), !Ct(b)) this.state = z.EMPTY;
		else {
			let n = 0, r = 0;
			e.canWrapX() && (n = H(g), r = Math.floor((b[0] - g[0]) / n)), Bt(b.slice(), e, !0).forEach((e) => {
	...
	reproject_() {
		...
		if (this.sourceTiles_.forEach((t) => {
		...
		}), this.sourceTiles_.length = 0, e.length === 0) this.state = z.ERROR;
		else {
			...
			this.canvas_ = eu(r, i, this.pixelRatio_, o, this.sourceTileGrid_.getExtent(), a, s, this.triangulation_, e, this.gutter_, this.renderEdges_, this.interpolate), this.state = z.LOADED;
		}
		this.changed();
	}
	load() {
		...
		if (this.state == z.IDLE) {
			...
			this.sourcesListenerKeys_ = [], this.sourceTiles_.forEach(({ tile: t }) => {
				let n = t.getState();
				if (n == z.IDLE || n == z.LOADING) {
					e++;
					let n = M(t, P.CHANGE, (r) => {
						let i = t.getState();
						(i == z.LOADED || i == z.ERROR || i == z.EMPTY) && (N(n), e--, e === 0 && (this.unlistenSources_(), this.reproject_()));
					});
	...
	release() {
		this.canvas_ &&= (ca(this.canvas_.getContext("2d")), Jl.push(this.canvas_), null), this.sourceTiles_.length = 0, super.release();
	}
}, ou = class {
	constructor(e) {
...
function lu(e, t, n, r, i) {
	return `${I(e)},${t},${cu(n, r, i)}`;
}
function uu(e) {
	return du(e[0], e[1], e[2]);
}
function du(e, t, n) {
	return (t << e) + n;
}
...
var pu = class {
	constructor() {
		this.instructions_ = [], this.zIndex = 0, this.offset_ = 0, this.pendingMethod_, this.context_ = new Proxy(sa(), {
			get: (e, t) => {
...
}, mu = 5, hu = class extends ve {
	constructor(e) {
		super(), this.ready = !0, this.boundHandleImageChange_ = this.handleImageChange_.bind(this), this.layer_ = e, this.staleKeys_ = [], this.maxStaleKeys = mu, this.renderedSourceKey_;
	}
	getStaleKeys() {
	...
	loadImage(e) {
		let t = e.getState();
		return t != Q.LOADED && t != Q.ERROR && e.addEventListener(P.CHANGE, this.boundHandleImageChange_), t == Q.IDLE && (e.load(), t = e.getState()), t == Q.LOADED;
	}
...
function vu() {
	_u = U(1, 1, void 0, { willReadFrequently: !0 });
}
var yu = class extends hu {
	constructor(e) {
		super(e), this.container = null, this.renderedResolution, this.tempTransform = Mr(), this.pixelTransform = Mr(), this.inversePixelTransform = Mr(), this.context = null, this.deferredContext_ = null, this.containerReused = !1, this.frameState = null;
	}
	getImageData(e, t, n) {
		_u || vu(), _u.clearRect(0, 0, 1, 1);
		let r;
		try {
			_u.drawImage(e, t, n, 1, 1, 0, 0, 1, 1), r = _u.getImageData(0, 0, 1, 1).data;
		} catch {
			return _u = null, null;
		}
		return r;
	...
	useContainer(e, t, n, r, i) {
		if (pa(e) && this.pixelTransform[1] === 0 && this.pixelTransform[2] === 0 && this.pixelTransform[4] === 0 && this.pixelTransform[5] === 0 && e.width === r && e.height === i) {
		...
		if (e && e.className === a && (!n || e && e.style.backgroundColor && le(Zo(e.style.backgroundColor), Zo(n)))) {
			let t = e.firstElementChild;
			pa(t) && (s = t.getContext("2d"));
		}
		if (s && Vr(s.canvas.style.transform, t) ? (this.container = e, this.context = s, this.containerReused = !0) : this.containerReused ? (this.container = null, this.context = null, this.containerReused = !1) : this.container && (this.container.style.backgroundColor = null), !this.container) {
			o = Me ? fa() : document.createElement("div"), o.className = a;
			let e = o.style;
			e.position = "absolute", e.width = "100%", e.height = "100%", s = U();
			let t = s.canvas;
	...
	clipUnrotated(e, t, n) {
		let r = Nt(n), i = Pt(n), a = Tt(n), o = wt(n);
		Pr(t.coordinateToPixelTransform, r), Pr(t.coordinateToPixelTransform, i), Pr(t.coordinateToPixelTransform, a), Pr(t.coordinateToPixelTransform, o);
		let s = this.inversePixelTransform;
		Pr(s, r), Pr(s, i), Pr(s, a), Pr(s, o), e.save(), e.beginPath(), e.moveTo(Math.round(r[0]), Math.round(r[1])), e.lineTo(Math.round(i[0]), Math.round(i[1])), e.lineTo(Math.round(a[0]), Math.round(a[1])), e.lineTo(Math.round(o[0]), Math.round(o[1])), e.clip();
	}
	prepareContainer(e, t) {
		let n = e.extent, r = e.viewState.resolution, i = e.viewState.rotation, a = e.pixelRatio, o = Math.round(H(n) / r * a), s = Math.round(At(n) / r * a);
		Fr(this.pixelTransform, e.size[0] / 2, e.size[1] / 2, 1 / a, 1 / a, i, -o / 2, -s / 2), Ir(this.inversePixelTransform, this.pixelTransform);
		let c = zr(this.pixelTransform), l = this.getBackground(e);
	...
	dispatchRenderEvent_(e, t, n) {
		let r = this.getLayer();
		if (r.hasListener(e)) {
			let i = new Al(e, this.inversePixelTransform, n, t);
			r.dispatchEvent(i);
		}
	}
	preRender(e, t) {
		this.frameState = t, !t.declutter && this.dispatchRenderEvent_(so.PRERENDER, e, t);
	}
	postRender(e, t) {
		t.declutter || this.dispatchRenderEvent_(so.POSTRENDER, e, t);
	}
	renderDeferredInternal(e) {}
	getRenderContext(e) {
		return e.declutter && !this.deferredContext_ && (this.deferredContext_ = new pu()), e.declutter ? this.deferredContext_.getContext() : this.context;
	}
	renderDeferred(e) {
		e.declutter && (this.dispatchRenderEvent_(so.PRERENDER, this.context, e), e.declutter && this.deferredContext_ && (this.deferredContext_.draw(this.context), this.deferredContext_.clear()), this.renderDeferredInternal(e), this.dispatchRenderEvent_(so.POSTRENDER, this.context, e));
	}
	getRenderTransform(e, t, n, r, i, a, o) {
		let s = i / 2, c = a / 2, l = r / t, u = -l, d = -e[0] + o, f = -e[1];
		return Fr(this.tempTransform, s, c, l, u, -n, d, f);
	}
	disposeInternal() {
...
function Su(e, t) {
	...
	n.extent && (t = jt(t, Or(n.extent, e.viewState.projection)));
...
var Cu = class extends yu {
	constructor(e, t) {
		super(e), t ||= {}, this.extentChanged = !0, this.renderComplete = !1, this.renderedExtent_ = null, this.renderedPixelRatio, this.renderedProjection = null, this.renderedTiles = [], this.renderedSourceRevision_, this.tempExtent = ft(), this.tempTileRange_ = new Gl(0, 0, 0, 0), this.tempTileCoord_ = su(0, 0, 0);
		let n = t.cacheSize === void 0 ? 512 : t.cacheSize;
		this.tileCache_ = new ou(n), this.sourceTileCache_ = null, this.layerExtent = null, this.maxStaleKeys = n * .5;
	}
	getTileCache() {
		return this.tileCache_;
	}
	getSourceTileCache() {
		return this.sourceTileCache_ ||= new ou(512), this.sourceTileCache_;
	}
	getOrCreateTile(e, t, n, r) {
		let i = this.tileCache_, a = this.getLayer().getSource(), o = lu(a, a.getKey(), e, t, n), s;
		if (i.containsKey(o)) s = i.get(o);
		else {
			let c = r.viewState.projection, l = a.getProjection();
			if (s = a.getTile(e, t, n, r.pixelRatio, c, !l || vr(l, c) ? void 0 : this.getSourceTileCache()), !s) return null;
			i.set(o, s);
		}
		return s;
	}
	...
	getData(e) {
		...
		if (!t) return null;
		let n = this.getLayer(), r = Pr(t.pixelToCoordinateTransform, e.slice()), i = n.getExtent();
		if (i && !ct(i, r)) return null;
		...
		for (let e = s.getZForResolution(a.resolution); e >= s.getMinZoom(); --e) {
			...
			if (!i || i.getState() !== z.LOADED) continue;
			let l = s.getOrigin(e), u = ts(s.getTileSize(e)), d = s.getResolution(e), f;
			if (i instanceof Ul || i instanceof au) f = i.getImage();
			else if (i instanceof Hl) {
				if (f = zl(i.getData()), !f) continue;
			} else continue;
	...
	enqueueTiles(e, t, n, r, i) {
		let a = e.viewState, o = this.getLayer(), s = o.getRenderSource(), c = s.getTileGridForProjection(a.projection), l = I(s);
		l in e.wantedTiles || (e.wantedTiles[l] = {});
		let u = e.wantedTiles[l], d = o.getMapInternal(), f = Math.max(n - i, c.getMinZoom(), c.getZForResolution(Math.min(o.getMaxResolution(), d ? d.getView().getResolutionForZoom(Math.max(o.getMinZoom(), 0)) : c.getResolution(0)), s.zDirection)), p = a.rotation, m = p ? kt(a.center, a.resolution, p, e.size) : void 0;
		for (let i = n; i >= f; --i) {
			...
			for (let t = n.minX; t <= n.maxX; ++t) for (let o = n.minY; o <= n.maxY; ++o) {
				...
				if (!n || !bu(r, n, i)) continue;
				let s = n.getKey();
				if (u[s] = !0, n.getState() === z.IDLE && !e.tileQueue.isKeyQueued(s)) {
					let r = su(i, t, o, this.tempTileCoord_);
					e.tileQueue.enqueue([
						n,
						l,
	...
	findStaleTile_(e, t) {
		...
		for (let e = 0; e < o.length; ++e) {
			let s = lu(this.getLayer().getSource(), o[e], r, i, a);
			if (n.containsKey(s)) {
				let e = n.peek(s);
				if (e.getState() === z.LOADED) return e.endTransition(I(this)), bu(t, e, r), !0;
			}
		}
		return !1;
	}
	findAltTiles_(e, t, n, r) {
		...
		for (let e = i.minX; e <= i.maxX; ++e) for (let t = i.minY; t <= i.maxY; ++t) {
			let i = lu(s, c, n, e, t), l = !1;
			if (o.containsKey(i)) {
				let e = o.peek(i);
				e.getState() === z.LOADED && (bu(r, e, n), l = !0);
			}
			l || (a = !1);
		}
		return a;
	...
	renderFrame(e, t) {
		...
		this.layerExtent = n.extent ? Or(n.extent, i) : null, this.layerExtent && (p = jt(p, this.layerExtent));
		...
		if (e.nextExtent && this.enqueueTilesForNextExtent()) {
			let t = u.getZForResolution(r.nextResolution, l.zDirection), n = Su(e, e.nextExtent);
		...
		let C = I(this), w = e.time;
		for (let t of b[d]) {
			let n = t.getState();
			if (n === z.EMPTY) continue;
			let r = t.tileCoord;
			if (n === z.LOADED && t.getAlpha(C, w) === 1) {
				t.endTransition(C);
				continue;
			}
			if (n !== z.ERROR && (this.renderComplete = !1), this.findStaleTile_(r, b)) {
				xu(b, t, d), e.animate = !0;
				continue;
			}
		...
		Fr(this.tempTransform, h / 2, g / 2, T, T, 0, -h / 2, -g / 2), this.layerExtent && this.clipUnrotated(E, e, this.layerExtent), l.getInterpolate() || (E.imageSmoothingEnabled = !1), this.preRender(E, e);
		let D = Object.keys(b).map(Number);
		D.sort(ie);
		let O = [], k = [], A = [];
		for (let t = D.length - 1; t >= 0; --t) {
			let n = D[t], r = l.getTilePixelSize(n, s, i), a = u.getResolution(n) / f, o = r[0] * a * T, c = r[1] * a * T, p = u.getTileCoordForCoordAndZ(Nt(y), n), h = u.getTileCoordExtent(p), g = Pr(this.tempTransform, [m * (h[0] - y[0]) / f, m * (y[3] - h[3]) / f]), _ = m * l.getGutterForProjection(i);
			for (let t of b[n]) {
				...
				for (let e = 0, t = O.length; e < t; ++e) n < k[e] && Ft(b, O[e]) && x.push(O[e]);
				let S;
				x.length > 0 && (S = Vt(b, x)), O.push(b), k.push(n), this.drawTile(t, e, f, m, h, v, _, y, S), this.renderedTiles.unshift(t), this.updateUsedTiles(e.usedTiles, l, t);
			}
		}
		for (let t = 0, n = A.length; t < n; ++t) {
			let { tile: n, x: r, y: i, w: a, h: o, gutter: s } = A[t];
			this.drawTile(n, e, r, i, a, o, s, !0, void 0);
		}
		return this.renderedResolution = f, this.extentChanged = !this.renderedExtent_ || !_t(this.renderedExtent_, y), this.renderedExtent_ = y, this.renderedPixelRatio = s, this.postRender(this.context, e), this.layerExtent && E.restore(), E.imageSmoothingEnabled = !0, this.renderComplete && e.postRenderFunctions.push((e, t) => {
			let n = I(l), r = t.wantedTiles[n], i = r ? Object.keys(r).length : 0;
	...
	drawTile(e, t, n, r, i, a, o, s, c) {
		let l;
		if (e instanceof Hl) {
			if (l = zl(e.getData()), !l) throw Error("Rendering array data is not yet supported");
		} else l = this.getTileImage(e);
		if (!l) return;
		let u = this.getRenderContext(t), d = I(this), f = t.layerStatesArray[t.layerIndex], p = f.opacity * (s ? e.getAlpha(d, t.time) : 1), m = p !== u.globalAlpha;
	...
	getPreload() {
		return this.get(wu.PRELOAD);
	}
	setPreload(e) {
		this.set(wu.PRELOAD, e);
	}
	getUseInterimTilesOnError() {
		return this.get(wu.USE_INTERIM_TILES_ON_ERROR);
	}
	setUseInterimTilesOnError(e) {
		this.set(wu.USE_INTERIM_TILES_ON_ERROR, e);
	}
	getData(e) {
	...
	createRenderer() {
		return new Cu(this, { cacheSize: this.getCacheSize() });
	}
}, Du = [
	0,
	0,
	...
	constructor(e) {
		...
		t === void 0 && n && (t = n.findIndex((e) => e !== void 0)), this.minZoom = t === void 0 ? 0 : t, this.resolutions_ = n, B(ue(this.resolutions_, (e, t) => t - e, !0), "`resolutions` must be sorted in descending order");
		let r;
		if (!e.origins) {
	...
	forEachTileCoordParentTileRange(e, t, n, r) {
		...
		for (this.zoomFactor_ === 2 ? (a = e[1], o = e[2]) : s = this.getTileCoordExtent(e, r); c >= this.minZoom;) {
			if (a !== void 0 && o !== void 0 ? (a = Math.floor(a / 2), o = Math.floor(o / 2), i = Kl(a, a, o, o, n)) : i = this.getTileRangeForExtentAndZ(s, c, n), t(c, i)) return !0;
			--c;
		}
		return !1;
	}
	...
	getTileRangeForTileCoordAndZ(e, t, n) {
		...
		if (t === r) return Kl(i, a, i, a, n);
		if (this.zoomFactor_) {
			let e = this.zoomFactor_ ** +(t - r), o = Math.floor(i * e), s = Math.floor(a * e);
			return t < r ? Kl(o, o, s, s, n) : Kl(o, Math.floor(e * (i + 1)) - 1, s, Math.floor(e * (a + 1)) - 1, n);
		}
	...
	getTileRangeForExtentAndZ(e, t, n) {
		this.getTileCoordForXYAndZ_(e[0], e[3], t, !1, Du);
		let r = Du[1], i = Du[2];
		this.getTileCoordForXYAndZ_(e[2], e[1], t, !0, Du);
		let a = Du[1], o = Du[2];
		return Kl(r, a, i, o, n);
	}
	getTileCoordCenter(e) {
		let t = this.getOrigin(e[0]), n = this.getResolution(e[0]), r = ts(this.getTileSize(e[0]), this.tmpSize_);
		return [t[0] + (e[1] + .5) * r[0] * n, t[1] - (e[2] + .5) * r[1] * n];
	}
	getTileCoordExtent(e, t) {
		let n = this.getOrigin(e[0]), r = this.getResolution(e[0]), i = ts(this.getTileSize(e[0]), this.tmpSize_), a = n[0] + e[1] * i[0] * r, o = n[1] - (e[2] + 1) * i[1] * r;
		return pt(a, o, a + i[0] * r, o + i[1] * r, t);
	}
	...
	getTileCoordForXYAndResolution_(e, t, n, r, i) {
		let a = this.getZForResolution(n), o = n / this.getResolution(a), s = this.getOrigin(a), c = ts(this.getTileSize(a), this.tmpSize_), l = o * (e - s[0]) / n / c[0], u = o * (s[1] - t) / n / c[1];
		return r ? (l = $e(l, Ou) - 1, u = $e(u, Ou) - 1) : (l = Qe(l, Ou), u = Qe(u, Ou)), su(a, l, u, i);
	}
	getTileCoordForXYAndZ_(e, t, n, r, i) {
		let a = this.getOrigin(n), o = this.getResolution(n), s = ts(this.getTileSize(n), this.tmpSize_), c = (e - a[0]) / o / s[0], l = (a[1] - t) / o / s[1];
		return r ? (c = $e(c, Ou) - 1, l = $e(l, Ou) - 1) : (c = Qe(c, Ou), l = Qe(l, Ou)), su(n, c, l, i);
	}
	...
	getZForResolution(e, t) {
		return V(oe(this.resolutions_, e, t || 0), this.minZoom, this.maxZoom);
	}
	tileCoordIntersectsViewport(e, t) {
		return _i(t, 0, t.length, 2, this.getTileCoordExtent(e));
	}
...
function Au(e) {
	...
	return t || (t = Fu(e), e.setDefaultTileGrid(t)), t;
}
function ju(e, t, n) {
	let r = t[0], i = e.getTileCoordCenter(t), a = Iu(n);
	if (!ct(a, i)) {
...
function Nu(e) {
	let t = e || {}, n = t.extent || dr("EPSG:3857").getExtent();
	return new ku({
		extent: n,
		minZoom: t.minZoom,
		tileSize: t.tileSize,
		resolutions: Pu(n, t.maxZoom, t.tileSize, t.maxResolution)
	});
}
function Pu(e, t, n, r) {
	t = t === void 0 ? 42 : t, n = ts(n === void 0 ? 256 : n);
	let i = At(e), a = H(e);
...
function Fu(e, t, n, r) {
	return Mu(Iu(e), t, n, r);
}
function Iu(e) {
	e = dr(e);
	let t = e.getExtent();
	if (!t) {
		let n = 180 * rn.degrees / e.getMetersPerUnit();
		t = pt(-n, -n, n, n);
	}
	return t;
}
...
var Lu = /\{z\}/g, Ru = /\{x\}/g, zu = /\{y\}/g, Bu = /\{-y\}/g;
...
function Gu(e) {
	return e.length === 1 ? e[0] : (function(t, n, r) {
		return t ? e[Ye(uu(t), e.length)](t, n, r) : void 0;
	});
}
//#endregion
...
var Ku = class extends Se {
	constructor(e) {
		super(), this.projection = dr(e.projection), this.attributions_ = qu(e.attributions), this.attributionsCollapsible_ = e.attributionsCollapsible ?? !0, this.loading = !1, this.state_ = e.state === void 0 ? "ready" : e.state, this.wrapX_ = e.wrapX !== void 0 && e.wrapX, this.interpolate_ = !!e.interpolate, this.viewResolver = null, this.viewRejector = null;
		let t = this;
	...
	setAttributions(e) {
		this.attributions_ = qu(e), this.changed();
	}
	setState(e) {
...
var Ju = class extends Ku {
	constructor(e) {
		super({
			...
			wrapX: e.wrapX,
			interpolate: e.interpolate
		}), this.on, this.once, this.un, this.tilePixelRatio_ = e.tilePixelRatio === void 0 ? 1 : e.tilePixelRatio, this.tileGrid = e.tileGrid === void 0 ? null : e.tileGrid, this.tileGrid && ts(this.tileGrid.getTileSize(this.tileGrid.getMinZoom()), [256, 256]), this.tmpSize = [0, 0], this.key_ = e.key || I(this), this.tileOptions = {
			transition: e.transition,
			interpolate: e.interpolate
	...
	getTilePixelSize(e, t, n) {
		let r = this.getTileGridForProjection(n), i = this.getTilePixelRatio(t), a = ts(r.getTileSize(e), this.tmpSize);
		return i == 1 ? a : es(a, i, this.tmpSize);
	}
	getTileCoordForTileUrlFunction(e, t) {
		...
		return this.getWrapX() && n.isGlobal() && (e = ju(r, e, n)), fu(e, r) ? e : null;
	}
	clear() {}
	refresh() {
	...
	handleTileChange(e) {
		let t = e.target, n = I(t), r = t.getState(), i;
		r == z.LOADING ? (this.tileLoadingKeys_[n] = !0, i = Xu.TILELOADSTART) : n in this.tileLoadingKeys_ && (delete this.tileLoadingKeys_[n], i = r == z.ERROR ? Xu.TILELOADERROR : r == z.LOADED ? Xu.TILELOADEND : void 0), i != null && this.dispatchEvent(new Yu(i, t));
	}
	...
	constructor(e) {
		super({
			...
			state: e.state,
			tileGrid: e.tileGrid,
			tileLoadFunction: e.tileLoadFunction ? e.tileLoadFunction : $u,
		...
		}), this.crossOrigin = e.crossOrigin === void 0 ? null : e.crossOrigin, this.referrerPolicy = e.referrerPolicy, this.tileClass = e.tileClass === void 0 ? Ul : e.tileClass, this.tileGridForProjection = {}, this.reprojectionErrorThreshold_ = e.reprojectionErrorThreshold, this.renderReprojectionEdges_ = !1;
	}
	getGutterForProjection(e) {
		return this.getProjection() && e && !vr(this.getProjection(), e) ? 0 : this.getGutter();
	}
	getGutter() {
		return 0;
	}
	...
	getTileGridForProjection(e) {
		...
		if (this.tileGrid && (!t || vr(t, e))) return this.tileGrid;
		let n = I(e);
	...
	createTile_(e, t, n, r, i, a) {
		let o = [
			...
			t,
			n
		], s = this.getTileCoordForTileUrlFunction(o, i), c = s ? this.tileUrlFunction(s, r, i) : void 0, l = new this.tileClass(o, c === void 0 ? z.EMPTY : z.IDLE, c === void 0 ? "" : c, {
			crossOrigin: this.crossOrigin,
			referrerPolicy: this.referrerPolicy
		}, this.tileLoadFunction, this.tileOptions);
		return l.key = a, l.addEventListener(P.CHANGE, this.handleTileChange.bind(this)), l;
	}
	getTile(e, t, n, r, i, a) {
		let o = this.getProjection();
		if (!o || !i || vr(o, i)) return this.getTileInternal(e, t, n, r, o || i);
		let s = [
			e,
			t,
			n
		], c = this.getKey(), l = new au(o, this.getTileGridForProjection(o), i, this.getTileGridForProjection(i), s, this.getTileCoordForTileUrlFunction(s, i), this.getTilePixelRatio(r), this.getGutter(), (e, t, n, r) => this.getTileInternal(e, t, n, r, o, a), this.reprojectionErrorThreshold_, this.renderReprojectionEdges_, this.tileOptions);
		return l.key = c, l;
	}
	getTileInternal(e, t, n, r, i, a) {
		let o = this.getKey(), s = lu(this, o, e, t, n);
...
var ed = class extends Qu {
	constructor(e) {
		e ||= {};
		let t = e.projection === void 0 ? "EPSG:3857" : e.projection, n = e.tileGrid === void 0 ? Nu({
			extent: Iu(t),
...
}, td = "&#169; <a href=\"https://www.openstreetmap.org/copyright\" target=\"_blank\">OpenStreetMap</a> contributors.", nd = class extends ed {
	constructor(e) {
		e ||= {};
		let t;
		t = e.attributions === void 0 ? [td] : e.attributions;
...
}, rd = class e extends Se {
	constructor(e) {
		if (super(), this.on, this.once, this.un, this.id_ = void 0, this.geometryName_ = "geometry", this.style_ = null, this.styleFunction_ = void 0, this.geometryChangeKey_ = null, this.addChangeListener(this.geometryName_, this.handleGeometryChanged_), e) if (typeof e.getSimplifiedGeometry == "function") {
			let t = e;
			this.setGeometry(t);
		} else {
			let t = e;
	...
	handleGeometryChanged_() {
		this.geometryChangeKey_ &&= (N(this.geometryChangeKey_), null);
		let e = this.getGeometry();
		e && (this.geometryChangeKey_ = M(e, P.CHANGE, this.handleGeometryChange_, this)), this.changed();
	}
	setGeometry(e) {
		this.set(this.geometryName_, e);
	}
	setStyle(e) {
		this.style_ = e, this.styleFunction_ = e ? id(e) : void 0, this.changed();
	}
	setId(e) {
...
function id(e) {
	...
	let t;
	return Array.isArray(e) ? t = e : (B(typeof e.getZIndex == "function", "Expected an `ol/style/Style` or an array of `ol/style/Style.js`"), t = [e]), function() {
		return t;
	};
}
//#endregion
...
function ad(e, t, n, r, i, a, o) {
	...
	o = o > 1 ? o : 2, a ||= Array(o);
	for (let t = 0; t < o; ++t) a[t] = s === void 0 ? NaN : c === void 0 ? e[s + t] : Xe(e[s + t], e[s + r + t], c);
	return a;
}
//#endregion
...
function sd(e, t, n, r, i, a, o, s) {
	...
	for (let x = t; x < n; x += r) {
		m = f, h = p, g = void 0, _ = void 0, x + r < n && (g = e[x + r], _ = e[x + r + 1]), a && x === t && (m = u, h = d), a && x === n - r && (g = c, _ = l), f = e[x], p = e[x + 1], [v, y] = cd(f, p, m, h, g, _, i), o[b++] = v, o[b++] = y;
...
var ud = class {
	...
	drawImages_(e, t, n, r) {
		...
		for (let e = 0, t = i.length; e < t; e += 2) {
			...
			if (c !== 0 || this.imageScale_[0] != 1 || this.imageScale_[1] != 1) {
				...
				Fr(o, e, r, 1, 1, c, -e, -r), a.save(), a.transform.apply(a, o), a.translate(e, r), a.scale(this.imageScale_[0], this.imageScale_[1]), a.drawImage(this.image_, this.imageOriginX_, this.imageOriginY_, this.imageWidth_, this.imageHeight_, -this.imageAnchorX_, -this.imageAnchorY_, this.imageWidth_, this.imageHeight_), a.restore();
	...
	drawText_(e, t, n, r) {
		...
		let i = Hr(e, t, n, r, this.transform_, this.pixelCoordinates_), a = this.context_, o = this.textRotation_;
	...
	moveToLineTo_(e, t, n, r, i, a) {
		let o = this.context_, s = Hr(e, t, n, r, this.transform_, this.pixelCoordinates_);
		if (Math.abs(a) > 0) {
			let e = s.length, t = i || Math.abs(s[0] - s[e - 2]) < 1e-6 && Math.abs(s[1] - s[e - 1]) < 1e-6;
			s = sd(s, 0, e, 2, a, t, s), ld(s, 2, t);
		}
		o.moveTo(s[0], s[1]);
		let c = s.length;
		i && (c -= 2);
	...
	drawCircle(e) {
		if (this.squaredTolerance_ && (e = e.simplifyTransformed(this.squaredTolerance_, this.userTransform_)), Ft(this.extent_, e.getExtent())) {
			if (this.fillState_ || this.strokeState_) {
				this.fillState_ && this.setContextFillState_(this.fillState_), this.strokeState_ && this.setContextStrokeState_(this.strokeState_);
				let t = Qr(e, this.transform_, this.pixelCoordinates_), n = t[2] - t[0], r = t[3] - t[1], i = Math.sqrt(n * n + r * r), a = this.context_;
	...
	setContextTextState_(e) {
		let t = this.context_, n = this.contextTextState_, r = e.textAlign ? e.textAlign : mc;
	...
	setFillStrokeStyle(e, t) {
		if (!e) this.fillState_ = null;
			...
			let t = e.getColor();
			this.fillState_ = { fillStyle: oc(t || lc) };
		}
		if (!t) this.strokeState_ = null;
		else {
			let e = t.getColor(), n = t.getLineCap(), r = t.getLineDash(), i = t.getLineDashOffset(), a = t.getLineJoin(), o = t.getWidth(), s = t.getMiterLimit(), c = r || dc, l = t.getOffset();
			this.strokeState_ = {
				lineCap: n === void 0 ? uc : n,
				lineDash: this.pixelRatio_ === 1 ? c : c.map((e) => e * this.pixelRatio_),
				lineDashOffset: (i || 0) * this.pixelRatio_,
				lineJoin: a === void 0 ? fc : a,
	...
	setTextStyle(e) {
		if (!e) this.text_ = "";
			...
			if (!t) this.textFillState_ = null;
				...
				let e = t.getColor();
				this.textFillState_ = { fillStyle: oc(e || lc) };
			}
			let n = e.getStroke();
			...
			this.textState_ = {
				font: r === void 0 ? cc : r,
				textAlign: u === void 0 ? mc : u,
				textBaseline: d === void 0 ? hc : d
...
function bd(e, t, n, r, i) {
	if (t.getType() == "GeometryCollection") {
		...
		for (let t = 0, o = a.length; t < o; ++t) bd(e, a[t], n, r, i);
		return;
	}
...
function kd(e, t, n, r, i, a, o) {
	...
	s.open("GET", typeof e == "function" ? e(n, r, i) : e, !0), t.getType() == "arraybuffer" && (s.responseType = "arraybuffer"), s.withCredentials = Od, s.onload = function(e) {
...
function Md(e, t, n, r) {
	...
	for (let o = 0, s = n.length; o < s; ++o) {
		let s = n[o];
		a = gt(e, t, s[0], r), i.push((a[0] + a[2]) / 2, (a[1] + a[3]) / 2), t = s[s.length - 1];
	}
	return i;
}
//#endregion
//#region node_modules/ol/render/Feature.js
var Nd = Mr(), Pd = class e {
	constructor(e, t, n, r, i, a) {
	...
	getExtent() {
		return this.extent_ ||= this.type_ === "Point" ? ht(this.flatCoordinates_) : gt(this.flatCoordinates_, 0, this.flatCoordinates_.length, this.stride_), this.extent_;
	}
	getFlatInteriorPoint() {
		if (!this.flatInteriorPoints_) {
			let e = Et(this.getExtent());
			this.flatInteriorPoints_ = Ei(this.flatCoordinates_, 0, this.ends_, this.stride_, e, 0);
		}
		return this.flatInteriorPoints_;
	}
	getFlatInteriorPoints() {
		if (!this.flatInteriorPoints_) {
			let e = Mi(this.flatCoordinates_, this.ends_), t = Md(this.flatCoordinates_, 0, e, this.stride_);
			this.flatInteriorPoints_ = Di(this.flatCoordinates_, 0, e, this.stride_, t);
		}
		return this.flatInteriorPoints_;
	}
	getFlatMidpoint() {
		return this.flatMidpoints_ ||= ad(this.flatCoordinates_, 0, this.flatCoordinates_.length, this.stride_, .5), this.flatMidpoints_;
	}
	getFlatMidpoints() {
		if (!this.flatMidpoints_) {
			...
			for (let r = 0, i = n.length; r < i; ++r) {
				let i = n[r], a = ad(e, t, i, this.stride_, .5);
				ce(this.flatMidpoints_, a), t = i;
			}
		}
	...
	transform(e) {
		...
		if (t && n) {
			let e = At(n) / At(t);
			Fr(Nd, n[0], n[3], e, -e, 0, 0, 0), Hr(this.flatCoordinates_, 0, this.flatCoordinates_.length, this.stride_, Nd, this.flatCoordinates_);
		}
	}
	applyTransform(e) {
	...
	enableSimplifyTransformed() {
		return this.simplifyTransformed = me((t, n) => {
			...
			switch (this.type_) {
				case "LineString":
					r.length = yi(r, 0, this.simplifiedGeometry_.flatCoordinates_.length, this.simplifiedGeometry_.stride_, t, r, 0), i = [r.length];
					break;
				case "MultiLineString":
					i = [], r.length = bi(r, 0, this.simplifiedGeometry_.ends_, this.simplifiedGeometry_.stride_, t, r, 0, i);
					break;
				case "Polygon": i = [], r.length = Ci(r, 0, this.simplifiedGeometry_.ends_, this.simplifiedGeometry_.stride_, Math.sqrt(t), r, 0, i);
			}
...
Pd.prototype.getFlatCoordinates = Pd.prototype.getOrientedFlatCoordinates;
//#endregion
//#region node_modules/ol/structs/RBush.js
var Fd = class {
	constructor(e) {
		this.rbush_ = new mo(e), this.items_ = {};
	}
	insert(e, t) {
		let n = {
			minX: e[0],
		...
		this.rbush_.insert(n), this.items_[I(t)] = n;
	}
	load(e, t) {
		...
		for (let r = 0, i = t.length; r < i; r++) {
			...
			n[r] = o, this.items_[I(a)] = o;
		}
		this.rbush_.load(n);
	}
	remove(e) {
		let t = I(e), n = this.items_[t];
		return delete this.items_[t], this.rbush_.remove(n) !== null;
	}
	update(e, t) {
		let n = this.items_[I(t)];
		_t([
			n.minX,
			n.minY,
			n.maxX,
	...
	constructor(e) {
		e ||= {}, super({
			...
			state: "ready",
			wrapX: e.wrapX === void 0 || e.wrapX
		}), this.on, this.once, this.un, this.loader_ = pe, this.format_ = e.format || null, this.overlaps_ = e.overlaps === void 0 || e.overlaps, this.url_ = e.url, e.loader === void 0 ? this.url_ !== void 0 && (B(this.format_, "`format` must be set when `url` is set"), this.loader_ = Ad(this.url_, this.format_)) : this.loader_ = e.loader, this.strategy_ = e.strategy === void 0 ? jd : e.strategy;
		let t = e.useSpatialIndex === void 0 || e.useSpatialIndex;
		this.featuresRtree_ = t ? new Fd() : null, this.loadedExtentsRtree_ = new Fd(), this.nullGeometryFeatures_ = {}, this.idIndex_ = {}, this.uidIndex_ = {}, this.featureChangeKeys_ = {}, this.featuresCollection_ = null;
		let n, r;
		Array.isArray(e.features) ? r = e.features : e.features && (n = e.features, r = n.getArray()), !t && n === void 0 && (n = new Te(r)), r !== void 0 && this.addFeaturesInternal(r), n !== void 0 && this.bindFeaturesCollection_(n);
	}
	addFeature(e) {
	...
	addFeatureInternal(e) {
		...
		this.dispatchEvent(new Ld(Id.ADDFEATURE, e));
	}
	setupChangeEvents_(e, t) {
		t instanceof Pd || (this.featureChangeKeys_[e] = [M(t, P.CHANGE, this.handleFeatureChange_, this), M(t, A.PROPERTYCHANGE, this.handleFeatureChange_, this)]);
	}
	addToIndex_(e, t) {
		let n = !0;
		if (t.getId() !== void 0) {
			...
			if (!(e in this.idIndex_)) this.idIndex_[e] = t;
				...
				r instanceof Pd ? Array.isArray(r) ? r.push(t) : this.idIndex_[e] = [r, t] : n = !1;
			} else n = !1;
		}
		return n && (B(!(e in this.uidIndex_), "The passed `feature` was already added to the source"), this.uidIndex_[e] = t), n;
	}
	addFeatures(e) {
	...
	addFeaturesInternal(e) {
		...
		if (this.featuresRtree_ && this.featuresRtree_.load(t, r), this.hasListener(Id.ADDFEATURE)) for (let e = 0, t = n.length; e < t; e++) this.dispatchEvent(new Ld(Id.ADDFEATURE, n[e]));
	}
	bindFeaturesCollection_(e) {
		let t = !1;
		this.addEventListener(Id.ADDFEATURE, function(n) {
			t ||= (t = !0, e.push(n.feature), !1);
		}), this.addEventListener(Id.REMOVEFEATURE, function(n) {
			t ||= (t = !0, e.remove(n.feature), !1);
		}), e.addEventListener(k.ADD, (e) => {
			t ||= (t = !0, this.addFeature(e.element), !1);
		}), e.addEventListener(k.REMOVE, (e) => {
			t ||= (t = !0, this.removeFeature(e.element), !1);
		}), this.featuresCollection_ = e;
	}
	clear(e) {
		if (e) {
			for (let e in this.featureChangeKeys_) this.featureChangeKeys_[e].forEach(N);
	...
	forEachFeatureAtCoordinateDirect(e, t) {
		...
		return this.forEachFeatureInExtent(n, function(n) {
			let r = n.getGeometry();
			if (r instanceof Pd || r.intersectsCoordinate(e)) return t(n);
		});
	}
	...
	forEachFeatureIntersectingExtent(e, t) {
		return this.forEachFeatureInExtent(e, function(n) {
			let r = n.getGeometry();
			if (r instanceof Pd || r.intersectsExtent(e)) {
				let e = t(n);
				if (e) return e;
			}
		});
	...
	getFeatures() {
		let e;
		return this.featuresCollection_ ? e = this.featuresCollection_.getArray().slice(0) : this.featuresRtree_ && (e = this.featuresRtree_.getAll(), j(this.nullGeometryFeatures_) || ce(e, Object.values(this.nullGeometryFeatures_))), e;
	}
	...
	getClosestFeatureToCoordinate(e, t) {
		...
		return t ||= de, this.featuresRtree_.forEachInExtent(s, function(e) {
			if (t(e)) {
				let t = e.getGeometry(), c = o;
				if (o = t instanceof Pd ? 0 : t.closestPointXY(n, r, a, o), o < c) {
					i = e;
					let t = Math.sqrt(o);
	...
	handleFeatureChange_(e) {
		let t = e.target, n = I(t), r = t.getGeometry();
		...
		this.changed(), this.dispatchEvent(new Ld(Id.CHANGEFEATURE, t));
	}
	hasFeature(e) {
		let t = e.getId();
		if (t !== void 0) {
		...
		return I(e) in this.uidIndex_;
	}
	isEmpty() {
		return this.featuresRtree_ ? this.featuresRtree_.isEmpty() && j(this.nullGeometryFeatures_) : !this.featuresCollection_ || this.featuresCollection_.getLength() === 0;
	}
	loadFeatures(e, t, n) {
		...
		for (let e = 0, a = i.length; e < a; ++e) {
			...
			if (!r.forEachInExtent(a, function(e) {
				return lt(e.extent, a);
			})) {
				this.loading = Number(this.loading) + 1, this.dispatchEvent(new Ld(Id.FEATURESLOADSTART));
				let e = (e) => {
					this.loading = Number(this.loading) - 1, this.dispatchEvent(new Ld(Id.FEATURESLOADEND, void 0, e));
				}, i = () => {
					this.changed(), this.loading = Number(this.loading) - 1, this.dispatchEvent(new Ld(Id.FEATURESLOADERROR));
	...
	removeFeatureInternal(e) {
		...
		t in this.nullGeometryFeatures_ ? delete this.nullGeometryFeatures_[t] : this.featuresRtree_ && this.featuresRtree_.remove(e), this.featureChangeKeys_[t]?.forEach(N), delete this.featureChangeKeys_[t];
		let n = e.getId();
		if (n !== void 0) {
		...
		return delete this.uidIndex_[t], this.hasListener(Id.REMOVEFEATURE) && this.dispatchEvent(new Ld(Id.REMOVEFEATURE, e)), !0;
	}
	...
	setUrl(e) {
		B(this.format_, "`format` must be set when `url` is set"), this.url_ = e, this.setLoader(Ad(e, this.format_));
	}
	setOverlaps(e) {
	...
	SET_STROKE_STYLE: 11,
	STROKE: 12
}, zd = [$.FILL], Bd = [$.STROKE], Vd = [$.BEGIN_PATH], Hd = [$.CLOSE_PATH], Ud = class extends ud {
	constructor(e, t, n, r) {
	...
	appendFlatPointCoordinates(e, t) {
		...
		for (let o = 0, s = e.length; o < s; o += t) r[0] = e[o], r[1] = e[o + 1], ct(n, r) && (i[a++] = r[0], i[a++] = r[1]);
		return a;
	}
	appendFlatLineCoordinates(e, t, n, r, i, a) {
		...
		for (p = t + r; p < n; p += r) d[0] = e[p], d[1] = e[p + 1], h = dt(c, d), h === m ? h === rt.INTERSECTING ? (o[s++] = d[0], o[s++] = d[1], f = !1) : f = !0 : (f &&= (o[s++] = l, o[s++] = u, !1), o[s++] = d[0], o[s++] = d[1]), l = d[0], u = d[1], m = h;
	...
	reverseHitDetectionInstructions() {
		...
		for (t = 0; t < n; ++t) r = e[t], i = r[0], i == $.END_GEOMETRY ? a = t : i == $.BEGIN_GEOMETRY && (r[2] = t, se(this.hitDetectionInstructions, a, t), a = -1);
	}
	fillStyleToState(e, t = {}) {
		if (e) {
			let n = e.getColor();
			t.fillPatternScale = n && typeof n == "object" && "src" in n ? this.pixelRatio : 1, t.fillStyle = oc(n || "#000") ?? void 0;
		} else t.fillStyle = void 0;
		return t;
	}
	strokeStyleToState(e, t = {}) {
		if (e) {
			t.strokeStyle = oc(e.getColor() || pc);
			let n = e.getLineCap();
			t.lineCap = n === void 0 ? uc : n;
			let r = e.getLineDash();
			t.lineDash = r ? r.slice() : dc, t.lineDashOffset = e.getLineDashOffset() || 0;
			let i = e.getLineJoin();
			t.lineJoin = i === void 0 ? fc : i;
			let a = e.getWidth();
	...
	createFill(e) {
		let t = e.fillStyle, n = [$.SET_FILL_STYLE, t];
	...
	drawPoint(e, t, n) {
		if (!this.image_ || this.maxExtent && !ct(this.maxExtent, e.getFlatCoordinates())) return;
	...
	drawMultiPoint(e, t, n) {
		...
		for (let t = 0, n = r.length; t < n; t += e.getStride()) (!this.maxExtent || ct(this.maxExtent, r.slice(t, t + 2))) && i.push(r[t], r[t + 1]);
	...
	drawLineString(e, t, n) {
		...
		this.drawFlatCoordinates_(s, 0, s.length, c, o), this.hitDetectionInstructions.push(Bd), this.endGeometry(t);
	}
	drawMultiLineString(e, t, n) {
		let r = this.state, i = r.strokeStyle, a = r.lineWidth, o = r.strokeOffset;
		if (i === void 0 || a === void 0) return;
		...
		this.hitDetectionInstructions.push(Bd), this.endGeometry(t);
	}
	finish() {
		let e = this.state;
		return e.lastStroke != null && e.lastStroke != this.coordinates.length && this.instructions.push(Bd), this.reverseHitDetectionInstructions(), this.state = null, super.finish();
	}
	applyStroke(e) {
		e.lastStroke != null && e.lastStroke != this.coordinates.length && (this.instructions.push(Bd), e.lastStroke = this.coordinates.length), e.lastStroke = 0, super.applyStroke(e), this.instructions.push(Vd);
	}
}, Kd = class extends Ud {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	...
	drawFlatCoordinatess_(e, t, n, r, i) {
		...
		return o && (this.instructions.push(zd), this.hitDetectionInstructions.push(zd)), s && (this.instructions.push(Bd), this.hitDetectionInstructions.push(Bd)), t;
	}
	drawCircle(e, t, n) {
		...
		this.setFillStrokeStyles_(), this.beginGeometry(e, t, n), r.fillStyle !== void 0 && this.hitDetectionInstructions.push([$.SET_FILL_STYLE, lc]), r.strokeStyle !== void 0 && this.hitDetectionInstructions.push([
			$.SET_STROKE_STYLE,
			pc,
			r.lineWidth,
			r.lineCap,
		...
		this.instructions.push(Vd, u), this.hitDetectionInstructions.push(Vd, u), r.fillStyle !== void 0 && (this.instructions.push(zd), this.hitDetectionInstructions.push(zd)), r.strokeStyle !== void 0 && (this.instructions.push(Bd), this.hitDetectionInstructions.push(Bd)), this.endGeometry(t);
	}
	drawPolygon(e, t, n) {
		let r = this.state, i = r.fillStyle, a = r.strokeStyle, o = r.strokeOffset;
	...
	finish() {
		...
		if (e !== 0) {
			...
			for (let n = 0, r = t.length; n < r; ++n) t[n] = xi(t[n], e);
		}
		return super.finish();
	}
...
function Xd(e, t, n, r) {
	...
	for (let r = 0, m = t.length; r < m; ++r) {
		...
		for (let t = p + n; t < m; t += n) {
			let n = e[t], r = e[t + 1];
			if (Yd(i, a, o, s, h, g, n, r)) {
				let e = n - h, t = r - g, i = h + qd * e, a = g + qd * t, o = h + Jd * e, s = g + Jd * t;
	...
	Text: class extends Ud {
		...
		drawText(e, t, n) {
			...
			if (a.placement === "line" && (c == "LineString" || c == "MultiLineString" || c == "Polygon" || c == "MultiPolygon")) {
				...
				if ((c == "LineString" || c == "MultiLineString") && !lt(this.getBufferedMaxExtent(), r)) {
					let e = Xd(l, i, u, this.getBufferedMaxExtent());
				...
				for (let e = 0, t = i.length; e < t; ++e) {
					let t;
					t = d ? Zd(d * this.resolution, l, p, i[e], u) : [l.slice(p, i[e])];
					for (let n = 0, r = t.length; n < r; ++n) {
						let r = t[n], c = 0, l = r.length;
						if (f == null) {
							let e = Qd(a.maxAngle, r, 0, r.length, 2);
							c = e[0], l = e[1];
						}
				...
				this.beginGeometry(e, t, n);
				let p = a.padding;
				if (p != gc && (a.scale[0] < 0 || a.scale[1] < 0)) {
				...
				g && (g[1] = lc), this.hitDetectionInstructions.push([
					$.DRAW_IMAGE,
					s,
					i,
					null,
					...
					this.textKey_,
					this.strokeKey_,
					this.fillKey_ ? lc : this.fillKey_,
					this.textOffsetX_,
					this.textOffsetY_,
					r
				]), this.endGeometry(t);
		...
		drawChars_(e, t) {
			...
			this.saveTextStates_();
			let s = this.pixelRatio, c = $d[r.textBaseline], l = this.textOffsetX_ * s, u = this.textOffsetY_ * s, d = this.text_, f = n ? n.lineWidth * Math.abs(r.scale[0]) / 2 : 0;
			this.instructions.push([
				$.DRAW_CHARS,
				e,
				t,
		...
		setTextStyle(e, t) {
			...
			if (!e) this.text_ = "";
				...
				let t = e.getFill();
				t ? (r = this.textFillState_, r || (r = {}, this.textFillState_ = r), r.fillStyle = oc(t.getColor() || "#000")) : (r = null, this.textFillState_ = r);
				let a = e.getStroke();
...
function af(e, t, n, r, i, a, o, s, c, l, u, d, f = !0) {
	...
	do
		y();
	while (t < n - r && v + _ < a);
	let b = _ === 0 ? 0 : (a - v) / _, x = Xe(h, p, b), S = Xe(g, m, b), C = t - r, w = v, T = a + s * c(l, i, u);
	for (; t < n - r && v + _ < T;) y();
	b = _ === 0 ? 0 : (T - v) / _;
	let E = Xe(h, p, b), D = Xe(g, m, b), O = !1;
	if (f) if (d) {
		let e = [
			x,
			S,
	...
	i = i.replace(/\n/g, " ");
	let M = Array.from(rf().segment(i), (e) => e.segment);
...
var of = ft(), sf = [], cf = [], lf = [], uf = [];
function df(e) {
	return e[3].declutterBox;
}
var ff = /* @__PURE__ */ RegExp("[֑-ࣿיִ-﷿ﹰ-ﻼࠀ-࿿-]");
function pf(e, t) {
	return t === "start" ? t = ff.test(e) ? "right" : "left" : t === "end" && (t = ff.test(e) ? "left" : "right"), $d[t];
}
function mf(e, t, n) {
	return n > 0 && e.push("\n", ""), e.push(t, ""), e;
}
...
var gf = class {
	constructor(e, t, n, r, i) {
		this.overlaps = n, this.pixelRatio = t, this.resolution = e, this.alignAndScaleFill_, this.instructions = r.instructions, this.coordinates = r.coordinates, this.coordinateCache_ = {}, this.renderedTransform_ = Mr(), this.hitDetectionInstructions = r.hitDetectionInstructions, this.pixelCoordinates_ = null, this.viewRotation_ = 0, this.fillStates = r.fillStates || {}, this.strokeStates = r.strokeStates || {}, this.textStates = r.textStates || {}, this.widths_ = {}, this.labels_ = {}, this.zIndexContext_ = i ? new pu() : null;
	}
	getZIndexContext() {
	...
	createLabel(e, t, n, r) {
		...
		let a = r ? this.strokeStates[r] : null, o = n ? this.fillStates[n] : null, s = this.textStates[t], c = this.pixelRatio, l = [s.scale[0] * c, s.scale[1] * c], u = s.justify ? $d[s.justify] : pf(Array.isArray(e) ? e[0] : e, s.textAlign || "center"), d = r && a.lineWidth ? a.lineWidth : 0, f = Array.isArray(e) ? e : String(e).split("\n").reduce(mf, []), { width: p, height: m, widths: h, heights: g, lineWidths: _ } = Oc(s, f), v = p + d, y = [], b = (v + 2) * l[0], x = (m + d) * l[1], S = {
	...
	calculateImageOrLabelDimensions_(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h) {
		...
		(m || u !== 0) && (sf[0] = S, uf[0] = S, sf[1] = C, cf[1] = C, cf[0] = S + b, lf[0] = cf[0], lf[1] = C + x, uf[1] = lf[1]);
		let w;
		return u === 0 ? pt(Math.min(S, S + b), Math.min(C, C + x), Math.max(S, S + b), Math.max(C, C + x), of) : (w = Fr(Mr(), n, r, 1, 1, u, -n, -r), Pr(w, sf), Pr(w, cf), Pr(w, lf), Pr(w, uf), pt(Math.min(sf[0], cf[0], lf[0], uf[0]), Math.min(sf[1], cf[1], lf[1], uf[1]), Math.max(sf[0], cf[0], lf[0], uf[0]), Math.max(sf[1], cf[1], lf[1], uf[1]), of)), f && (g = Math.round(g), _ = Math.round(_)), {
			drawImageX: g,
			drawImageY: _,
			drawImageW: v,
			drawImageH: y,
	...
	replayImageOrLabel_(e, t, n, r, i, a, o) {
		...
		return c.minX - l <= t[0] && c.maxX + l >= 0 && c.minY - l <= t[1] && c.maxY + l >= 0 && (s && this.replayTextBackground_(e, sf, cf, lf, uf, a, o), kc(e, r.canvasTransform, i, n, r.originX, r.originY, r.drawImageW, r.drawImageH, r.drawImageX, r.drawImageY, r.scale)), !0;
	}
	fill_(e) {
		let t = this.alignAndScaleFill_;
		if (t) {
			let n = Pr(this.renderedTransform_, [0, 0]), r = 512 * this.pixelRatio;
	...
	drawLabelWithPointPlacement_(e, t, n, r) {
		let i = this.textStates[t], a = this.createLabel(e, t, r, n), o = this.strokeStates[n], s = this.pixelRatio, c = pf(Array.isArray(e) ? e[0] : e, i.textAlign || "center"), l = $d[i.textBaseline || "middle"], u = o && o.lineWidth ? o.lineWidth : 0;
		return {
			label: a,
	...
	execute_(e, t, n, r, i, a, o, s) {
		...
		this.pixelCoordinates_ && le(n, this.renderedTransform_) ? l = this.pixelCoordinates_ : (this.pixelCoordinates_ ||= [], l = Hr(this.coordinates, 0, this.coordinates.length, 2, n, this.pixelCoordinates_), Nr(this.renderedTransform_, n));
		let u = 0, d = r.length, f = 0, p, m = [], h, g, _, v, y, b, x, S, C, w, T, E, D, O = 0, k = 0, A = this.coordinateCache_, ee = this.viewRotation_, j = Math.round(Math.atan2(-n[1], n[0]) * 0xe8d4a51000) / 0xe8d4a51000, M = {
			context: e,
			pixelRatio: this.pixelRatio,
			resolution: this.resolution,
			rotation: ee
		}, te = this.instructions != r || this.overlaps ? 0 : 200, N, P, ne, re;
		for (; u < d;) {
			let n = r[u];
			switch (n[0]) {
				case $.BEGIN_GEOMETRY:
					N = n[1], re = n[3], N.getGeometry() ? o !== void 0 && !Ft(o, re.getExtent()) ? u = n[2] + 1 : ++u : u = n[2], c && (c.zIndex = n[4]);
					break;
				case $.BEGIN_PATH:
					O > te && (this.fill_(e), O = 0), k > te && (e.stroke(), k = 0), !O && !k && (e.beginPath(), y = NaN, b = NaN), ++u;
					break;
				case $.CIRCLE:
					f = n[1], _ = n[2] ?? 0;
					let r = l[f], d = l[f + 1], ie = l[f + 2] - _, ae = l[f + 3] - _, oe = ie - r, se = ae - d, ce = Math.sqrt(oe * oe + se * se);
				...
				case $.CUSTOM:
					...
					M.geometry = le, M.feature = N, u in A || (A[u] = []);
					let fe = A[u];
					de ? de(l, f, p, 2, fe) : (fe[0] = l[f], fe[1] = l[f + 1], fe.length = 2), c && (c.zIndex = n[6]), ue(fe, M), ++u;
					break;
				case $.DRAW_IMAGE:
					f = n[1], p = n[2], C = n[3], h = n[4], g = n[5];
					let pe = n[6], me = n[7], he = n[8], ge = n[9], _e = n[10], ve = n[11], ye = n[12], F = n[13];
					v = n[14] || "declutter";
					let be = n[15];
					if (!C && n.length >= 20) {
						...
						let r = n[24];
						g = (e.anchorY - r) * this.pixelRatio, n[5] = g, pe = C.height, n[6] = pe, F = C.width, n[13] = F;
					}
					let I;
					n.length > 25 && (I = n[25]);
					let xe, Se, Ce;
					n.length > 17 ? (xe = n[16], Se = n[17], Ce = n[18]) : (xe = gc, Se = null, Ce = null), _e && j ? ve += ee : !_e && !j && (ve -= ee);
					let we = 0;
					for (; f < p; f += 2) {
						if (I && I[we++] < F / this.pixelRatio) continue;
						let n = this.calculateImageOrLabelDimensions_(C.width, C.height, l[f], l[f + 1], F, pe, h, g, he, ge, ve, ye, i, xe, !!Se || !!Ce, N), r = [
							e,
							t,
							C,
							n,
						...
						if (s) {
							...
							if (be) {
								...
								let a = be[n];
								e = a.args, t = a.declutterMode, delete be[n], i = df(e);
							}
							let a, o;
					...
					break;
				case $.DRAW_CHARS:
					let Te = n[1], Ee = n[2], De = n[3], L = n[4];
					D = n[5];
					let Oe = n[6], ke = n[7], Ae = n[8];
					E = n[9];
					let je = n[10];
					w = n[11], Array.isArray(w) && (w = w.reduce(hf, "")), T = n[12];
					let Me = [n[13], n[13]];
					v = n[14] || "declutter";
					let Ne = n[15], Pe = n[16], Fe = this.textStates[T], Ie = Fe.font, Le = [Fe.scale[0] * ke, Fe.scale[1] * ke], R;
					Ie in this.widths_ ? R = this.widths_[Ie] : (R = {}, this.widths_[Ie] = R);
					let z = od(l, Te, Ee, 2), B = Math.abs(Le[0]) * Dc(Ie, w, R);
					if (L || B <= z) {
						let n = this.textStates[T].textAlign, r = (z - B) * pf(w, n), i = af(l, Te, Ee, 2, w, r, Oe, Math.abs(Le[0]), Dc, Ie, R, j ? 0 : this.viewRotation_, Ne);
						drawChars: if (i) {
							let n = [], r, a, o, c, l;
							if (E) for (r = 0, a = i.length; r < a; ++r) {
								l = i[r], o = l[4], c = this.createLabel(o, T, "", E), h = l[2] + (Le[0] < 0 ? -je : je) - Pe, g = De * c.height + (.5 - De) * 2 * je * Le[1] / Le[0] - Ae;
								let a = this.calculateImageOrLabelDimensions_(c.width, c.height, l[0], l[1], c.width, c.height, h, g, 0, 0, l[3], Me, !1, gc, !1, N);
							...
							if (D) for (r = 0, a = i.length; r < a; ++r) {
								l = i[r], o = l[4], c = this.createLabel(o, T, D, ""), h = l[2] - Pe, g = De * c.height - Ae;
								let a = this.calculateImageOrLabelDimensions_(c.width, c.height, l[0], l[1], c.width, c.height, h, g, 0, 0, l[3], Me, !1, gc, !1, N);
								if (s && v === "declutter" && s.collides(a.declutterBox)) break drawChars;
								n.push([
									e,
				...
				case $.MOVE_TO_LINE_TO:
					...
					if (_) {
						...
						sd(l, f, p, 2, _, e, m), ld(m, 2, e), Re = m, ze = 0, Be = Re.length;
					} else Re = l, ze = f, Be = p;
					P = Re[ze], ne = Re[ze + 1], e.moveTo(P, ne), y = P + .5 | 0, b = ne + .5 | 0;
					for (let t = ze + 2; t < Be; t += 2) P = Re[t], ne = Re[t + 1], x = P + .5 | 0, S = ne + .5 | 0, (t == Be - 2 || x !== y || S !== b) && (e.lineTo(P, ne), y = x, b = S);
					++u;
					break;
				case $.SET_FILL_STYLE:
	...
	"Text",
	"Default"
], vf = ["Image", "Text"], yf = _f.filter((e) => !vf.includes(e)), bf = !1, xf = !1;
function Sf() {
	let e = 0, t = (t) => {
		let n = U(1, 1, null, { willReadFrequently: t }), r = 0, i = performance.now();
...
var Cf = class {
	constructor(e, t, n, r, i, a, o) {
		this.maxExtent_ = e, this.overlaps_ = r, this.pixelRatio_ = n, this.resolution_ = t, this.renderBuffer_ = a, this.executorsByZIndex_ = {}, this.hitDetectionContext_ = null, this.hitDetectionTransform_ = Mr(), this.renderedContext_ = null, this.deferredZIndexContexts_ = {}, this.createExecutors_(i, o);
	}
	clip(e, t) {
	...
	createExecutors_(e, t) {
		for (let n in e) {
			...
			for (let e in i) {
				let n = i[e];
				r[e] = new gf(this.resolution_, this.pixelRatio_, this.overlaps_, n, t);
			}
		}
	}
	hasExecutors(e) {
	...
	forEachFeatureAtCoordinate(e, t, n, r, i, a) {
		xf === !1 && Sf(), r = Math.round(r);
		let o = r * 2 + 1, s = Fr(this.hitDetectionTransform_, r + .5, r + .5, 1 / t, -1 / t, -n, -e[0], -e[1]), c = !this.hitDetectionContext_;
		c && (this.hitDetectionContext_ = U(o, o, null, { willReadFrequently: bf }));
		...
		let u;
		this.renderBuffer_ !== void 0 && (u = ft(), yt(u, e), at(u, t * (this.renderBuffer_ + r), u));
		let d = Tf(r), f;
		function p(e, t, n) {
		...
		for (h = m.length - 1; h >= 0; --h) {
			let e = m[h].toString();
			for (_ = this.executorsByZIndex_[e], g = _f.length - 1; g >= 0; --g) if (f = _f[g], v = _[f], v !== void 0 && (y = v.executeHitDetection(l, s, n, p, u), y)) return y;
		}
	}
	getClipCoords(e) {
		...
		return Hr(o, 0, 8, 2, e, o), o;
	}
	isEmpty() {
		return j(this.executorsByZIndex_);
	}
	...
	renderDeferred() {
		let e = this.deferredZIndexContexts_, t = Object.keys(e).map(Number).sort(ie);
...
var Ef = .5;
function Df(e, t, n, r, i, a, o, s, c) {
	let l = c ? Dr(i, c) : i, u = U(e[0] * Ef, e[1] * Ef);
	u.imageSmoothingEnabled = !1;
	let d = u.canvas, f = new dd(u, Ef, i, null, o, s, c ? yr(wr(), c) : null), p = n.length, m = Math.floor(16777215 / p), h = {};
	for (let e = 1; e <= p; ++e) {
		...
		for (let e = 0, n = o.length; e < n; ++e) {
			...
			if (!r || !Ft(l, r.getExtent())) continue;
			...
			if (u) {
				...
				if (!e) continue;
				let t = U(e[0], e[1], void 0, { alpha: !1 }), n = t.canvas;
				t.fillStyle = s, t.fillRect(0, 0, n.width, n.height), i.setImage(new Ic({
					img: n,
					anchor: u.getAnchor(),
					anchorXUnits: "pixels",
					anchorYUnits: "pixels",
	...
	let g = Object.keys(h).map(Number).sort(ie);
...
function Of(e, t, n) {
	let r = [];
	if (n) {
		let i = Math.floor(Math.round(e[0]) * Ef), a = Math.floor(Math.round(e[1]) * Ef), o = (V(i, 0, n.width - 1) + V(a, 0, n.height - 1) * n.width) * 4, s = n.data[o], c = n.data[o + 1], l = n.data[o + 2] + 256 * (c + 256 * s), u = Math.floor(16777215 / t.length);
...
var kf = class extends yu {
	constructor(e) {
		super(e), this.boundHandleStyleImageChange_ = this.handleStyleImageChange_.bind(this), this.animatingOrInteracting_, this.hitDetectionImageData_ = null, this.clipExtent_ = null, this.extendX_ = !1, this.renderedFeatures_ = null, this.renderedRevision_ = -1, this.renderedResolution_ = NaN, this.renderedExtent_ = ft(), this.wrappedRenderedExtent_ = ft(), this.renderedRotation_, this.renderedCenter_ = null, this.renderedProjection_ = null, this.renderedPixelRatio_ = 1, this.renderedRenderOrder_ = null, this.renderedFrameDeclutter_, this.replayGroup_ = null, this.replayGroupChanged = !0, this.clipping = !0, this.targetContext_ = null, this.opacity_ = 1;
	}
	renderWorlds(e, t, n) {
		let r = t.extent, i = t.viewState, a = i.center, o = i.resolution, s = i.projection, c = i.rotation, l = s.getExtent(), u = this.getLayer().getSource(), d = this.getLayer().getDeclutter(), f = t.pixelRatio, p = t.viewHints, m = !(p[He.ANIMATING] || p[He.INTERACTING]), h = this.context, g = Math.round(H(r) / o * f), _ = Math.round(At(r) / o * f), v = u.getWrapX() && s.canWrapX(), y = v ? H(l) : null, b = v ? Math.ceil((r[2] - l[2]) / y) + (this.extendX_ ? 2 : 1) : 1, x = v ? Math.floor((r[0] - l[0]) / y) - +!!this.extendX_ : 0;
		do {
			let r = this.getRenderTransform(a, o, 0, f, g, _, x * y);
			t.declutter && (r = r.slice(0)), e.execute(h, [h.canvas.width, h.canvas.height], r, c, m, n === void 0 ? _f : n ? vf : yf, n ? d && t.declutter[d] : void 0);
		} while (++x < b);
	}
	setDrawContext_() {
		this.opacity_ !== 1 && (this.targetContext_ = this.context, this.context = U(this.context.canvas.width, this.context.canvas.height, gu));
	}
	resetDrawContext_() {
		if (this.opacity_ !== 1 && this.targetContext_) {
			let e = this.targetContext_.globalAlpha;
			this.targetContext_.globalAlpha = this.opacity_, this.targetContext_.drawImage(this.context.canvas, 0, 0), this.targetContext_.globalAlpha = e, ca(this.context), gu.push(this.context.canvas), this.context = this.targetContext_, this.targetContext_ = null;
		}
	}
	renderDeclutter(e) {
	...
	renderFrame(e, t) {
		...
		if (!o && !(this.getLayer().hasListener(so.PRERENDER) || this.getLayer().hasListener(so.POSTRENDER))) return this.container;
		...
		if (o && n.extent && this.clipping) {
			let t = Or(n.extent, s);
			o = Ft(t, e.extent), o && !lt(t, e.extent) && (e.declutter ? this.clipExtent_ = t : (this.clipUnrotated(i, e, t), c = !0));
		}
	...
	getFeatures(e) {
		return new Promise((t) => {
			if (this.frameState && !this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
				let e = this.frameState.size.slice(), t = this.renderedCenter_, n = this.renderedResolution_, r = this.renderedRotation_, i = this.renderedProjection_, a = this.wrappedRenderedExtent_, o = this.getLayer(), s = [], c = e[0] * Ef, l = e[1] * Ef;
				s.push(this.getRenderTransform(t, n, r, Ef, c, l, 0).slice());
				let u = o.getSource(), d = i.getExtent();
				if (u.getWrapX() && i.canWrapX() && !lt(d, a)) {
					let e = a[0], i = H(d), o = 0, u;
					for (; e < d[0];) --o, u = i * o, s.push(this.getRenderTransform(t, n, r, Ef, c, l, u).slice()), e += i;
					for (o = 0, e = a[2]; e > d[2];) ++o, u = i * o, s.push(this.getRenderTransform(t, n, r, Ef, c, l, u).slice()), e -= i;
				}
				let f = wr();
				this.hitDetectionImageData_ = Df(e, s, this.renderedFeatures_, o.getStyleFunction(), a, n, r, hd(n, this.renderedPixelRatio_), f ? i : null);
			}
	...
	prepareFrame(e) {
		...
		if (!n) return !1;
		let r = e.viewHints[He.ANIMATING], i = e.viewHints[He.INTERACTING], a = t.getUpdateWhileAnimating(), o = t.getUpdateWhileInteracting();
		...
		m === void 0 && (m = md);
		let h = c.center.slice(), g = at(s, p * u), _ = g.slice(), v = [g.slice()], y = l.getExtent(), b = n.getWrapX() && l.canWrapX();
		if (this.extendX_ = !1, b) {
			let e = n.getExtent();
			e && !It(e) && (this.extendX_ = e[0] < y[0] || e[2] > y[2]);
		}
		if (b && (!lt(y, e.extent) || this.extendX_)) {
			let e = H(y), t = Math.max(H(g) / 2, e), n = y[0], r = y[2];
			this.extendX_ && (n -= e, r += e), g[0] = n - t, g[2] = r + t, Kt(h, l);
			let i = zt(v[0], l);
		...
		if (this.ready && this.renderedResolution_ == u && this.renderedPixelRatio_ === d && this.renderedRevision_ == f && this.renderedRenderOrder_ == m && this.renderedFrameDeclutter_ === !!e.declutter && lt(this.wrappedRenderedExtent_, g)) return le(this.renderedExtent_, _) || (this.hitDetectionImageData_ = null, this.renderedExtent_ = _), this.renderedCenter_ = h, this.replayGroupChanged = !1, !0;
		this.replayGroup_ = null;
		let x = new tf(gd(u, d), g, u, d), S = wr(), C;
		if (S) {
			for (let e = 0, t = v.length; e < t; ++e) {
				let t = v[e], r = Dr(t, l);
				n.loadFeatures(r, kr(u, l), S);
			}
			C = yr(S, l);
		} else for (let e = 0, t = v.length; e < t; ++e) n.loadFeatures(v[e], u, l);
		let w = hd(u, d), T = !0, E = (e, n) => {
			let r, i = e.getStyleFunction() || t.getStyleFunction();
			if (i && (r = i(e, u)), r) {
				let t = this.renderFeature(e, w, r, x, C, this.getLayer().getDeclutter(), n);
				T &&= !t;
			}
		}, D = Dr(g, l), O = n.getFeaturesInExtent(D);
		m && O.sort(m);
		for (let e = 0, t = O.length; e < t; ++e) E(O[e], e);
		this.renderedFeatures_ = O, this.ready = T;
		let k = x.finish(), A = new Cf(g, u, d, n.getOverlaps(), k, t.getRenderBuffer(), !!e.declutter);
		return this.renderedResolution_ = u, this.renderedRevision_ = f, this.renderedRenderOrder_ = m, this.renderedFrameDeclutter_ = !!e.declutter, this.renderedExtent_ = _, this.wrappedRenderedExtent_ = g, this.renderedCenter_ = h, this.renderedProjection_ = l, this.renderedPixelRatio_ = d, this.replayGroup_ = A, this.hitDetectionImageData_ = null, this.replayGroupChanged = !0, !0;
	}
	renderFeature(e, t, n, r, i, a, o) {
		if (!n) return !1;
		let s = !1;
		if (Array.isArray(n)) for (let c = 0, l = n.length; c < l; ++c) s = vd(r, e, n[c], t, this.boundHandleStyleImageChange_, i, a, o) || s;
		else s = vd(r, e, n, t, this.boundHandleStyleImageChange_, i, a, o);
		return s;
	}
}, Af = class extends Ol {
	constructor(e) {
...
}, jf = n("<div class=\"metadata__block metadata__block--title svelte-1a5u456\"><div class=\"metadata__block-title svelte-1a5u456\">Title</div> <div class=\"metadata__block-value svelte-1a5u456\"> </div></div>"), Mf = n("<div class=\"metadata__label svelte-1a5u456\"> </div>"), Nf = n("<div class=\"metadata__description svelte-1a5u456\"></div>"), Pf = n("<img alt=\"\" class=\"metadata__provider-logo svelte-1a5u456\"/>"), Ff = n("<a class=\"metadata__link svelte-1a5u456\" target=\"_blank\" rel=\"noreferrer\"> </a>"), If = n("<div class=\"metadata__provider\"><!> <div class=\"metadata__provider-body svelte-1a5u456\"><div class=\"metadata__provider-name svelte-1a5u456\"> </div> <!> <!></div></div>"), Lf = n("<div class=\"metadata__block svelte-1a5u456\"><div class=\"metadata__block-title svelte-1a5u456\"> </div> <!></div>"), Rf = n("<div class=\"metadata__block svelte-1a5u456\"><div class=\"metadata__block-title svelte-1a5u456\"> </div> <div class=\"metadata__block-value svelte-1a5u456\"></div></div>"), zf = n("<div class=\"metadata__block svelte-1a5u456\"><div class=\"metadata__block-title svelte-1a5u456\"> </div> <div class=\"metadata__block-value svelte-1a5u456\"><a class=\"metadata__link svelte-1a5u456\" target=\"_blank\" rel=\"noreferrer\"> </a></div></div>"), Bf = n("<dt class=\"metadata__term svelte-1a5u456\"> </dt> <dd class=\"metadata__value svelte-1a5u456\"></dd>", 1), Vf = n("<dl class=\"metadata__list svelte-1a5u456\"></dl>"), Hf = n("<div class=\"panel__empty\"> </div>"), Uf = n("<section class=\"panel panel--metadata\"><div class=\"panel__header\"><div class=\"panel__title\"> </div> <!></div> <div><div class=\"metadata__map\"><div class=\"metadata__map-target svelte-1a5u456\"></div></div> <!> <!> <!> <!> <!> <!></div></section>");
function Wf(n, k) {
	C(k, !0);
	let A = () => f(pe, "$manifestGeoLocation", re), ee = () => f(T, "$t", re), j = () => f(se, "$manifestTitle", re), M = () => f(ce, "$manifestDescription", re), te = () => f(fe, "$manifestProviders", re), N = () => f(le, "$manifestAttribution", re), P = () => f(ue, "$manifestLicence", re), ne = () => f(de, "$manifestMetadata", re), [re, ie] = m(), ae = y(k, "redesigned", 3, !1), oe = y(k, "onclose", 3, void 0), { manifestTitle: se, manifestDescription: ce, manifestAttribution: le, manifestLicence: ue, manifestMetadata: de, manifestProviders: fe, manifestGeoLocation: pe } = D().derived, me, he, ge = new rd();
	ge.setStyle(new Rc({ image: new Nc({
		radius: 7,
		fill: new Pc({ color: "#2563eb" }),
		stroke: new Lc({
			color: "#ffffff",
			width: 2
		})
	}) })), c(() => {
		let e = new Af({ source: new Rd({ features: [ge] }) });
		return he = new Il({
			target: me,
			layers: [new Eu({ source: new nd() }), e],
			view: new Gi({
				center: _r([0, 0]),
				zoom: 2
			})
		}), () => {
			he?.setTarget(void 0), he = void 0;
		};
	}), e(() => {
		let e = A();
		if (!e) {
			ge.setGeometry(void 0);
			return;
		}
		let t = _r([e.lng, e.lat]);
		ge.setGeometry(new Ti(t)), he?.getView().setCenter(t), he?.getView().setZoom(12), requestAnimationFrame(() => he?.updateSize());
	});
	var _e = Uf(), ve = b(_e), ye = b(ve), F = b(ye, !0);
	a(ye);
	var be = h(ye, 2);
	{
		let e = v(() => ee()("viewer.panels.metadata.close"));
		O(be, {
			get lucide() {
				return ae();
			},
	...
	var we = h(Se, 2), Te = (e) => {
		var t = w(), n = x(t), r = (e) => {
			var t = jf(), n = h(b(t), 2), r = b(n, !0);
			a(n), a(t), u(() => o(r, j())), d(e, t);
		}, i = (e) => {
			var t = Mf(), n = b(t, !0);
			a(t), u(() => o(n, j())), d(e, t);
		};
	...
	var L = h(Ee, 2), Oe = (e) => {
		var n = Lf(), r = b(n), i = b(r, !0);
		a(r);
		var c = h(r, 2);
		_(c, 1, te, t, (e, t) => {
			var n = If(), r = b(n), i = (e) => {
				var n = Pf();
				u(() => p(n, "src", s(t).logo.id)), d(e, n);
			};
			g(r, (e) => {
				s(t).logo?.id && e(i);
			});
			var c = h(r, 2), l = b(c), f = b(l, !0);
			a(l);
			var m = h(l, 2), _ = (e) => {
				var n = Ff(), r = b(n, !0);
				a(n), u(() => {
					p(n, "href", s(t).homepage.id), o(r, s(t).homepage.label || s(t).homepage.id);
				}), d(e, n);
			};
			g(m, (e) => {
				s(t).homepage?.id && e(_);
			...
			var v = h(m, 2), y = (e) => {
				var n = Ff(), r = b(n, !0);
				a(n), u(() => {
					p(n, "href", s(t).seeAlso.id), o(r, s(t).seeAlso.label || s(t).seeAlso.id);
				}), d(e, n);
			};
			g(v, (e) => {
				s(t).seeAlso?.id && e(y);
			}), a(c), a(n), u(() => o(f, s(t).label)), d(e, n);
		}), a(n), u((e) => o(i, e), [() => ee()("viewer.panels.metadata.provider")]), d(e, n);
	};
	g(L, (e) => {
		te().length > 0 && e(Oe);
	});
	var ke = h(L, 2), Ae = (e) => {
		var t = Rf(), n = b(t), r = b(n, !0);
		a(n);
		var i = h(n, 2);
		l(i, () => E(N().value), !0), a(i), a(t), u((e) => o(r, e), [() => N().label || ee()("viewer.panels.metadata.attribution")]), d(e, t);
	};
	g(ke, (e) => {
		N().value && e(Ae);
	});
	var je = h(ke, 2), Me = (e) => {
		var t = zf(), n = b(t), r = b(n, !0);
		a(n);
		var i = h(n, 2), s = b(i), c = b(s, !0);
		a(s), a(i), a(t), u((e) => {
			o(r, e), p(s, "href", P()), o(c, P());
		}, [() => ee()("viewer.panels.metadata.license")]), d(e, t);
	};
	g(je, (e) => {
		P() && e(Me);
	});
	var Ne = h(je, 2), Pe = (e) => {
		var n = Vf();
		_(n, 5, ne, t, (e, t) => {
			var n = Bf(), r = x(n), i = b(r, !0);
			a(r);
			var c = h(r, 2);
			l(c, () => E(s(t).value), !0), a(c), u(() => o(i, s(t).label)), d(e, n);
		}), a(n), d(e, n);
	}, Fe = (e) => {
		var t = Hf(), n = b(t, !0);
		a(t), u((e) => o(n, e), [() => ee()("viewer.panels.metadata.empty")]), d(e, t);
	};
	g(Ne, (e) => {
		ne().length > 0 ? e(Pe) : !M() && !N().value && !P() && e(Fe, 1);
	}), a(I), a(_e), u((e, t) => {
		p(_e, "aria-label", e), o(F, t), xe = r(I, 1, "panel__body metadata svelte-1a5u456", null, xe, { "metadata--redesigned": ae() }), p(Se, "hidden", !A());
	}, [() => ee()("viewer.panels.metadata.label"), () => ee()("viewer.panels.metadata.title")]), d(n, _e), i(), ie();
}
//#endregion
