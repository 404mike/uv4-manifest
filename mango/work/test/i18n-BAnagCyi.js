...
} }, t = globalThis.navigator?.language || "en", n = (e) => {
	t = e;
}, r = (t, n) => {
	e[t] = n;
}, i = (n) => {
	let [r] = t.split("-");
	return e[t]?.[n] || e[r]?.[n] || e.en?.[n] || n;
}, a = () => {
	let [n] = t.split("-");
	return e[t] ? t : e[n] ? n : "en";
}, o = (e, t = {}) => i(e).replace(/\{(\w+)\}/g, (e, n) => n in t ? String(t[n]) : `{${n}}`);
//#endregion
export { o as i, a as n, n as r, r as t };
