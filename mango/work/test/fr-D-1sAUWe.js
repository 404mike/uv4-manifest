...
//#region node_modules/media-chrome/dist/lang/fr.js
var t = {
	...
	"A network error caused the media download to fail.": "Une erreur réseau a causé l’échec du téléchargement du média.",
	"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.": "Une erreur de média a provoqué l’interruption de la lecture. Le média peut être corrompu ou votre navigateur ne prend pas en charge ce format.",
	"An unsupported error occurred. The server or network failed, or your browser does not support this format.": "Une erreur non supportée s’est produite. Le serveur ou le réseau a échoué, ou votre navigateur ne prend pas en charge ce format.",
	"The media is encrypted and there are no keys to decrypt it.": "Le média est chiffré et il n’y a pas de clés pour le déchiffrer.",
	hour: "heure",
	hours: "heures",
	minute: "minute",
	minutes: "minutes",
