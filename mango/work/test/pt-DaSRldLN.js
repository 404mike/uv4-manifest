...
//#region node_modules/media-chrome/dist/lang/pt.js
var t = {
	...
	"A network error caused the media download to fail.": "Um erro de rede causou a falha no download do conteúdo.",
	"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.": "Um erro de mídia fez com que a reprodução fosse interrompida. O conteúdo pode estar corrompido ou seu navegador não suporta este formato.",
	"An unsupported error occurred. The server or network failed, or your browser does not support this format.": "Ocorreu um erro de incompatibilidade. O servidor ou a rede falharam, ou seu navegador não suporta este formato.",
	"The media is encrypted and there are no keys to decrypt it.": "O conteúdo está criptografado e não há chaves disponíveis para descriptografá-lo.",
	hour: "hora",
	hours: "horas",
	minute: "minuto",
	minutes: "minutos",
