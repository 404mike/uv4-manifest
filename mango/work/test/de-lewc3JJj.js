import { t as e } from "./i18n-BAnagCyi.js";
//#region node_modules/media-chrome/dist/lang/de.js
var t = {
	...
	"A network error caused the media download to fail.": "Ein Netzwerkfehler hat dazu geführt, dass der Medien-Download fehlgeschlagen ist.",
	"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.": "Ein Medienfehler hat die Wiedergabe abgebrochen. Das Medium könnte beschädigt sein oder Ihr Browser unterstützt dieses Format nicht.",
	"An unsupported error occurred. The server or network failed, or your browser does not support this format.": "Ein nicht unterstützter Fehler ist aufgetreten. Der Server oder das Netzwerk ist fehlgeschlagen, oder Ihr Browser unterstützt dieses Format nicht.",
	"The media is encrypted and there are no keys to decrypt it.": "Das Medium ist verschlüsselt und es sind keine Schlüssel zum Entschlüsseln vorhanden.",
	hour: "Stunde",
	hours: "Stunden",
	minute: "Minute",
	minutes: "Minuten",
