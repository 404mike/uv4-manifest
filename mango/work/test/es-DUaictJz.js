...
//#region node_modules/media-chrome/dist/lang/es.js
var t = {
	...
	"A network error caused the media download to fail.": "Un error de red causó la falla en la descarga del contenido.",
	"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.": "Un error de medios causó la interrupción de la reproducción. El contenido podría estar dañado o tu navegador no admite este formato.",
	"An unsupported error occurred. The server or network failed, or your browser does not support this format.": "Ocurrió un error de incompatibilidad. El servidor o la red fallaron, o tu navegador no admite este formato.",
	"The media is encrypted and there are no keys to decrypt it.": "El contenido está cifrado y no hay claves disponibles para descifrarlo.",
	hour: "hora",
	hours: "horas",
	minute: "minuto",
	minutes: "minutos",
